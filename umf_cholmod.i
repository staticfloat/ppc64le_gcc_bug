...
# 63 "../../CHOLMOD/Include/cholmod_cholesky.h"
# 1 "../../CHOLMOD/Include/cholmod_partition.h" 1
# 41 "../../CHOLMOD/Include/cholmod_partition.h"
...
int cholmod_l_camd (cholmod_sparse *, long *, size_t,
    long *, long *, cholmod_common *) ;
# 42 "../../CHOLMOD/Include/cholmod_partition.h" 2
# 53 "../../CHOLMOD/Include/cholmod_partition.h"
...
# 127 "../../CHOLMOD/Include/cholmod_partition.h"
...
long cholmod_l_collapse_septree (size_t, size_t, double, size_t,
    long *, long *, cholmod_common *) ;
# 64 "../../CHOLMOD/Include/cholmod_cholesky.h" 2
...
# 154 "umf_cholmod.c"
    ...
    A->i = Ai ;
    A->x = 
# 157 "umf_cholmod.c" 3 4
          ((void *)0) 
# 157 "umf_cholmod.c"
               ;
    A->z = 
# 158 "umf_cholmod.c" 3 4
          ((void *)0) 
# 158 "umf_cholmod.c"
               ;
    A->sorted = (0) ;
