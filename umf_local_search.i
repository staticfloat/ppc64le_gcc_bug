# 1 "umf_local_search.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "umf_local_search.c"
# 19 "umf_local_search.c"
# 1 "umf_internal.h" 1
# 25 "umf_internal.h"
...
# 20 "umf_local_search.c" 2
# 1 "umf_local_search.h" 1
...
# 21 "umf_local_search.c" 2
# 1 "umf_row_search.h" 1
...
# 342 "umf_local_search.c"
 ...
 else
 {
  ...
  jcand [1] = j ;
    ...
    cdeg_in = (-1) ;
    cdeg_out = (-1) ;
# 439 "umf_local_search.c"
    if (pivcol [0] != (-1))
    {
# 449 "umf_local_search.c"
 ;
...
# 553 "umf_local_search.c"
 cdeg_in = fnrows ;
# 608 "umf_local_search.c"
 ;
 ;
...
# 711 "umf_local_search.c"
 nr_in = cdeg_in - fnrows ;



 ;
# 726 "umf_local_search.c"
...
# 863 "umf_local_search.c"
 ...
 search_pivcol_out = search_pivcol_out && (pivrow [0][0] == (-1)) ;
    ...
    {
# 991 "umf_local_search.c"
 cdeg_out = 0 ;
# 1006 "umf_local_search.c"
 ;
 ;
