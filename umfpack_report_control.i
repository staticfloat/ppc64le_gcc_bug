# 1 "umfpack_report_control.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "umfpack_report_control.c"
# 15 "umfpack_report_control.c"
# 1 "umf_internal.h" 1
# 25 "umf_internal.h"
...
)
{
 ...
 force_fixQ, droptol, aggr ;
    long prl, nb, irstep, strategy, scale, s ;
    long do_singletons, ordering_option ;

    prl = ((Control != (double *) 
# 27 "umfpack_report_control.c" 3 4
         ((void *)0)
# 27 "umfpack_report_control.c"
...
# 35 "umfpack_report_control.c" 3 4
   ((void *)0)
# 35 "umfpack_report_control.c"
   ) { (void) (SuiteSparse_config.printf_func) ("UMFPACK V%d.%d.%d (%s), Control:\n", 5, 7, 1, "Oct 10, 2014") ; } }
                                                             ;
# 58 "umfpack_report_control.c"
    { if (SuiteSparse_config.printf_func != 
# 58 "umfpack_report_control.c" 3 4
   ((void *)0)
# 58 "umfpack_report_control.c"
   ) { (void) (SuiteSparse_config.printf_func) ("    Matrix entry defined as: double complex\n") ; } } ;
    { if (SuiteSparse_config.printf_func != 
# 59 "umfpack_report_control.c" 3 4
   ((void *)0)
# 59 "umfpack_report_control.c"
    ...
    { if (SuiteSparse_config.printf_func != 
# 66 "umfpack_report_control.c" 3 4
   ((void *)0)
# 66 "umfpack_report_control.c"
    ...
    drow = ((Control != (double *) 
# 73 "umfpack_report_control.c" 3 4
          ((void *)0)
# 73 "umfpack_report_control.c"
          ) ? (((Control [1]) != (Control [1])) ? 0.2 : Control [1]) : 0.2) ;
    dcol = ((Control != (double *) 
# 74 "umfpack_report_control.c" 3 4
          ((void *)0)
# 74 "umfpack_report_control.c"
          ) ? (((Control [2]) != (Control [2])) ? 0.2 : Control [2]) : 0.2) ;

    { if (SuiteSparse_config.printf_func != 
# 76 "umfpack_report_control.c" 3 4
   ((void *)0)
# 76 "umfpack_report_control.c"
   ) { (void) (SuiteSparse_config.printf_func) ("    ""%" "ld"": dense row parameter:    %g\n", (long) (1), drow) ; } }
                                         ;
    { if (SuiteSparse_config.printf_func != 
# 78 "umfpack_report_control.c" 3 4
   ((void *)0)
# 78 "umfpack_report_control.c"
   ) { (void) (SuiteSparse_config.printf_func) ("        \"dense\" rows have    > max (16, (%g)*16*sqrt(n_col)" " entries)\n", drow) ; } }
                       ;
    { if (SuiteSparse_config.printf_func != 
# 80 "umfpack_report_control.c" 3 4
   ((void *)0)
# 80 "umfpack_report_control.c"
   ) { (void) (SuiteSparse_config.printf_func) ("    ""%" "ld"": dense column parameter: %g\n", (long) (2), dcol) ; } }
                                         ;
    { if (SuiteSparse_config.printf_func != 
# 82 "umfpack_report_control.c" 3 4
   ((void *)0)
# 82 "umfpack_report_control.c"
   ) { (void) (SuiteSparse_config.printf_func) ("        \"dense\" columns have > max (16, (%g)*16*sqrt(n_row)" " entries)\n", dcol) ; } }
                       ;
    ...
    relpt = ((Control != (double *) 
# 89 "umfpack_report_control.c" 3 4
           ((void *)0)
# 89 "umfpack_report_control.c"
           ) ? (((Control [3]) != (Control [3])) ? 0.1 : Control [3]) : 0.1)
                                  ;
    relpt = (((0.0) > ((((relpt) < (1.0)) ? (relpt) : (1.0)))) ? (0.0) : ((((relpt) < (1.0)) ? (relpt) : (1.0)))) ;
    { if (SuiteSparse_config.printf_func != 
# 92 "umfpack_report_control.c" 3 4
   ((void *)0)
# 92 "umfpack_report_control.c"
   ) { (void) (SuiteSparse_config.printf_func) ("    ""%" "ld"": pivot tolerance: %g\n", (long) (3), relpt) ; } }
                                                ;
    ...
    nb = ((Control != (double *) 
# 99 "umfpack_report_control.c" 3 4
        ((void *)0)
# 99 "umfpack_report_control.c"
        ) ? (((Control [4]) != (Control [4])) ? 32 : Control [4]) : 32) ;
    nb = (((1) > (nb)) ? (1) : (nb)) ;
    { if (SuiteSparse_config.printf_func != 
# 101 "umfpack_report_control.c" 3 4
   ((void *)0)
# 101 "umfpack_report_control.c"
   ) { (void) (SuiteSparse_config.printf_func) ("    ""%" "ld"": block size for dense matrix kernels: ""%" "ld""\n", (long) (4), nb) ; } }
                                        ;
...
# 108 "umfpack_report_control.c" 3 4
              ((void *)0)
# 108 "umfpack_report_control.c"
 ...
 strategy = 0 ;
    ...
    { if (SuiteSparse_config.printf_func != 
# 115 "umfpack_report_control.c" 3 4
   ((void *)0)
# 115 "umfpack_report_control.c"
   ) { (void) (SuiteSparse_config.printf_func) ("    ""%" "ld"": strategy: ""%" "ld", (long) (5), strategy) ; } }
                                            ;

    if (strategy == 3)
    {
 { if (SuiteSparse_config.printf_func != 
# 120 "umfpack_report_control.c" 3 4
((void *)0)
# 120 "umfpack_report_control.c"
) { (void) (SuiteSparse_config.printf_func) (" (symmetric)\n" "        Q = AMD (A+A'), Q not refined during numerical\n" "        factorization, and diagonal pivoting (P=Q') attempted.\n") ; } }
    ...
    {
 { if (SuiteSparse_config.printf_func != 
# 126 "umfpack_report_control.c" 3 4
((void *)0)
# 126 "umfpack_report_control.c"
) { (void) (SuiteSparse_config.printf_func) (" (unsymmetric)\n" "        Q = COLAMD (A), Q refined during numerical\n" "        factorization, and no attempt at diagonal pivoting.\n") ; } }
 ...
 strategy = 0 ;
 { if (SuiteSparse_config.printf_func != 
# 133 "umfpack_report_control.c" 3 4
((void *)0)
# 133 "umfpack_report_control.c"
) { (void) (SuiteSparse_config.printf_func) (" (auto)\n") ; } } ;
    }
...
# 140 "umfpack_report_control.c" 3 4
                     ((void *)0)
# 140 "umfpack_report_control.c"
    ...
    { if (SuiteSparse_config.printf_func != 
# 145 "umfpack_report_control.c" 3 4
   ((void *)0)
# 145 "umfpack_report_control.c"
   ) { (void) (SuiteSparse_config.printf_func) ("    ""%" "ld"": ordering: ""%" "ld", (long) (10), ordering_option) ; } }
                                                   ;
    if (ordering_option == 0)
    {
        { if (SuiteSparse_config.printf_func != 
# 149 "umfpack_report_control.c" 3 4
       ((void *)0)
# 149 "umfpack_report_control.c"
       ) { (void) (SuiteSparse_config.printf_func) (" CHOLMOD: AMD/COLAMD, then try METIS, and select best\n") ; } } ;
    }
    else if (ordering_option == 1)
    {
        { if (SuiteSparse_config.printf_func != 
# 153 "umfpack_report_control.c" 3 4
       ((void *)0)
# 153 "umfpack_report_control.c"
       ) { (void) (SuiteSparse_config.printf_func) (" AMD/COLAMD\n") ; } } ;
    }
    else if (ordering_option == 2)
    {
        { if (SuiteSparse_config.printf_func != 
# 157 "umfpack_report_control.c" 3 4
       ((void *)0)
# 157 "umfpack_report_control.c"
       ) { (void) (SuiteSparse_config.printf_func) (" user-provided permutation vector\n") ; } } ;
    }
    else if (ordering_option == 5)
    {
        { if (SuiteSparse_config.printf_func != 
# 161 "umfpack_report_control.c" 3 4
       ((void *)0)
# 161 "umfpack_report_control.c"
       ) { (void) (SuiteSparse_config.printf_func) (" none\n") ; } } ;
    }
    else if (ordering_option == 3)
    {
        { if (SuiteSparse_config.printf_func != 
# 165 "umfpack_report_control.c" 3 4
       ((void *)0)
# 165 "umfpack_report_control.c"
       ) { (void) (SuiteSparse_config.printf_func) (" METIS\n") ; } } ;
    }
    else if (ordering_option == 4)
    {
        { if (SuiteSparse_config.printf_func != 
# 169 "umfpack_report_control.c" 3 4
       ((void *)0)
# 169 "umfpack_report_control.c"
       ) { (void) (SuiteSparse_config.printf_func) (" best effort. Try AMD/COLAMD and METIS, select best\n") ; } } ;
    }
    else if (ordering_option == 6)
    {
        { if (SuiteSparse_config.printf_func != 
# 173 "umfpack_report_control.c" 3 4
       ((void *)0)
# 173 "umfpack_report_control.c"
       ) { (void) (SuiteSparse_config.printf_func) (" user-provided ordering function\n") ; } } ;
    }
...
# 180 "umfpack_report_control.c" 3 4
                   ((void *)0)
# 180 "umfpack_report_control.c"
                   ) ? (((Control [11]) != (Control [11])) ? (1) : Control [11]) : (1));
    { if (SuiteSparse_config.printf_func != 
# 181 "umfpack_report_control.c" 3 4
   ((void *)0)
# 181 "umfpack_report_control.c"
   ) { (void) (SuiteSparse_config.printf_func) ("    ""%" "ld"": singleton filter:", (long) (11)) ; } } ;
    if (do_singletons)
    {
 { if (SuiteSparse_config.printf_func != 
# 184 "umfpack_report_control.c" 3 4
((void *)0)
# 184 "umfpack_report_control.c"
) { (void) (SuiteSparse_config.printf_func) (" enabled\n") ; } } ;
    }
    else
    {
 { if (SuiteSparse_config.printf_func != 
# 188 "umfpack_report_control.c" 3 4
((void *)0)
# 188 "umfpack_report_control.c"
) { (void) (SuiteSparse_config.printf_func) (" disabled\n") ; } } ;
    }
    ...
    alloc_init = ((Control != (double *) 
# 195 "umfpack_report_control.c" 3 4
                ((void *)0)
# 195 "umfpack_report_control.c"
                ) ? (((Control [6]) != (Control [6])) ? 0.7 : Control [6]) : 0.7) ;
    if (alloc_init >= 0)
    {
 { if (SuiteSparse_config.printf_func != 
# 198 "umfpack_report_control.c" 3 4
((void *)0)
# 198 "umfpack_report_control.c"
) { (void) (SuiteSparse_config.printf_func) ("    ""%" "ld"": initial allocation ratio: %g\n", (long) (6), alloc_init) ; } }
                                                ;
    }
    else
    {
 ...
 s = (((1) > (s)) ? (1) : (s)) ;
 { if (SuiteSparse_config.printf_func != 
# 205 "umfpack_report_control.c" 3 4
((void *)0)
# 205 "umfpack_report_control.c"
) { (void) (SuiteSparse_config.printf_func) ("    ""%" "ld"": initial allocation (in Units): ""%" "ld""\n", (long) (6), s) ; } }
                                       ;
    }
    ...
    irstep = ((Control != (double *) 
# 213 "umfpack_report_control.c" 3 4
            ((void *)0)
# 213 "umfpack_report_control.c"
            ) ? (((Control [7]) != (Control [7])) ? 2 : Control [7]) : 2) ;
    irstep = (((0) > (irstep)) ? (0) : (irstep)) ;
    { if (SuiteSparse_config.printf_func != 
# 215 "umfpack_report_control.c" 3 4
   ((void *)0)
# 215 "umfpack_report_control.c"
   ) { (void) (SuiteSparse_config.printf_func) ("    ""%" "ld"": max iterative refinement steps: ""%" "ld""\n", (long) (7), irstep) ; } }
                                        ;
...
# 222 "umfpack_report_control.c" 3 4
                ((void *)0)
# 222 "umfpack_report_control.c"
                ) ? (((Control [13]) != (Control [13])) ? 0 : Control [13]) : 0) ;
    { if (SuiteSparse_config.printf_func != 
# 223 "umfpack_report_control.c" 3 4
   ((void *)0)
# 223 "umfpack_report_control.c"
   ) { (void) (SuiteSparse_config.printf_func) ("    ""%" "ld"": Q fixed during numerical factorization: %g ", (long) (13), force_fixQ) ; } }
                                          ;
    if (force_fixQ > 0)
    {
 { if (SuiteSparse_config.printf_func != 
# 227 "umfpack_report_control.c" 3 4
((void *)0)
# 227 "umfpack_report_control.c"
) { (void) (SuiteSparse_config.printf_func) ("(yes)\n") ; } } ;
    }
    else if (force_fixQ < 0)
    {
 { if (SuiteSparse_config.printf_func != 
# 231 "umfpack_report_control.c" 3 4
((void *)0)
# 231 "umfpack_report_control.c"
) { (void) (SuiteSparse_config.printf_func) ("(no)\n") ; } } ;
    }
    else
    {
 { if (SuiteSparse_config.printf_func != 
# 235 "umfpack_report_control.c" 3 4
((void *)0)
# 235 "umfpack_report_control.c"
) { (void) (SuiteSparse_config.printf_func) ("(auto)\n") ; } } ;
    }
    ...
    amd_alpha = ((Control != (double *) 
# 242 "umfpack_report_control.c" 3 4
               ((void *)0)
# 242 "umfpack_report_control.c"
               ) ? (((Control [14]) != (Control [14])) ? 10.0 : Control [14]) : 10.0) ;
    { if (SuiteSparse_config.printf_func != 
# 243 "umfpack_report_control.c" 3 4
   ((void *)0)
# 243 "umfpack_report_control.c"
   ) { (void) (SuiteSparse_config.printf_func) ("    ""%" "ld"": AMD dense row/col parameter:    %g\n", (long) (14), amd_alpha) ; } }
                                              ;
    if (amd_alpha < 0)
    {
 { if (SuiteSparse_config.printf_func != 
# 247 "umfpack_report_control.c" 3 4
((void *)0)
# 247 "umfpack_report_control.c"
) { (void) (SuiteSparse_config.printf_func) ("       no \"dense\" rows/columns\n") ; } } ;
    }
    else
    {
 { if (SuiteSparse_config.printf_func != 
# 251 "umfpack_report_control.c" 3 4
((void *)0)
# 251 "umfpack_report_control.c"
) { (void) (SuiteSparse_config.printf_func) ("       \"dense\" rows/columns have > max (16, (%g)*sqrt(n))" " entries\n", amd_alpha) ; } }
                               ;
    }
    { if (SuiteSparse_config.printf_func != 
# 254 "umfpack_report_control.c" 3 4
   ((void *)0)
# 254 "umfpack_report_control.c"
   ) { (void) (SuiteSparse_config.printf_func) ("        Only used if the AMD ordering is used.\n") ; } } ;





    relpt2 = ((Control != (double *) 
# 260 "umfpack_report_control.c" 3 4
            ((void *)0)
# 260 "umfpack_report_control.c"
            ) ? (((Control [15]) != (Control [15])) ? 0.001 : Control [15]) : 0.001)
                                      ;
    relpt2 = (((0.0) > ((((relpt2) < (1.0)) ? (relpt2) : (1.0)))) ? (0.0) : ((((relpt2) < (1.0)) ? (relpt2) : (1.0)))) ;
    { if (SuiteSparse_config.printf_func != 
# 263 "umfpack_report_control.c" 3 4
   ((void *)0)
# 263 "umfpack_report_control.c"
   ) { (void) (SuiteSparse_config.printf_func) ("    ""%" "ld"": diagonal pivot tolerance: %g\n" "        Only used if diagonal pivoting is attempted.\n", (long) (15), relpt2) ; } }
    ...
    scale = ((Control != (double *) 
# 271 "umfpack_report_control.c" 3 4
           ((void *)0)
# 271 "umfpack_report_control.c"
           ) ? (((Control [16]) != (Control [16])) ? 1 : Control [16]) : 1) ;
    if (scale != 0 && scale != 2)
    {
 scale = 1 ;
    }
    { if (SuiteSparse_config.printf_func != 
# 276 "umfpack_report_control.c" 3 4
   ((void *)0)
# 276 "umfpack_report_control.c"
   ) { (void) (SuiteSparse_config.printf_func) ("    ""%" "ld"": scaling: ""%" "ld", (long) (16), scale) ; } } ;
    if (scale == 0)
    {
 { if (SuiteSparse_config.printf_func != 
# 279 "umfpack_report_control.c" 3 4
((void *)0)
# 279 "umfpack_report_control.c"
) { (void) (SuiteSparse_config.printf_func) (" (no)") ; } } ;
    }
    else if (scale == 1)
    {
 { if (SuiteSparse_config.printf_func != 
# 283 "umfpack_report_control.c" 3 4
((void *)0)
# 283 "umfpack_report_control.c"
) { (void) (SuiteSparse_config.printf_func) (" (divide each row by sum of abs. values in each row)") ; } } ;
    }
    else if (scale == 2)
    {
 { if (SuiteSparse_config.printf_func != 
# 287 "umfpack_report_control.c" 3 4
((void *)0)
# 287 "umfpack_report_control.c"
) { (void) (SuiteSparse_config.printf_func) (" (divide each row by max. abs. value in each row)") ; } } ;
    }
    { if (SuiteSparse_config.printf_func != 
# 289 "umfpack_report_control.c" 3 4
   ((void *)0)
# 289 "umfpack_report_control.c"
   ) { (void) (SuiteSparse_config.printf_func) ("\n") ; } } ;
    ...
    front_alloc_init = ((Control != (double *) 
# 295 "umfpack_report_control.c" 3 4
                      ((void *)0)
# 295 "umfpack_report_control.c"
                      ) ? (((Control [17]) != (Control [17])) ? 0.5 : Control [17]) : 0.5)
                                   ;
    front_alloc_init = (((1.0) < (front_alloc_init)) ? (1.0) : (front_alloc_init)) ;
    if (front_alloc_init >= 0)
    {
 { if (SuiteSparse_config.printf_func != 
# 300 "umfpack_report_control.c" 3 4
((void *)0)
# 300 "umfpack_report_control.c"
) { (void) (SuiteSparse_config.printf_func) ("    ""%" "ld"": frontal matrix allocation ratio: %g\n", (long) (17), front_alloc_init) ; } }
                                                            ;
    }
    else
    {
 ...
 s = (((1) > (s)) ? (1) : (s)) ;
 { if (SuiteSparse_config.printf_func != 
# 307 "umfpack_report_control.c" 3 4
((void *)0)
# 307 "umfpack_report_control.c"
) { (void) (SuiteSparse_config.printf_func) ("    ""%" "ld"": initial frontal matrix size (# of Entry's): ""%" "ld""\n", (long) (17), s) ; } }
                                             ;
    }
    ...
    droptol = ((Control != (double *) 
# 315 "umfpack_report_control.c" 3 4
             ((void *)0)
# 315 "umfpack_report_control.c"
             ) ? (((Control [18]) != (Control [18])) ? 0 : Control [18]) : 0) ;
    { if (SuiteSparse_config.printf_func != 
# 316 "umfpack_report_control.c" 3 4
   ((void *)0)
# 316 "umfpack_report_control.c"
   ) { (void) (SuiteSparse_config.printf_func) ("    ""%" "ld"": drop tolerance: %g\n", (long) (18), droptol) ; } }
                                          ;
    ...
    aggr = ((Control != (double *) 
# 323 "umfpack_report_control.c" 3 4
          ((void *)0)
# 323 "umfpack_report_control.c"
          ) ? (((Control [19]) != (Control [19])) ? 1 : Control [19]) : 1) ;
    { if (SuiteSparse_config.printf_func != 
# 324 "umfpack_report_control.c" 3 4
   ((void *)0)
# 324 "umfpack_report_control.c"
   ) { (void) (SuiteSparse_config.printf_func) ("    ""%" "ld"": AMD and COLAMD aggressive absorption: %g", (long) (19), aggr) ; } }
                                          ;
    if (aggr != 0.0)
    {
 { if (SuiteSparse_config.printf_func != 
# 328 "umfpack_report_control.c" 3 4
((void *)0)
# 328 "umfpack_report_control.c"
) { (void) (SuiteSparse_config.printf_func) (" (yes)\n") ; } } ;
    }
    else
    {
 { if (SuiteSparse_config.printf_func != 
# 332 "umfpack_report_control.c" 3 4
((void *)0)
# 332 "umfpack_report_control.c"
) { (void) (SuiteSparse_config.printf_func) (" (no)\n") ; } } ;
    }
    ...
    { if (SuiteSparse_config.printf_func != 
# 339 "umfpack_report_control.c" 3 4
   ((void *)0)
# 339 "umfpack_report_control.c"
   ) { (void) (SuiteSparse_config.printf_func) ( "\n    The following options can only be changed at compile-time:\n") ; } }
                                                                        ;

    { if (SuiteSparse_config.printf_func != 
# 342 "umfpack_report_control.c" 3 4
   ((void *)0)
# 342 "umfpack_report_control.c"
   ) { (void) (SuiteSparse_config.printf_func) ("    ""%" "ld"": BLAS library used:  ", (long) (8)) ; } }
                                            ;
    ...
    { if (SuiteSparse_config.printf_func != 
# 348 "umfpack_report_control.c" 3 4
   ((void *)0)
# 348 "umfpack_report_control.c"
    ...
    { if (SuiteSparse_config.printf_func != 
# 355 "umfpack_report_control.c" 3 4
   ((void *)0)
# 355 "umfpack_report_control.c"
   ) { (void) (SuiteSparse_config.printf_func) ("    compiled for ANSI C\n") ; } } ;



    { if (SuiteSparse_config.printf_func != 
# 359 "umfpack_report_control.c" 3 4
   ((void *)0)
# 359 "umfpack_report_control.c"
   ) { (void) (SuiteSparse_config.printf_func) ("    POSIX C clock_getttime.\n") ; } } ;




    { if (SuiteSparse_config.printf_func != 
# 364 "umfpack_report_control.c" 3 4
   ((void *)0)
# 364 "umfpack_report_control.c"
   ) { (void) (SuiteSparse_config.printf_func) ("    computer/operating system: %s\n", "Linux") ; } } ;
    { if (SuiteSparse_config.printf_func != 
# 365 "umfpack_report_control.c" 3 4
   ((void *)0)
# 365 "umfpack_report_control.c"
   ) { (void) (SuiteSparse_config.printf_func) ("    size of int: %g SuiteSparse_long: %g Int: %g pointer: %g" " double: %g Entry: %g (in bytes)\n\n", (double) sizeof (int), (double) sizeof (long), (double) sizeof (long), (double) sizeof (void *), (double) sizeof (double), (double) sizeof (DoubleComplex)) ; } }
