...
)
{
    ...
    DoubleComplex axx, wi, xj, zi, xi, aij, bi ;
    double omega [3], d, z2i, yi, flops ;
    DoubleComplex *W, *Z, *S, *X ;
    double *Z2, *Y, *B2, *Rs ;
    long *Rperm, *Cperm, i, n, p, step, j, nz, status, p2, do_scale ;

    long AXsplit ;
    long Bsplit ;


    long do_recip = Numeric->do_recip ;
# 101 "umf_solve.c"
    nz = 0 ;
    omega [0] = 0. ;
    omega [1] = 0. ;
...
# 148 "umf_solve.c"
 ...
 Z = (DoubleComplex *) (SolveWork + 4*n) ;
 S = (DoubleComplex *) (SolveWork + 6*n) ;
 ...
 if (irstep > 0)
 {
  ...
  Y [i] = 0. ;
     ...
     for (p = 0 ; p < p2 ; p++)
     {
         ...
         { if (AXsplit) { (aij).component [0] = (Ax)[p] ; (aij).component [1] = (Az)[p] ; } else { (aij) = ((DoubleComplex *)(Ax))[p] ; } } ;
  { (d) = SuiteSparse_config.hypot_func ((aij).component [0], (aij).component [1]) ; } ;
  Y [Ai [p]] += d ;
     }
  ...
  { if (Bsplit) { (bi).component [0] = (Bx)[i] ; (bi).component [1] = (Bz)[i] ; } else { (bi) = ((DoubleComplex *)(Bx))[i] ; } } ;
  { (B2 [i]) = SuiteSparse_config.hypot_func ((bi).component [0], (bi).component [1]) ; } ;
     }
...
# 273 "umf_solve.c"
  ...
  if (do_scale)
  {
   ...
   for (i = 0 ; i < n ; i++)
   {
       { if (Bsplit) { (X [i]).component [0] = (Bx)[i] ; (X [i]).component [1] = (Bz)[i] ; } else { (X [i]) = ((DoubleComplex *)(Bx))[i] ; } } ;
       { (X [i]).component [0] *= (Rs [i]) ; (X [i]).component [1] *= (Rs [i]) ; } ;
   }
      }
      else
  ...
  else
  {
   ...
   { if (Bsplit) { (W [i]).component [0] = (Bx)[Rperm [i]] ; (W [i]).component [1] = (Bz)[Rperm [i]] ; } else { (W [i]) = ((DoubleComplex *)(Bx))[Rperm [i]] ; } } ;
      }
  }
     }
     else
  ...
  for (i = 0 ; i < n ; i++)
  {
      ...
      { if (Bsplit) { (Z [i]).component [0] = (Bx)[i] ; (Z [i]).component [1] = (Bz)[i] ; } else { (Z [i]) = ((DoubleComplex *)(Bx))[i] ; } } ;
  }
  flops += 8. * nz ;
  for (i = 0 ; i < n ; i++)
  {
   ...
   { if (AXsplit) { (aij).component [0] = (Ax)[p] ; (aij).component [1] = (Az)[p] ; } else { (aij) = ((DoubleComplex *)(Ax))[p] ; } } ;
   { ; (Z [Ai [p]]).component [0] -= (aij).component [0] * (xi).component [0] - (aij).component [1] * (xi).component [1] ; (Z [Ai [p]]).component [1] -= (aij).component [1] * (xi).component [0] + (aij).component [0] * (xi).component [1] ; } ;
      }
  }
  ...
  if (do_scale)
  {
   ...
   for (i = 0 ; i < n ; i++)
   {
       { (Z [i]).component [0] *= (Rs [i]) ; (Z [i]).component [1] *= (Rs [i]) ; } ;
   }
      }
      else
  ...
  for (i = 0 ; i < n ; i++)
  {
     ...
     flops += umfzl_lsolve (Numeric, W, Pattern) ;
     flops += umfzl_usolve (Numeric, W, Pattern) ;
  ...
  for (i = 0 ; i < n ; i++)
  {
      ...
      { (X [Cperm [i]]).component [0] += (W [i]).component [0] ; (X [Cperm [i]]).component [1] += (W [i]).component [1] ; } ;
  }
     }
  ...
  for (i = 0 ; i < n ; i++)
  {
      ...
      { if (Bsplit) { (W [i]).component [0] = (Bx)[i] ; (W [i]).component [1] = (Bz)[i] ; } else { (W [i]) = ((DoubleComplex *)(Bx))[i] ; } } ;
      Z2 [i] = 0. ;
  }
  flops += (6. + 2. + 6. + 1) * nz ;
  for (j = 0 ; j < n ; j++)
  {
   ...
   { if (AXsplit) { (aij).component [0] = (Ax)[p] ; (aij).component [1] = (Az)[p] ; } else { (aij) = ((DoubleComplex *)(Ax))[p] ; } } ;
   { ; (axx).component [0] = (aij).component [0] * (xj).component [0] - (aij).component [1] * (xj).component [1] ; (axx).component [1] = (aij).component [1] * (xj).component [0] + (aij).component [0] * (xj).component [1] ; } ;


   { (W [i]).component [0] -= (axx).component [0] ; (W [i]).component [1] -= (axx).component [1] ; } ;


   { (d) = SuiteSparse_config.hypot_func ((axx).component [0], (axx).component [1]) ; } ;
   Z2 [i] += d ;
      }
  }
  ...
  if (do_scale)
  {
   ...
   for (i = 0 ; i < n ; i++)
   {
       { (W [i]).component [0] *= (Rs [i]) ; (W [i]).component [1] *= (Rs [i]) ; } ;
       Z2 [i] *= Rs [i] ;
   }
      }
      else
...
# 571 "umf_solve.c"
  ...
  for (i = 0 ; i < n ; i++)
  {
      ...
      { if (Bsplit) { (W [i]).component [0] = (Bx)[Cperm [i]] ; (W [i]).component [1] = (Bz)[Cperm [i]] ; } else { (W [i]) = ((DoubleComplex *)(Bx))[Cperm [i]] ; } } ;
  }
     }
     else
     {
  ...
  for (i = 0 ; i < n ; i++)
  {
   ...
   { if (Bsplit) { (aij).component [0] = (Ax)[p] ; (aij).component [1] = (Az)[p] ; } else { (aij) = ((DoubleComplex *)(Ax))[p] ; } } ;
   { ; (zi).component [0] -= (X [Ai [p]]).component [0] * (aij).component [0] + (X [Ai [p]]).component [1] * (aij).component [1] ; (zi).component [1] -= (X [Ai [p]]).component [1] * (aij).component [0] - (X [Ai [p]]).component [0] * (aij).component [1] ; } ;
      }
      Z [i] = zi ;
  }
  ...
  for (i = 0 ; i < n ; i++)
  {
     ...
     flops += umfzl_uhsolve (Numeric, W, Pattern) ;
     flops += umfzl_lhsolve (Numeric, W, Pattern) ;
  ...
  for (i = 0 ; i < n ; i++)
  {
      ...
      { (X [i]).component [0] += (Z [i]).component [0] ; (X [i]).component [1] += (Z [i]).component [1] ; } ;
  }
     }
  ...
  for (i = 0 ; i < n ; i++)
  {
      ...
      { if (Bsplit) { (wi).component [0] = (Bx)[i] ; (wi).component [1] = (Bz)[i] ; } else { (wi) = ((DoubleComplex *)(Bx))[i] ; } } ;
      z2i = 0. ;
      p2 = Ap [i+1] ;
      for (p = Ap [i] ; p < p2 ; p++)
      {
   ...
   { if (AXsplit) { (aij).component [0] = (Ax)[p] ; (aij).component [1] = (Az)[p] ; } else { (aij) = ((DoubleComplex *)(Ax))[p] ; } } ;
   { ; (axx).component [0] = (X [Ai [p]]).component [0] * (aij).component [0] + (X [Ai [p]]).component [1] * (aij).component [1] ; (axx).component [1] = (X [Ai [p]]).component [1] * (aij).component [0] - (X [Ai [p]]).component [0] * (aij).component [1] ; } ;


   { (wi).component [0] -= (axx).component [0] ; (wi).component [1] -= (axx).component [1] ; } ;
...
# 844 "umf_solve.c"
  ...
  for (i = 0 ; i < n ; i++)
  {
   ...
   { if (AXsplit) { (aij).component [0] = (Ax)[p] ; (aij).component [1] = (Az)[p] ; } else { (aij) = ((DoubleComplex *)(Ax))[p] ; } } ;
   { ; (zi).component [0] -= (aij).component [0] * (X [Ai [p]]).component [0] - (aij).component [1] * (X [Ai [p]]).component [1] ; (zi).component [1] -= (aij).component [1] * (X [Ai [p]]).component [0] + (aij).component [0] * (X [Ai [p]]).component [1] ; } ;
      }
      Z [i] = zi ;
  }
  ...
  for (i = 0 ; i < n ; i++)
  {
     ...
     flops += umfzl_utsolve (Numeric, W, Pattern) ;
     flops += umfzl_ltsolve (Numeric, W, Pattern) ;
  ...
  for (i = 0 ; i < n ; i++)
  {
   ...
   { if (AXsplit) { (aij).component [0] = (Ax)[p] ; (aij).component [1] = (Az)[p] ; } else { (aij) = ((DoubleComplex *)(Ax))[p] ; } } ;
   { ; (axx).component [0] = (aij).component [0] * (X [Ai [p]]).component [0] - (aij).component [1] * (X [Ai [p]]).component [1] ; (axx).component [1] = (aij).component [1] * (X [Ai [p]]).component [0] + (aij).component [0] * (X [Ai [p]]).component [1] ; } ;
 ...
 for (i = 0 ; i < n ; i++)
 {
     ...
     { if (Bsplit) { (X [i]).component [0] = (Bx)[Rperm [i]] ; (X [i]).component [1] = (Bz)[Rperm [i]] ; } else { (X [i]) = ((DoubleComplex *)(Bx))[Rperm [i]] ; } } ;
 }
 flops = umfzl_lsolve (Numeric, X, Pattern) ;
 status = (0) ;
 ...
 flops = umfzl_lhsolve (Numeric, X, Pattern) ;
 status = (0) ;
 ...
 flops = umfzl_ltsolve (Numeric, X, Pattern) ;
 status = (0) ;
 ...
 flops = umfzl_usolve (Numeric, X, Pattern) ;
 ...
 for (i = 0 ; i < n ; i++)
 {
     ...
     { if (Bsplit) { (X [i]).component [0] = (Bx)[Cperm [i]] ; (X [i]).component [1] = (Bz)[Cperm [i]] ; } else { (X [i]) = ((DoubleComplex *)(Bx))[Cperm [i]] ; } } ;
 }
 flops = umfzl_uhsolve (Numeric, X, Pattern) ;
 ...
 flops = umfzl_utsolve (Numeric, X, Pattern) ;
 ...
 for (i = 0 ; i < n ; i++)
 {
     Xx [i] = ((X [i]).component [0]) ;
     Xz [i] = ((X [i]).component [1]) ;
 }
    }
...
)
{
    ...
    nctau = 1000 * n * ((double)2.22044604925031308084726333618164e-16L) ;
    ;
...
# 1270 "umf_solve.c"
 ...
 { (xi) = SuiteSparse_config.hypot_func ((X [i]).component [0], (X [i]).component [1]) ; } ;
 if (((xi) != (xi)))
 {
     xnorm = xi ;
     break ;
 ...
 { (wi) = SuiteSparse_config.hypot_func ((W [i]).component [0], (W [i]).component [1]) ; } ;
 if (((d1) != (d1)))
 {
     omega [1] = d1 ;
     omega [2] = d1 ;
 ...
 {
     wd1 = wi / d1 ;
     omega [1] = (((omega [1]) > (wd1)) ? (omega [1]) : (wd1)) ;
 }
 else if (tau > 0.0)
 {
     d2 = Z2 [i] + yix ;
     wd2 = wi / d2 ;
     omega [2] = (((omega [2]) > (wd2)) ? (omega [2]) : (wd2)) ;
 }
    }
 ...
 return ((1)) ;
    ...
    if (omega [0] < ((double)2.22044604925031308084726333618164e-16L))
    {
 ;
 ...
 if (omega [0] > last_omega [0])
 {
  ...
  X [i] = S [i] ;
     ...
     Info [82] = last_omega [1] ;
     Info [83] = last_omega [2] ;
 }
 Info [80] = step - 1 ;
