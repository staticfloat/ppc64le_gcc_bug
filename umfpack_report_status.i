# 1 "umfpack_report_status.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "umfpack_report_status.c"
# 15 "umfpack_report_status.c"
# 1 "umf_internal.h" 1
# 25 "umf_internal.h"
...
)
{
    ...
    prl = ((Control != (double *) 
# 29 "umfpack_report_status.c" 3 4
         ((void *)0)
# 29 "umfpack_report_status.c"
...
# 48 "umfpack_report_status.c" 3 4
   ((void *)0)
# 48 "umfpack_report_status.c"
   ) { (void) (SuiteSparse_config.printf_func) ("\n") ; } } ;
    { if (prl >= (4)) { { if (SuiteSparse_config.printf_func != 
# 49 "umfpack_report_status.c" 3 4
   ((void *)0)
# 49 "umfpack_report_status.c"
   ) { (void) (SuiteSparse_config.printf_func) ("%s\n", "UMFPACK:  Copyright (c) 2005-2013 by Timothy A. Davis.  All Rights Reserved.\n") ; } } ; } } ;
    { if (prl >= (6)) { { if (SuiteSparse_config.printf_func != 
# 50 "umfpack_report_status.c" 3 4
   ((void *)0)
# 50 "umfpack_report_status.c"
    ...
    { if (prl >= (6)) { { if (SuiteSparse_config.printf_func != 
# 51 "umfpack_report_status.c" 3 4
   ((void *)0)
# 51 "umfpack_report_status.c"
    ...
    { if (prl >= (6)) { { if (SuiteSparse_config.printf_func != 
# 52 "umfpack_report_status.c" 3 4
   ((void *)0)
# 52 "umfpack_report_status.c"
   ) { (void) (SuiteSparse_config.printf_func) ("%s", "\n" "Availability: http://www.suitesparse.com" "\n") ; } } ; } } ;
    { if (SuiteSparse_config.printf_func != 
# 53 "umfpack_report_status.c" 3 4
   ((void *)0)
# 53 "umfpack_report_status.c"
   ) { (void) (SuiteSparse_config.printf_func) ("UMFPACK V%d.%d.%d (%s): ", 5, 7, 1, "Oct 10, 2014") ; } }
                                                             ;
 ...
 case (0):
     { if (SuiteSparse_config.printf_func != 
# 59 "umfpack_report_status.c" 3 4
    ((void *)0)
# 59 "umfpack_report_status.c"
    ) { (void) (SuiteSparse_config.printf_func) ("OK\n") ; } } ;
     break ;

 case (1):
     { if (SuiteSparse_config.printf_func != 
# 63 "umfpack_report_status.c" 3 4
    ((void *)0)
# 63 "umfpack_report_status.c"
    ) { (void) (SuiteSparse_config.printf_func) ("WARNING: matrix is singular\n") ; } } ;
     break ;

 case (-1):
     { if (SuiteSparse_config.printf_func != 
# 67 "umfpack_report_status.c" 3 4
    ((void *)0)
# 67 "umfpack_report_status.c"
    ) { (void) (SuiteSparse_config.printf_func) ("ERROR: out of memory\n") ; } } ;
     break ;

 case (-3):
     { if (SuiteSparse_config.printf_func != 
# 71 "umfpack_report_status.c" 3 4
    ((void *)0)
# 71 "umfpack_report_status.c"
    ) { (void) (SuiteSparse_config.printf_func) ("ERROR: Numeric object is invalid\n") ; } } ;
     break ;

 case (-4):
     { if (SuiteSparse_config.printf_func != 
# 75 "umfpack_report_status.c" 3 4
    ((void *)0)
# 75 "umfpack_report_status.c"
    ) { (void) (SuiteSparse_config.printf_func) ("ERROR: Symbolic object is invalid\n") ; } } ;
     break ;

 case (-5):
     { if (SuiteSparse_config.printf_func != 
# 79 "umfpack_report_status.c" 3 4
    ((void *)0)
# 79 "umfpack_report_status.c"
    ) { (void) (SuiteSparse_config.printf_func) ("ERROR: required argument(s) missing\n") ; } } ;
     break ;

 case (-6):
     { if (SuiteSparse_config.printf_func != 
# 83 "umfpack_report_status.c" 3 4
    ((void *)0)
# 83 "umfpack_report_status.c"
    ) { (void) (SuiteSparse_config.printf_func) ("ERROR: dimension (n_row or n_col) must be > 0\n") ; } } ;
     break ;

 case (-8):
     { if (SuiteSparse_config.printf_func != 
# 87 "umfpack_report_status.c" 3 4
    ((void *)0)
# 87 "umfpack_report_status.c"
    ) { (void) (SuiteSparse_config.printf_func) ("ERROR: input matrix is invalid\n") ; } } ;
     break ;

 case (-13):
     { if (SuiteSparse_config.printf_func != 
# 91 "umfpack_report_status.c" 3 4
    ((void *)0)
# 91 "umfpack_report_status.c"
    ) { (void) (SuiteSparse_config.printf_func) ("ERROR: system argument invalid\n") ; } } ;
     break ;

 case (-15):
     { if (SuiteSparse_config.printf_func != 
# 95 "umfpack_report_status.c" 3 4
    ((void *)0)
# 95 "umfpack_report_status.c"
    ) { (void) (SuiteSparse_config.printf_func) ("ERROR: invalid permutation\n") ; } } ;
     break ;

 case (-11):
     { if (SuiteSparse_config.printf_func != 
# 99 "umfpack_report_status.c" 3 4
    ((void *)0)
# 99 "umfpack_report_status.c"
    ) { (void) (SuiteSparse_config.printf_func) ("ERROR: pattern of matrix (Ap and/or Ai) has changed\n") ; } } ;
     break ;

        case (-18):
     { if (SuiteSparse_config.printf_func != 
# 103 "umfpack_report_status.c" 3 4
    ((void *)0)
# 103 "umfpack_report_status.c"
    ) { (void) (SuiteSparse_config.printf_func) ("ERROR: ordering failed\n") ; } } ;
     break ;

 case (-911):
     { if (SuiteSparse_config.printf_func != 
# 107 "umfpack_report_status.c" 3 4
    ((void *)0)
# 107 "umfpack_report_status.c"
    ) { (void) (SuiteSparse_config.printf_func) ("INTERNAL ERROR!\n" "Input arguments might be corrupted or aliased, or an internal\n" "error has occurred.  Check your input arguments with the\n" "umfpack_*_report_* routines before calling the umfpack_*\n" "computational routines.  Recompile UMFPACK with debugging\n" "enabled, and look for failed assertions.  If all else fails\n" "please report this error to Tim Davis\n" "(DrTimothyAldenDavis@gmail.com).\n" ) ; } }
 ...
 default:
     { if (SuiteSparse_config.printf_func != 
# 119 "umfpack_report_status.c" 3 4
    ((void *)0)
# 119 "umfpack_report_status.c"
    ) { (void) (SuiteSparse_config.printf_func) ("ERROR: Unrecognized error code: ""%" "ld""\n", status) ; } } ;

    }
    { if (SuiteSparse_config.printf_func != 
# 122 "umfpack_report_status.c" 3 4
   ((void *)0)
# 122 "umfpack_report_status.c"
   ) { (void) (SuiteSparse_config.printf_func) ("\n") ; } } ;
}
