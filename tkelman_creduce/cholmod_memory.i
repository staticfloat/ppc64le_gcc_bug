# 1 "CHOLMOD/Core/cholmod_memory.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "CHOLMOD/Core/cholmod_memory.c"
# 50 "CHOLMOD/Core/cholmod_memory.c"
...
# 51 "CHOLMOD/Core/cholmod_memory.c" 2
...
# 52 "CHOLMOD/Core/cholmod_memory.c" 2
# 60 "CHOLMOD/Core/cholmod_memory.c"
size_t cholmod_l_add_size_t (size_t a, size_t b, int *ok)
{
    size_t s = a + b ;
    (*ok) = (*ok) && (s >= a) ;
...
# 75 "CHOLMOD/Core/cholmod_memory.c"
size_t cholmod_l_mult_size_t (size_t a, size_t k, int *ok)
{
    size_t p = 0, s ;
    while (*ok)
...
# 114 "CHOLMOD/Core/cholmod_memory.c"
void *cholmod_l_malloc
(
...
)
{
    ...
    { if (Common == 
# 129 "CHOLMOD/Core/cholmod_memory.c" 3 4
   ((void *)0)
# 129 "CHOLMOD/Core/cholmod_memory.c"
   ) { return (
# 129 "CHOLMOD/Core/cholmod_memory.c" 3 4
   ((void *)0)
# 129 "CHOLMOD/Core/cholmod_memory.c"
...
# 129 "CHOLMOD/Core/cholmod_memory.c"
    ...
    if (size == 0)
    {
 cholmod_l_error ((-4), "CHOLMOD/Core/cholmod_memory.c", 132, "sizeof(item) must be > 0", Common) ;
 p = 
# 133 "CHOLMOD/Core/cholmod_memory.c" 3 4
    ((void *)0) 
# 133 "CHOLMOD/Core/cholmod_memory.c"
         ;
    }
    else if (n >= (((size_t) (-1)) / size) || n >= 0x7fffffffffffffffL)
    {

 cholmod_l_error ((-3), "CHOLMOD/Core/cholmod_memory.c", 138, "problem too large", Common) ;
 p = 
# 139 "CHOLMOD/Core/cholmod_memory.c" 3 4
    ((void *)0) 
# 139 "CHOLMOD/Core/cholmod_memory.c"
         ;
    }
    else
    {
 ...
 if (p == 
# 146 "CHOLMOD/Core/cholmod_memory.c" 3 4
         ((void *)0)
# 146 "CHOLMOD/Core/cholmod_memory.c"
             )
 {

     cholmod_l_error ((-2), "CHOLMOD/Core/cholmod_memory.c", 149, "out of memory", Common) ;
 }
 else
 {
     ...
     Common->memory_usage =
  (((Common->memory_usage) > (Common->memory_inuse)) ? (Common->memory_usage) : (Common->memory_inuse)) ;
...
# 185 "CHOLMOD/Core/cholmod_memory.c"
void *cholmod_l_free
(
...
{
    { if (Common == 
# 196 "CHOLMOD/Core/cholmod_memory.c" 3 4
   ((void *)0)
# 196 "CHOLMOD/Core/cholmod_memory.c"
   ) { return (
# 196 "CHOLMOD/Core/cholmod_memory.c" 3 4
   ((void *)0)
# 196 "CHOLMOD/Core/cholmod_memory.c"
...
# 196 "CHOLMOD/Core/cholmod_memory.c"
    ...
    if (p != 
# 197 "CHOLMOD/Core/cholmod_memory.c" 3 4
            ((void *)0)
# 197 "CHOLMOD/Core/cholmod_memory.c"
                )
    {
 ...
 ;
    ...
    return (
# 215 "CHOLMOD/Core/cholmod_memory.c" 3 4
           ((void *)0)
# 215 "CHOLMOD/Core/cholmod_memory.c"
               ) ;
}
# 230 "CHOLMOD/Core/cholmod_memory.c"
void *cholmod_l_calloc
(
...
)
{
    ...
    { if (Common == 
# 241 "CHOLMOD/Core/cholmod_memory.c" 3 4
   ((void *)0)
# 241 "CHOLMOD/Core/cholmod_memory.c"
   ) { return (
# 241 "CHOLMOD/Core/cholmod_memory.c" 3 4
   ((void *)0)
# 241 "CHOLMOD/Core/cholmod_memory.c"
...
# 241 "CHOLMOD/Core/cholmod_memory.c"
    ...
    if (size == 0)
    {
 cholmod_l_error ((-4), "CHOLMOD/Core/cholmod_memory.c", 244, "sizeof(item) must be > 0", Common) ;
 p = 
# 245 "CHOLMOD/Core/cholmod_memory.c" 3 4
    ((void *)0) 
# 245 "CHOLMOD/Core/cholmod_memory.c"
         ;
    }
    else if (n >= (((size_t) (-1)) / size) || n >= 0x7fffffffffffffffL)
    {

 cholmod_l_error ((-3), "CHOLMOD/Core/cholmod_memory.c", 250, "problem too large", Common) ;
 p = 
# 251 "CHOLMOD/Core/cholmod_memory.c" 3 4
    ((void *)0) 
# 251 "CHOLMOD/Core/cholmod_memory.c"
         ;
    }
    else
    {
 ...
 if (p == 
# 258 "CHOLMOD/Core/cholmod_memory.c" 3 4
         ((void *)0)
# 258 "CHOLMOD/Core/cholmod_memory.c"
             )
 {

     cholmod_l_error ((-2), "CHOLMOD/Core/cholmod_memory.c", 261, "out of memory", Common) ;
 }
 else
 {
...
# 300 "CHOLMOD/Core/cholmod_memory.c"
void *cholmod_l_realloc
(
...
)
{
    ...
    { if (Common == 
# 317 "CHOLMOD/Core/cholmod_memory.c" 3 4
   ((void *)0)
# 317 "CHOLMOD/Core/cholmod_memory.c"
   ) { return (
# 317 "CHOLMOD/Core/cholmod_memory.c" 3 4
   ((void *)0)
# 317 "CHOLMOD/Core/cholmod_memory.c"
...
# 317 "CHOLMOD/Core/cholmod_memory.c"
    ...
    if (size == 0)
    {
 cholmod_l_error ((-4), "CHOLMOD/Core/cholmod_memory.c", 320, "sizeof(item) must be > 0", Common) ;
 p = 
# 321 "CHOLMOD/Core/cholmod_memory.c" 3 4
    ((void *)0) 
# 321 "CHOLMOD/Core/cholmod_memory.c"
         ;
    }
    else if (p == 
# 323 "CHOLMOD/Core/cholmod_memory.c" 3 4
                 ((void *)0)
# 323 "CHOLMOD/Core/cholmod_memory.c"
                     )
    {

 ;
 p = cholmod_l_malloc (nnew, size, Common) ;
 *n = (p == 
# 328 "CHOLMOD/Core/cholmod_memory.c" 3 4
           ((void *)0)
# 328 "CHOLMOD/Core/cholmod_memory.c"
               ) ? 0 : nnew ;
    }
    else if (nold == nnew)
    {
 ...
 ;
    ...
    else if (nnew >= (((size_t) (-1)) / size) || nnew >= 0x7fffffffffffffffL)
    {

 cholmod_l_error ((-3), "CHOLMOD/Core/cholmod_memory.c", 338, "problem too large", Common) ;
    }
    else
    {
     ...
     *n = nnew ;
     Common->memory_inuse += ((nnew-nold) * size) ;
        ...
        else
        {
            ...
            cholmod_l_error ((-2), "CHOLMOD/Core/cholmod_memory.c", 363, "out of memory", Common) ;
        }

 Common->memory_usage = (((Common->memory_usage) > (Common->memory_inuse)) ? (Common->memory_usage) : (Common->memory_inuse));
    }

    return (p) ;
}
# 383 "CHOLMOD/Core/cholmod_memory.c"
int cholmod_l_realloc_multiple
(
...
)
{
    ...
    { if (Common == 
# 403 "CHOLMOD/Core/cholmod_memory.c" 3 4
   ((void *)0)
# 403 "CHOLMOD/Core/cholmod_memory.c"
   ) { return (0) ; } if (Common->itype != 2 || Common->dtype != 0) { Common->status = (-4) ; return (0) ; } } ;

    if (xtype < 0 || xtype > 3)
    {
 cholmod_l_error ((-4), "CHOLMOD/Core/cholmod_memory.c", 407, "invalid xtype", Common) ;
 return (0) ;
    }
 ...
 return (1) ;
    ...
    if (nint > 0)
    {
 *Iblock = cholmod_l_realloc (nnew, sizeof (long), *Iblock, &i, Common) ;
    }
    if (nint > 1)
    {
 *Jblock = cholmod_l_realloc (nnew, sizeof (long), *Jblock, &j, Common) ;
    }

    switch (xtype)
    {
 case 1:
     *Xblock = cholmod_l_realloc (nnew, sizeof (double), *Xblock, &x,
                    Common) ;
     break ;

 case 2:
     *Xblock = cholmod_l_realloc (nnew, 2*sizeof (double), *Xblock, &x,
                    Common) ;
     break ;
 ...
 case 3:
     *Xblock = cholmod_l_realloc (nnew, sizeof (double), *Xblock, &x,
                    Common) ;
     *Zblock = cholmod_l_realloc (nnew, sizeof (double), *Zblock, &z,
                    Common) ;
     break ;
    }
 ...
 if (nold == 0)
 {
     ...
     if (nint > 0)
     {
  *Iblock = cholmod_l_free (i, sizeof (long), *Iblock, Common) ;
     }
     if (nint > 1)
     {
  *Jblock = cholmod_l_free (j, sizeof (long), *Jblock, Common) ;
     }

     switch (xtype)
     {
  case 1:
      *Xblock = cholmod_l_free (x, sizeof (double), *Xblock,
                            Common) ;
      break ;

  case 2:
      *Xblock = cholmod_l_free (x, 2*sizeof (double), *Xblock,
                            Common) ;
      break ;
  ...
  case 3:
      *Xblock = cholmod_l_free (x, sizeof (double), *Xblock,
                            Common) ;
      *Zblock = cholmod_l_free (x, sizeof (double), *Zblock,
                            Common) ;
      break ;
     }
 ...
 else
 {
     if (nint > 0)
     {
  *Iblock = cholmod_l_realloc (nold, sizeof (long), *Iblock, &i,
                            Common) ;
     }
     if (nint > 1)
     {
  *Jblock = cholmod_l_realloc (nold, sizeof (long), *Jblock, &j,
                            Common) ;
     }
     ...
     {
  case 1:
      *Xblock = cholmod_l_realloc (nold, sizeof (double),
                            *Xblock, &x, Common) ;
      break ;

  case 2:
      *Xblock = cholmod_l_realloc (nold, 2*sizeof (double),
                            *Xblock, &x, Common) ;
      break ;
  ...
  case 3:
      *Xblock = cholmod_l_realloc (nold, sizeof (double),
                            *Xblock, &x, Common) ;
      *Zblock = cholmod_l_realloc (nold, sizeof (double),
                            *Zblock, &z, Common) ;
      break ;
     }
