# 1 "UMFPACK/Source/umf_cholmod.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "UMFPACK/Source/umf_cholmod.c"
# 14 "UMFPACK/Source/umf_cholmod.c"
...
# 15 "UMFPACK/Source/umf_cholmod.c" 2
...
# 16 "UMFPACK/Source/umf_cholmod.c" 2


# 1 "CHOLMOD/Include/cholmod.h" 1
# 84 "CHOLMOD/Include/cholmod.h"
# 1 "CHOLMOD/Include/cholmod_io64.h" 1
# 85 "CHOLMOD/Include/cholmod.h" 2



# 1 "CHOLMOD/Include/cholmod_config.h" 1
# 89 "CHOLMOD/Include/cholmod.h" 2
...
# 93 "CHOLMOD/Include/cholmod.h" 2


# 1 "CHOLMOD/Include/cholmod_check.h" 1
# 76 "CHOLMOD/Include/cholmod_check.h"
...
int cholmod_l_write_dense (FILE *, cholmod_dense *, const char *,
    cholmod_common *) ;
# 96 "CHOLMOD/Include/cholmod.h" 2



# 1 "CHOLMOD/Include/cholmod_cholesky.h" 1
# 67 "CHOLMOD/Include/cholmod_cholesky.h"
...
# 100 "CHOLMOD/Include/cholmod.h" 2



# 1 "CHOLMOD/Include/cholmod_matrixops.h" 1
# 44 "CHOLMOD/Include/cholmod_matrixops.h"
int cholmod_drop
(
...
cholmod_sparse *cholmod_l_horzcat (cholmod_sparse *, cholmod_sparse *, int,
    cholmod_common *) ;
# 113 "CHOLMOD/Include/cholmod_matrixops.h"
int cholmod_scale
(
...
cholmod_sparse *cholmod_l_ssmult (cholmod_sparse *, cholmod_sparse *, int, int,
    int, cholmod_common *) ;
# 180 "CHOLMOD/Include/cholmod_matrixops.h"
...
int cholmod_l_symmetry (cholmod_sparse *, int, long *,
    long *, long *, long *,
    cholmod_common *) ;
# 104 "CHOLMOD/Include/cholmod.h" 2



# 1 "CHOLMOD/Include/cholmod_modify.h" 1
# 58 "CHOLMOD/Include/cholmod_modify.h"
int cholmod_updown
(
...
int cholmod_l_updown (int, cholmod_sparse *, cholmod_factor *,
    cholmod_common *) ;
# 82 "CHOLMOD/Include/cholmod_modify.h"
...
# 107 "CHOLMOD/Include/cholmod_modify.h"
...
# 132 "CHOLMOD/Include/cholmod_modify.h"
...
# 182 "CHOLMOD/Include/cholmod_modify.h"
int cholmod_rowadd
(
...
int cholmod_l_rowadd (size_t, cholmod_sparse *, cholmod_factor *,
    cholmod_common *) ;
# 204 "CHOLMOD/Include/cholmod_modify.h"
...
int cholmod_l_rowadd_solve (size_t, cholmod_sparse *, double *,
    cholmod_factor *, cholmod_dense *, cholmod_dense *, cholmod_common *) ;
# 229 "CHOLMOD/Include/cholmod_modify.h"
...
int cholmod_l_rowadd_mark (size_t, cholmod_sparse *, double *,
    long *, cholmod_factor *, cholmod_dense *, cholmod_dense *,
    cholmod_common *) ;
# 260 "CHOLMOD/Include/cholmod_modify.h"
int cholmod_rowdel
(
...
int cholmod_l_rowdel (size_t, cholmod_sparse *, cholmod_factor *,
    cholmod_common *) ;
# 283 "CHOLMOD/Include/cholmod_modify.h"
...
int cholmod_l_rowdel_solve (size_t, cholmod_sparse *, double *,
    cholmod_factor *, cholmod_dense *, cholmod_dense *, cholmod_common *) ;
# 308 "CHOLMOD/Include/cholmod_modify.h"
...
int cholmod_l_rowdel_mark (size_t, cholmod_sparse *, double *,
    long *, cholmod_factor *, cholmod_dense *, cholmod_dense *,
    cholmod_common *) ;
# 108 "CHOLMOD/Include/cholmod.h" 2



# 1 "CHOLMOD/Include/cholmod_camd.h" 1
# 40 "CHOLMOD/Include/cholmod_camd.h"
int cholmod_ccolamd
(
...
int cholmod_l_camd (cholmod_sparse *, long *, size_t,
    long *, long *, cholmod_common *) ;
# 112 "CHOLMOD/Include/cholmod.h" 2
# 19 "UMFPACK/Source/umf_cholmod.c" 2
# 39 "UMFPACK/Source/umf_cholmod.c"
int umf_l_cholmod
(
...
)
{
    ...
    cholmod_common cm ;
    long *P, *ColCount ;
    long k, ordering_option, print_level, *params ;

    params = (long *) user_params ;
    ordering_option = params [0] ;
    print_level = params [1] - 1 ;
    params [2] = -1 ;

    if (Ap == 
# 69 "UMFPACK/Source/umf_cholmod.c" 3 4
             ((void *)0) 
# 69 "UMFPACK/Source/umf_cholmod.c"
                  || Ai == 
# 69 "UMFPACK/Source/umf_cholmod.c" 3 4
                           ((void *)0) 
# 69 "UMFPACK/Source/umf_cholmod.c"
...
# 69 "UMFPACK/Source/umf_cholmod.c"
    ...
    switch (ordering_option)
    {
        ...
        case 1:
            ...
            cm.nmethods = 1 ;
            cm.method [0].ordering = symmetric ? 2 : 5 ;
            cm.postorder = (1) ;
            break ;
        ...
        case 4:
            ...
            cm.nmethods = 3 ;
            cm.method [0].ordering = symmetric ? 2 : 5 ;
            cm.method [1].ordering = 3 ;
            cm.method [2].ordering = 4 ;
            cm.postorder = (1) ;
            break ;

        case 0:
# 134 "UMFPACK/Source/umf_cholmod.c"
            break ;
    }
    ...
    A->dtype = 0 ;
    A->nz = 
# 154 "UMFPACK/Source/umf_cholmod.c" 3 4
           ((void *)0) 
# 154 "UMFPACK/Source/umf_cholmod.c"
                ;
    A->p = Ap ;
    A->i = Ai ;
    A->x = 
# 157 "UMFPACK/Source/umf_cholmod.c" 3 4
          ((void *)0) 
# 157 "UMFPACK/Source/umf_cholmod.c"
               ;
    A->z = 
# 158 "UMFPACK/Source/umf_cholmod.c" 3 4
          ((void *)0) 
# 158 "UMFPACK/Source/umf_cholmod.c"
               ;
    A->sorted = (0) ;
    ...
    if (symmetric)
    {
        ...
        AT = 
# 164 "UMFPACK/Source/umf_cholmod.c" 3 4
            ((void *)0) 
# 164 "UMFPACK/Source/umf_cholmod.c"
                 ;
        S = A ;
    }
    else
    ...
    if (L == 
# 177 "UMFPACK/Source/umf_cholmod.c" 3 4
            ((void *)0)
# 177 "UMFPACK/Source/umf_cholmod.c"
                )
    {
        return ((0)) ;
    }
    ...
    if (print_level > 0)
    {
        cholmod_l_print_common ("for UMFPACK", &cm) ;
    }
    cholmod_l_finish (&cm) ;
    return ((1)) ;
