# 1 "UMFPACK/Source/umf_transpose.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "UMFPACK/Source/umf_transpose.c"
# 20 "UMFPACK/Source/umf_transpose.c"
...
# 21 "UMFPACK/Source/umf_transpose.c" 2
...
# 22 "UMFPACK/Source/umf_transpose.c" 2
...
# 23 "UMFPACK/Source/umf_transpose.c" 2
...
)
{
    ...
    long i, j, k, p, bp, newj, do_values ;

    long split ;
# 78 "UMFPACK/Source/umf_transpose.c"
    if (check)
    {
 ...
 if (!umf_l_is_permutation (P, W, n_row, n_row) ||
     !umf_l_is_permutation (Q, W, nq, nq))
 {
     return ((-15)) ;
 }
...
# 116 "UMFPACK/Source/umf_transpose.c"
    for (i = 0 ; i < n_row ; i++)
    {
 W [i] = 0 ;
 Rp [i] = 0 ;
    ...
    if (Q != (long *) 
# 122 "UMFPACK/Source/umf_transpose.c" 3 4
                    ((void *)0)
# 122 "UMFPACK/Source/umf_transpose.c"
                        )
    {
 ...
 for (j = 0 ; j < n_col ; j++)
 {
  ...
  W [i]++ ;
    ...
    if (P != (long *) 
# 153 "UMFPACK/Source/umf_transpose.c" 3 4
                    ((void *)0)
# 153 "UMFPACK/Source/umf_transpose.c"
                        )
    {
 Rp [0] = 0 ;
 for (k = 0 ; k < n_row ; k++)
 ...
 for (i = 0 ; i < n_row ; i++)
 {
    ...
    split = ((Az) != (double *) 
# 192 "UMFPACK/Source/umf_transpose.c" 3 4
           ((void *)0)
# 192 "UMFPACK/Source/umf_transpose.c"
           ) && ((Rz) != (double *) 
# 192 "UMFPACK/Source/umf_transpose.c" 3 4
                         ((void *)0)
# 192 "UMFPACK/Source/umf_transpose.c"
    ...
    {
 if (Q != (long *) 
# 196 "UMFPACK/Source/umf_transpose.c" 3 4
                 ((void *)0)
# 196 "UMFPACK/Source/umf_transpose.c"
                     )
 {
     if (split)
     {
 ...
 else
 {
  ...
  for (j = 0 ; j < n_col ; j++)
  {
   ...
   Rx [2*bp+1] = -Ax [2*p+1] ;
    ...
    {
 if (Q != (long *) 
# 266 "UMFPACK/Source/umf_transpose.c" 3 4
                 ((void *)0)
# 266 "UMFPACK/Source/umf_transpose.c"
                     )
 {
     if (do_values)
     {
...
# 399 "UMFPACK/Source/umf_transpose.c"
    return ((0)) ;
}
