# 1 "CHOLMOD/Supernodal/cholmod_super_symbolic.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "CHOLMOD/Supernodal/cholmod_super_symbolic.c"
# 46 "CHOLMOD/Supernodal/cholmod_super_symbolic.c"
...
# 47 "CHOLMOD/Supernodal/cholmod_super_symbolic.c" 2
# 1 "CHOLMOD/Include/cholmod_supernodal.h" 1
# 50 "CHOLMOD/Include/cholmod_supernodal.h"
...
# 51 "CHOLMOD/Include/cholmod_supernodal.h" 2
...
int cholmod_l_super_ltsolve (cholmod_factor *, cholmod_dense *, cholmod_dense *,
    cholmod_common *) ;
# 48 "CHOLMOD/Supernodal/cholmod_super_symbolic.c" 2
# 85 "CHOLMOD/Supernodal/cholmod_super_symbolic.c"
static void subtree
(
...
)
{
    ...
    p = Ap [j] ;
    pend = (Anz == 
# 107 "CHOLMOD/Supernodal/cholmod_super_symbolic.c" 3 4
                  ((void *)0)
# 107 "CHOLMOD/Supernodal/cholmod_super_symbolic.c"
                      ) ? (Ap [j+1]) : (p + Anz [j]) ;
 ...
 if (i < k1)
 {
# 124 "CHOLMOD/Supernodal/cholmod_super_symbolic.c"
...
# 158 "CHOLMOD/Supernodal/cholmod_super_symbolic.c"
int cholmod_l_super_symbolic2
(
...
)
{
    ...
    long *Wi, *Wj, *Super, *Snz, *Ap, *Ai, *Flag, *Head, *Ls, *Lpi, *Lpx, *Fnz,
 *Sparent, *Anz, *SuperMap, *Merged, *Nscol, *Zeros, *Fp, *Fj,
 *ColCount, *Lpi2, *Lsuper, *Iwork ;
    long nsuper, d, n, j, k, s, mark, parent, p, pend, k1, k2, packed, nscol,
 ...
 merge, snext, esize, maxesize, nrelax0, nrelax1, nrelax2, Asorted ;
    ...
    { if (Common == 
# 194 "CHOLMOD/Supernodal/cholmod_super_symbolic.c" 3 4
   ((void *)0)
# 194 "CHOLMOD/Supernodal/cholmod_super_symbolic.c"
   ) { return (0) ; } if (Common->itype != 2 || Common->dtype != 0) { Common->status = (-4) ; return (0) ; } } ;
    { if ((A) == 
# 195 "CHOLMOD/Supernodal/cholmod_super_symbolic.c" 3 4
   ((void *)0)
# 195 "CHOLMOD/Supernodal/cholmod_super_symbolic.c"
   ) { if (Common->status != (-2)) { cholmod_l_error ((-4), "CHOLMOD/Supernodal/cholmod_super_symbolic.c", 195, "argument missing", Common) ; } return (0) ; } } ;
    { if ((L) == 
# 196 "CHOLMOD/Supernodal/cholmod_super_symbolic.c" 3 4
   ((void *)0)
# 196 "CHOLMOD/Supernodal/cholmod_super_symbolic.c"
   ) { if (Common->status != (-2)) { cholmod_l_error ((-4), "CHOLMOD/Supernodal/cholmod_super_symbolic.c", 196, "argument missing", Common) ; } return (0) ; } } ;
    { if ((Parent) == 
# 197 "CHOLMOD/Supernodal/cholmod_super_symbolic.c" 3 4
   ((void *)0)
# 197 "CHOLMOD/Supernodal/cholmod_super_symbolic.c"
   ) { if (Common->status != (-2)) { cholmod_l_error ((-4), "CHOLMOD/Supernodal/cholmod_super_symbolic.c", 197, "argument missing", Common) ; } return (0) ; } } ;
    { if ((A)->xtype < (0) || (A)->xtype > (3) || ((A)->xtype != 0 && ((A)->x) == 
# 198 "CHOLMOD/Supernodal/cholmod_super_symbolic.c" 3 4
   ((void *)0)
# 198 "CHOLMOD/Supernodal/cholmod_super_symbolic.c"
   ) || ((A)->xtype == 3 && ((A)->z) == 
# 198 "CHOLMOD/Supernodal/cholmod_super_symbolic.c" 3 4
   ((void *)0)
# 198 "CHOLMOD/Supernodal/cholmod_super_symbolic.c"
   )) { if (Common->status != (-2)) { cholmod_l_error ((-4), "CHOLMOD/Supernodal/cholmod_super_symbolic.c", 198, "invalid xtype", Common) ; } return (0) ; } } ;
    { if ((L)->xtype < (0) || (L)->xtype > (0) || ((L)->xtype != 0 && ((L)->x) == 
# 199 "CHOLMOD/Supernodal/cholmod_super_symbolic.c" 3 4
   ((void *)0)
# 199 "CHOLMOD/Supernodal/cholmod_super_symbolic.c"
   ) || ((L)->xtype == 3 && ((L)->z) == 
# 199 "CHOLMOD/Supernodal/cholmod_super_symbolic.c" 3 4
   ((void *)0)
# 199 "CHOLMOD/Supernodal/cholmod_super_symbolic.c"
   )) { if (Common->status != (-2)) { cholmod_l_error ((-4), "CHOLMOD/Supernodal/cholmod_super_symbolic.c", 199, "invalid xtype", Common) ; } return (0) ; } } ;
    stype = A->stype ;
    if (stype < 0)
    {

 cholmod_l_error ((-4), "CHOLMOD/Supernodal/cholmod_super_symbolic.c", 204, "symmetric lower not supported", Common) ;
 return (0) ;
    }
    if (stype == 0)
    {
 ...
 { if ((F) == 
# 210 "CHOLMOD/Supernodal/cholmod_super_symbolic.c" 3 4
((void *)0)
# 210 "CHOLMOD/Supernodal/cholmod_super_symbolic.c"
) { if (Common->status != (-2)) { cholmod_l_error ((-4), "CHOLMOD/Supernodal/cholmod_super_symbolic.c", 210, "argument missing", Common) ; } return (0) ; } } ;
    }
    if (L->is_super)
    {

 cholmod_l_error ((-4), "CHOLMOD/Supernodal/cholmod_super_symbolic.c", 215, "L must be symbolic on input", Common) ;
 return (0) ;
    }
    Common->status = 0 ;
    ...
    w = cholmod_l_mult_size_t (n, 5, &ok) ;
    if (!ok)
    {
 cholmod_l_error ((-3), "CHOLMOD/Supernodal/cholmod_super_symbolic.c", 230, "problem too large", Common) ;
 return (0) ;
    }

    cholmod_l_allocate_work (n, w, 0, Common) ;
    if (Common->status < 0)
    {
 ...
 return (0) ;
    ...
    L->useGPU = 0 ;
# 329 "CHOLMOD/Supernodal/cholmod_super_symbolic.c"
    Common->useGPU = 0 ;
# 342 "CHOLMOD/Supernodal/cholmod_super_symbolic.c"
    Ap = A->p ;
    Ai = A->i ;
    Anz = A->nz ;
 ...
 Fp = 
# 349 "CHOLMOD/Supernodal/cholmod_super_symbolic.c" 3 4
     ((void *)0) 
# 349 "CHOLMOD/Supernodal/cholmod_super_symbolic.c"
          ;
 Fj = 
# 350 "CHOLMOD/Supernodal/cholmod_super_symbolic.c" 3 4
     ((void *)0) 
# 350 "CHOLMOD/Supernodal/cholmod_super_symbolic.c"
          ;
 Fnz = 
# 351 "CHOLMOD/Supernodal/cholmod_super_symbolic.c" 3 4
      ((void *)0) 
# 351 "CHOLMOD/Supernodal/cholmod_super_symbolic.c"
           ;
 packed = 1 ;
    }
    else
 ...
 packed = F->packed ;
    ...
    zrelax0 = ((zrelax0) != (zrelax0)) ? 0 : zrelax0 ;
    zrelax1 = ((zrelax1) != (zrelax1)) ? 0 : zrelax1 ;
    zrelax2 = ((zrelax2) != (zrelax2)) ? 0 : zrelax2 ;
    ...
    Wi = Iwork ;
    Wj = Iwork + n ;
    Sparent = Iwork + 2*((size_t) n) ;
    Snz = Iwork + 3*((size_t) n) ;
    Merged = Iwork + 4*((size_t) n) ;
 ...
 if (Parent [j-1] != j
     ...
     || Wi [j] > 1
# 433 "CHOLMOD/Supernodal/cholmod_super_symbolic.c"
     )
 {
 ...
 for (ss = Sparent [s] ; Merged [ss] != (-1) ; ss = Merged [ss]) ;
 sparent = ss ;
 ;


 for (ss = Sparent [s] ; Merged [ss] != (-1) ; ss = snext)
 {
     snext = Merged [ss] ;
     ;
     Merged [ss] = sparent ;
 ...
 else
 {
  ...
  merge = ((ns <= nrelax1 && z < zrelax0) ||
    (ns <= nrelax2 && z < zrelax1) ||
       (z < zrelax2)) &&
   (xtotsize < 0x7fffffffffffffffL / sizeof (double)) ;

     }
 }
# 597 "CHOLMOD/Supernodal/cholmod_super_symbolic.c"
 if (merge)
 {
     ;
     Zeros [s] = totzeros ;
...
# 615 "CHOLMOD/Supernodal/cholmod_super_symbolic.c"
    nsuper = 0 ;
    for (s = 0 ; s < nfsuper ; s++)
    {
 if (Merged [s] == (-1))
 {
    ...
    Super [nsuper] = n ;
    ;
# 638 "CHOLMOD/Supernodal/cholmod_super_symbolic.c"
    for (s = 0 ; s < nsuper ; s++)
    {
 for (k = Super [s] ; k < Super [s+1] ; k++)
 {
 ...
 if (ssize < 0 ||(find_xsize && xxsize > 0x7fffffffffffffffL))
 {
     ...
     cholmod_l_error ((-3), "CHOLMOD/Supernodal/cholmod_super_symbolic.c", 686, "problem too large", Common) ;
     { { Common->mark++ ; if (Common->mark <= 0) { Common->mark = (-1) ; cholmod_l_clear_flag (Common) ; } } ; for (k = 0 ; k <= nfsuper ; k++) { Head [k] = (-1) ; } ; } ;
     return (0) ;
 }
 ;
        ;
    }
    xsize = (((1) > (xsize)) ? (1) : (xsize)) ;
    ssize = (((1) > (ssize)) ? (1) : (ssize)) ;
    ;
    ...
    cholmod_l_change_factor (0, 1, 1, 1, 1, L, Common);
 ...
 for (k = k1 ; k < k2 ; k++)
 {
# 815 "CHOLMOD/Supernodal/cholmod_super_symbolic.c"
     { Common->mark++ ; if (Common->mark <= 0) { Common->mark = (-1) ; cholmod_l_clear_flag (Common) ; } } ;
     mark = Common->mark ;
     Flag [s] = mark ;
     ;
...
# 910 "CHOLMOD/Supernodal/cholmod_super_symbolic.c"
    maxcsize = 1 ;
    maxesize = 1 ;
        ...
        for_whom == 2)
    {
        ...
        for (d = 0 ; d < nsuper ; d++)
        {
            ...
            pend = Lpi [d+1] ;
            esize = pend - p ;
            maxesize = (((maxesize) > (esize)) ? (maxesize) : (esize)) ;
            slast = (p == pend) ? ((-1)) : (SuperMap [Ls [p]]) ;
            for ( ; p <= pend ; p++)
            {
                s = (p == pend) ? ((-1)) : (SuperMap [Ls [p]]) ;
                if (s != slast)
                {
                    ...
                    csize = ndrow2 * ndrow1 ;
                                                                            ...
                                                                            ;
                    maxcsize = (((maxcsize) > (csize)) ? (maxcsize) : (csize)) ;
                    plast = p ;
                    slast = s ;
                }
            }
...
# 978 "CHOLMOD/Supernodal/cholmod_super_symbolic.c"
int cholmod_l_super_symbolic
(
...
{
    return (cholmod_l_super_symbolic2 (1, A, F, Parent, L, Common)) ;
}
