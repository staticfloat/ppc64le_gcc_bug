# 1 "UMFPACK/Source/umf_mem_alloc_tail_block.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "UMFPACK/Source/umf_mem_alloc_tail_block.c"
# 12 "UMFPACK/Source/umf_mem_alloc_tail_block.c"
...
# 13 "UMFPACK/Source/umf_mem_alloc_tail_block.c" 2
...
# 14 "UMFPACK/Source/umf_mem_alloc_tail_block.c" 2
...
)
{
    ...
    ;
    ;
# 43 "UMFPACK/Source/umf_mem_alloc_tail_block.c"
    bigsize = 0 ;
    pbig = (Unit *) 
# 44 "UMFPACK/Source/umf_mem_alloc_tail_block.c" 3 4
                   ((void *)0) 
# 44 "UMFPACK/Source/umf_mem_alloc_tail_block.c"
                        ;
 ...
 pnext->header.prevsize = nunits ;
    ...
    Numeric->max_usage = (((Numeric->max_usage) > (usage)) ? (Numeric->max_usage) : (usage)) ;
# 132 "UMFPACK/Source/umf_mem_alloc_tail_block.c"
