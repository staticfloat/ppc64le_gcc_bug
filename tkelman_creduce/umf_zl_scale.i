# 1 "UMFPACK/Source/umf_scale.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "UMFPACK/Source/umf_scale.c"
# 12 "UMFPACK/Source/umf_scale.c"
...
# 13 "UMFPACK/Source/umf_scale.c" 2
...
# 14 "UMFPACK/Source/umf_scale.c" 2
...
)
{
    ...
    { (s) = (((((pivot).component [0]) < 0.)) ? -((pivot).component [0]) : ((pivot).component [0])) + (((((pivot).component [1]) < 0.)) ? -((pivot).component [1]) : ((pivot).component [1])) ; } ;

    if (s < 1e-12 || ((((pivot).component [0]) != ((pivot).component [0])) || (((pivot).component [1]) != ((pivot).component [1]))))
    {
 ...
 for (i = 0 ; i < n ; i++)
 {
     ...
     if (((((x).component [0]) != 0.) || (((x).component [1]) != 0.)))
     {
  { (void) SuiteSparse_config.divcomplex_func ((x).component [0], (x).component [1], (pivot).component [0], (pivot).component [1], &((X [i]).component [0]), &((X [i]).component [1])) ; } ;
     }
# 59 "UMFPACK/Source/umf_scale.c"
 }

    }
    else
    {
# 74 "UMFPACK/Source/umf_scale.c"
 for (i = 0 ; i < n ; i++)
 {
