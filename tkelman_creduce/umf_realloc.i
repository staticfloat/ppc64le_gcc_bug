# 1 "UMFPACK/Source/umf_realloc.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "UMFPACK/Source/umf_realloc.c"
# 16 "UMFPACK/Source/umf_realloc.c"
...
# 17 "UMFPACK/Source/umf_realloc.c" 2
...
# 18 "UMFPACK/Source/umf_realloc.c" 2
...
)
{
    size_t size ;
    void *p2 ;
# 45 "UMFPACK/Source/umf_realloc.c"
    n_objects = (((1) > (n_objects)) ? (1) : (n_objects)) ;

    size = (size_t) n_objects ;
    ;
    if (size > 0x7fffffffffffffffL / size_of_object)
    {

 return ((void *) 
# 52 "UMFPACK/Source/umf_realloc.c" 3 4
                 ((void *)0)
# 52 "UMFPACK/Source/umf_realloc.c"
                     ) ;
    }
    size *= size_of_object ;
...
# 70 "UMFPACK/Source/umf_realloc.c"
