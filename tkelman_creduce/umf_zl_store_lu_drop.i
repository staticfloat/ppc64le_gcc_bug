...
# 258 "UMFPACK/Source/umf_store_lu.c"
 lnz2x += lnz2i ;
...
# 452 "UMFPACK/Source/umf_store_lu.c"
 }
 else
 {
     ;
...
# 539 "UMFPACK/Source/umf_store_lu.c"
 }
 ;
 ;
 ;
 ;
     ...
     Lnz [kk] = all_lnz ;
# 560 "UMFPACK/Source/umf_store_lu.c"
...
# 690 "UMFPACK/Source/umf_store_lu.c"
 unz2x += unz2i ;
...
# 923 "UMFPACK/Source/umf_store_lu.c"
 }
 else
 {
...
# 1009 "UMFPACK/Source/umf_store_lu.c"
 }
 ...
 ;
  ...
  + 8. * (Lnz [kk] * all_unz) ;
# 1034 "UMFPACK/Source/umf_store_lu.c"
