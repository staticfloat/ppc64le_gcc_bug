# 1 "UMFPACK/Source/umf_colamd.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "UMFPACK/Source/umf_colamd.c"
# 394 "UMFPACK/Source/umf_colamd.c"
...
# 395 "UMFPACK/Source/umf_colamd.c" 2
...
# 396 "UMFPACK/Source/umf_colamd.c" 2
# 1 "UMFPACK/Source/umf_apply_order.h" 1





 void umf_l_apply_order
(
    long Front [ ],
    const long Order [ ],
    long Temp [ ],
...
# 397 "UMFPACK/Source/umf_colamd.c" 2
# 1 "UMFPACK/Source/umf_fsize.h" 1
...
# 398 "UMFPACK/Source/umf_colamd.c" 2
# 435 "UMFPACK/Source/umf_colamd.c"
...
(
    ...
    , long *p_ndense_row
    , long *p_nempty_row
    , long *p_nnewlyempty_row
    , long *p_ndense_col
    , long *p_nempty_col
    , long *p_nnewlyempty_col
) ;
...
# 625 "UMFPACK/Source/umf_colamd.c"
 void umf_l_colamd_set_defaults
(
...
# 673 "UMFPACK/Source/umf_colamd.c"
 long umf_l_colamd
(
...
)
{
    ...
    long max_deg ;
    long aggressive ;
# 727 "UMFPACK/Source/umf_colamd.c"
    long ndense_row, nempty_row, parent, ndense_col,
 nempty_col, k, col, nfr, *Front_child, *Front_sibling, *Front_stack,
 *Front_order, *Front_size ;
    long nnewlyempty_col, nnewlyempty_row ;
# 743 "UMFPACK/Source/umf_colamd.c"
    ;
 ...
 stats [i] = 0 ;
    ...
    stats [4] = -1 ;
    stats [5] = -1 ;
# 789 "UMFPACK/Source/umf_colamd.c"
    ;
    ;
    ;
    ;
    ...
    nnz = p [n_col] ;
# 815 "UMFPACK/Source/umf_colamd.c"
    ;
    ;
# 829 "UMFPACK/Source/umf_colamd.c"
    ;
    ...
    Col_size = ((n_col + 1) * sizeof (Colamd_Col) / sizeof (long)) ;
    Row_size = ((n_row + 1) * sizeof (Colamd_Row) / sizeof (long)) ;
# 856 "UMFPACK/Source/umf_colamd.c"
...
# 877 "UMFPACK/Source/umf_colamd.c"
    ;
 ...
 , &nfr, aggressive, InFront
    ...
    umf_l_fsize (nfr, Front_size, Front_nrows, Front_ncols,
     Front_parent, Front_npivcol) ;

    amd_l_postorder (nfr, Front_parent, Front_npivcol, Front_size,
 Front_order, Front_child, Front_sibling, Front_stack) ;




    umf_l_apply_order (Front_npivcol, Front_order, A, nfr, nfr) ;
    umf_l_apply_order (Front_nrows, Front_order, A, nfr, nfr) ;
    umf_l_apply_order (Front_ncols, Front_order, A, nfr, nfr) ;
    umf_l_apply_order (Front_parent, Front_order, A, nfr, nfr) ;
    umf_l_apply_order (Front_cols, Front_order, A, nfr, nfr) ;
 ...
 A [i] = (-1) ;
    ...
    {
 ;
 for (col = Front_cols [i] ; col != (-1) ; col = Col [col].nextcol)
 {
     ;
     ;
     p [k] = col ;
 ...
 for (col = 0 ; col < n_col ; col++)
 {
  ...
  A [col] = k ;
    ...
    stats [0] = ndense_row ;
    stats [7] = nempty_row ;
    stats [9] = nnewlyempty_row ;
    stats [1] = ndense_col ;
    stats [8] = nempty_col ;
    stats [10] = nnewlyempty_col ;
    ;
...
# 1059 "UMFPACK/Source/umf_colamd.c"
static long init_rows_cols
(
...
# 1101 "UMFPACK/Source/umf_colamd.c"
 ;
...
# 1127 "UMFPACK/Source/umf_colamd.c"
    for (row = 0 ; row < n_row ; row++)
    {
 Row [row].length = 0 ;
 ...
 {
     row = *cp++ ;
# 1170 "UMFPACK/Source/umf_colamd.c"
     ;
# 1189 "UMFPACK/Source/umf_colamd.c"
     ;
...
# 1263 "UMFPACK/Source/umf_colamd.c"
static void init_scoring
(
...
)
{
    ...
    long ndense_row ;
    long nempty_row ;
    long nnewlyempty_row ;
    long ndense_col ;
    long nempty_col ;
    long nnewlyempty_col ;
    long ne ;
# 1330 "UMFPACK/Source/umf_colamd.c"
    dense_row_count =
 ((long) (((16.0) > ((knobs [0]) * 16.0 * sqrt ((double) (n_col)))) ? (16.0) : ((knobs [0]) * 16.0 * sqrt ((double) (n_col))))) ;
    dense_col_count =
 ((long) (((16.0) > ((knobs [1]) * 16.0 * sqrt ((double) (n_row)))) ? (16.0) : ((knobs [1]) * 16.0 * sqrt ((double) (n_row))))) ;

    dense_row_count = (((0) > ((((dense_row_count) < (n_col)) ? (dense_row_count) : (n_col)))) ? (0) : ((((dense_row_count) < (n_col)) ? (dense_row_count) : (n_col)))) ;
    dense_col_count = (((0) > ((((dense_col_count) < (n_row)) ? (dense_col_count) : (n_row)))) ? (0) : ((((dense_col_count) < (n_row)) ? (dense_col_count) : (n_row)))) ;
    ...
    nempty_row = 0 ;
    nnewlyempty_row = 0 ;
# 1412 "UMFPACK/Source/umf_colamd.c"
    for (c = n_col-1 ; c >= 0 ; c--)
    {
# 1424 "UMFPACK/Source/umf_colamd.c"
 ;
 ;
 ...
 else
 {
    ...
    ;
    ;
# 1501 "UMFPACK/Source/umf_colamd.c"
    for (c = n_col-1 ; c >= 0 ; c--)
    {
 ...
 else
 {
     ...
     Col [c].shared2.score = score ;
                ...
                ;
# 1570 "UMFPACK/Source/umf_colamd.c"
    for (c = 0 ; c <= n_col ; c++)
    {
 head [c] = (-1) ;
    }
...
# 1627 "UMFPACK/Source/umf_colamd.c"
    *p_n_col2 = n_col2 ;
    *p_n_row2 = n_row2 ;
    *p_max_deg = max_deg ;
...
# 1653 "UMFPACK/Source/umf_colamd.c"
static long find_ordering
(
...
)
{
    ...
    long next_col ;
    long ngarbage ;
# 1721 "UMFPACK/Source/umf_colamd.c"
    long pivot_row_thickness ;
    long nfr = 0 ;
    long child ;
    ...
    max_mark = 0x7fffffffffffffffL - (2*(n_col)+1) ;
 ...
 InFront [row] = (-1) ;
    ...
    for (k = 0 ; k < n_col2 ; )
    {
# 1762 "UMFPACK/Source/umf_colamd.c"
 ;
 ;
 ;
# 1774 "UMFPACK/Source/umf_colamd.c"
...
# 1889 "UMFPACK/Source/umf_colamd.c"
     }
 }
# 1899 "UMFPACK/Source/umf_colamd.c"
 Col [pivot_col].shared1.thickness = pivot_col_thickness ;
 max_deg = (((max_deg) > (pivot_row_degree)) ? (max_deg) : (pivot_row_degree)) ;
# 1910 "UMFPACK/Source/umf_colamd.c"
 cp = &A [Col [pivot_col].start] ;
 cp_end = cp + Col [pivot_col].length ;
 while (cp < cp_end)
 {
 ...
 ;
# 1986 "UMFPACK/Source/umf_colamd.c"
 ;
...
# 2099 "UMFPACK/Source/umf_colamd.c"
 ;
...
# 2246 "UMFPACK/Source/umf_colamd.c"
...
# 2266 "UMFPACK/Source/umf_colamd.c"
 ;
 ;
...
# 2344 "UMFPACK/Source/umf_colamd.c"
 ...
 pivot_row_thickness -= pivot_col_thickness ;
                                ...
                                ;
 pivot_row_thickness = (((0) > (pivot_row_thickness)) ? (0) : (pivot_row_thickness)) ;
...
# 2405 "UMFPACK/Source/umf_colamd.c"
 nfr++ ;
...
# 2458 "UMFPACK/Source/umf_colamd.c"
static void detect_super_cols
(
# 2468 "UMFPACK/Source/umf_colamd.c"
    Colamd_Col Col [],
    long A [],
    long head [],
    long row_start,
...
# 2630 "UMFPACK/Source/umf_colamd.c"
static long garbage_collection
(
...
)
{
    ...
    long c ;
    long length ;
# 2660 "UMFPACK/Source/umf_colamd.c"
    pdest = &A[0] ;
    for (c = 0 ; c < n_col ; c++)
    {
 if ((Col [c].start >= (0)))
 ...
 if ((Row [r].shared2.mark >= (0)))
 {
     if (Row [r].length == 0)
     {
# 2699 "UMFPACK/Source/umf_colamd.c"
  ;
  { Row [r].shared2.mark = (-1) ; } ;
     }
     else
...
# 2771 "UMFPACK/Source/umf_colamd.c"
static long clear_mark
(
