# 1 "CHOLMOD/Core/cholmod_copy.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "CHOLMOD/Core/cholmod_copy.c"
# 51 "CHOLMOD/Core/cholmod_copy.c"
...
# 52 "CHOLMOD/Core/cholmod_copy.c" 2
...
# 53 "CHOLMOD/Core/cholmod_copy.c" 2
# 64 "CHOLMOD/Core/cholmod_copy.c"
...
)
{
    double aij ;
    double *Ax, *Cx ;
    long *Ap, *Ai, *Anz, *Cp, *Ci, *Wj, *Iwork ;
    cholmod_sparse *C ;
    long nrow, ncol, nz, packed, j, p, pend, i, pc, up, lo, values, diag,
 astype, extra ;
    ...
    Ax = A->x ;
    packed = A->packed ;
    values = (mode > 0) && (A->xtype != 0) ;
    diag = (mode >= 0) ;

    astype = (((A->stype) < 0) ? (-1) : (((A->stype) > 0) ? 1 : 0)) ;
    up = (astype > 0) ;
    lo = (astype < 0) ;
    ;
    ...
    Iwork = Common->Iwork ;
    Wj = Iwork ;
# 118 "CHOLMOD/Core/cholmod_copy.c"
    ;
    ;
 ...
 nz += Wj [j] ;
    ...
    C = cholmod_l_allocate_sparse (nrow, ncol, nz + extra, A->sorted, 1, 0,
     values ? A->xtype : 0, Common) ;
    if (Common->status < 0)
    {
 return (
# 165 "CHOLMOD/Core/cholmod_copy.c" 3 4
        ((void *)0)
# 165 "CHOLMOD/Core/cholmod_copy.c"
            ) ;
    }
...
{
    cholmod_sparse *C ;
    long nrow, ncol, up, lo, values, diag, astype ;
    ...
    { if (Common == 
# 284 "CHOLMOD/Core/cholmod_copy.c" 3 4
   ((void *)0)
# 284 "CHOLMOD/Core/cholmod_copy.c"
   ) { return (
# 284 "CHOLMOD/Core/cholmod_copy.c" 3 4
   ((void *)0)
# 284 "CHOLMOD/Core/cholmod_copy.c"
...
# 284 "CHOLMOD/Core/cholmod_copy.c"
    ...
    { if ((A) == 
# 285 "CHOLMOD/Core/cholmod_copy.c" 3 4
   ((void *)0)
# 285 "CHOLMOD/Core/cholmod_copy.c"
   ) { if (Common->status != (-2)) { cholmod_l_error ((-4), "CHOLMOD/Core/cholmod_copy.c", 285, "argument missing", Common) ; } return (
# 285 "CHOLMOD/Core/cholmod_copy.c" 3 4
   ((void *)0)
# 285 "CHOLMOD/Core/cholmod_copy.c"
   ) ; } } ;
    values = (mode > 0) && (A->xtype != 0) ;
    { if ((A)->xtype < (0) || (A)->xtype > (values ? 1 : 3) || ((A)->xtype != 0 && ((A)->x) == 
# 287 "CHOLMOD/Core/cholmod_copy.c" 3 4
   ((void *)0)
# 287 "CHOLMOD/Core/cholmod_copy.c"
   ) || ((A)->xtype == 3 && ((A)->z) == 
# 287 "CHOLMOD/Core/cholmod_copy.c" 3 4
   ((void *)0)
# 287 "CHOLMOD/Core/cholmod_copy.c"
   )) { if (Common->status != (-2)) { cholmod_l_error ((-4),
 "CHOLMOD/Core/cholmod_copy.c"
# 287 "CHOLMOD/Core/cholmod_copy.c"
    ,
 288
# 287 "CHOLMOD/Core/cholmod_copy.c"
    , "invalid xtype", Common) ; } return (
# 287 "CHOLMOD/Core/cholmod_copy.c" 3 4
   ((void *)0)
# 287 "CHOLMOD/Core/cholmod_copy.c"
   ) ; } }
 ...
 cholmod_l_error ((-4), "CHOLMOD/Core/cholmod_copy.c", 294, "matrix invalid", Common) ;
 return (
# 295 "CHOLMOD/Core/cholmod_copy.c" 3 4
        ((void *)0)
# 295 "CHOLMOD/Core/cholmod_copy.c"
            ) ;
    }
    Common->status = 0 ;
 ...
 return (
# 307 "CHOLMOD/Core/cholmod_copy.c" 3 4
        ((void *)0)
# 307 "CHOLMOD/Core/cholmod_copy.c"
            ) ;
    }
 ...
 C = cholmod_l_band (A, -nrow, ncol, mode, Common) ;
 ...
 if (stype > 0)
 {
     ...
     C = cholmod_l_band (A, 0, ncol, mode, Common) ;
 }
 else
 {

     C = cholmod_l_band (A, -nrow, 0, mode, Common) ;
 }
 if (Common->status < 0)
 {

     return (
# 356 "CHOLMOD/Core/cholmod_copy.c" 3 4
            ((void *)0)
# 356 "CHOLMOD/Core/cholmod_copy.c"
                ) ;
 }
 C->stype = stype ;
 ...
 C = cholmod_l_transpose (A, values, Common) ;
 if (!diag)
 {

     cholmod_l_band_inplace (-nrow, ncol, -1, C, Common) ;
 }
 ...
 return (
# 395 "CHOLMOD/Core/cholmod_copy.c" 3 4
        ((void *)0)
# 395 "CHOLMOD/Core/cholmod_copy.c"
            ) ;
    }
