# 1 "UMFPACK/Source/umf_grow_front.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "UMFPACK/Source/umf_grow_front.c"
# 12 "UMFPACK/Source/umf_grow_front.c"
...
# 13 "UMFPACK/Source/umf_grow_front.c" 2
# 1 "UMFPACK/Source/umf_grow_front.h" 1





 long umfzl_grow_front
(
    NumericType *Numeric,
    long fnr2,
    long fnc2,
...
# 14 "UMFPACK/Source/umf_grow_front.c" 2
...
# 15 "UMFPACK/Source/umf_grow_front.c" 2
# 1 "UMFPACK/Source/umf_mem_alloc_tail_block.h" 1
...
# 16 "UMFPACK/Source/umf_grow_front.c" 2
# 1 "UMFPACK/Source/umf_get_memory.h" 1
...
# 17 "UMFPACK/Source/umf_grow_front.c" 2
...
)
{
    ...
    double s ;
    DoubleComplex *Fcold, *Fcnew ;
    long j, i, col, *Fcpos, *Fcols, fnrows_max, fncols_max, fnr_curr, nb,
 fnrows_new, fncols_new, fnr_min, fnc_min, minsize,
 newsize, fnrows, fncols, *E, eloc ;
# 52 "UMFPACK/Source/umf_grow_front.c"
    Fcols = Work->Fcols ;
    Fcpos = Work->Fcpos ;
    E = Work->E ;
    ...
    fnrows_new += nb ;
    fncols_new += nb ;
    fnr_min = (((fnrows_new) < (fnrows_max)) ? (fnrows_new) : (fnrows_max)) ;
    fnc_min = (((fncols_new) < (fncols_max)) ? (fncols_new) : (fncols_max)) ;
    minsize = fnr_min * fnc_min ;
    if (((!(((double) fnr_min * (double) fnc_min * sizeof (DoubleComplex)) * (1.0+1e-8) <= (double) 0x7fffffffffffffffL)) || (((double) fnr_min * (double) fnc_min * sizeof (DoubleComplex)) != ((double) fnr_min * (double) fnc_min * sizeof (DoubleComplex)))))
    {
 ...
 return ((0)) ;
    ...
    ;
    if (fnr2 % 2 == 0) fnr2++ ;
    fnr2 = (((fnr2) > (fnr_min)) ? (fnr2) : (fnr_min)) ;
    fnc2 = (((fnc2) > (fnc_min)) ? (fnc2) : (fnc_min)) ;
    fnr2 = (((fnr2) < (fnrows_max)) ? (fnr2) : (fnrows_max)) ;
    fnc2 = (((fnc2) < (fncols_max)) ? (fnc2) : (fncols_max)) ;
    ;
    ;
    ;

    s = ((double) fnr2) * ((double) fnc2) ;
    if (((!((s * sizeof (DoubleComplex)) * (1.0+1e-8) <= (double) 0x7fffffffffffffffL)) || ((s * sizeof (DoubleComplex)) != (s * sizeof (DoubleComplex)))))
    {



 double a = 0.9 * sqrt ((0x7fffffffffffffffL / sizeof (DoubleComplex)) / s) ;
 fnr2 = (((fnr_min) > (a * fnr2)) ? (fnr_min) : (a * fnr2)) ;
 fnc2 = (((fnc_min) > (a * fnc2)) ? (fnc_min) : (a * fnc2)) ;
 ...
 ;
 umfzl_mem_free_tail_block (Numeric, E [0]) ;
 E [0] = 0 ;
 Work->Flublock = (DoubleComplex *) 
# 145 "UMFPACK/Source/umf_grow_front.c" 3 4
                           ((void *)0) 
# 145 "UMFPACK/Source/umf_grow_front.c"
                                ;
 Work->Flblock = (DoubleComplex *) 
# 146 "UMFPACK/Source/umf_grow_front.c" 3 4
                           ((void *)0) 
# 146 "UMFPACK/Source/umf_grow_front.c"
                                ;
 Work->Fublock = (DoubleComplex *) 
# 147 "UMFPACK/Source/umf_grow_front.c" 3 4
                           ((void *)0) 
# 147 "UMFPACK/Source/umf_grow_front.c"
                                ;
 Work->Fcblock = (DoubleComplex *) 
# 148 "UMFPACK/Source/umf_grow_front.c" 3 4
                           ((void *)0) 
# 148 "UMFPACK/Source/umf_grow_front.c"
                                ;
    }
# 166 "UMFPACK/Source/umf_grow_front.c"
    ;
    eloc = umfzl_mem_alloc_tail_block (Numeric, (((((sizeof (DoubleComplex) * (newsize))) + (sizeof (Unit)) - 1) / (sizeof (Unit))))) ;
 ...
 ;
 if (!umfzl_get_memory (Numeric, Work, 1 + (((((sizeof (DoubleComplex) * (newsize))) + (sizeof (Unit)) - 1) / (sizeof (Unit)))),
     Work->fnrows, Work->fncols, (0)))
 {
 ...
 eloc = umfzl_mem_alloc_tail_block (Numeric, (((((sizeof (DoubleComplex) * (newsize))) + (sizeof (Unit)) - 1) / (sizeof (Unit))))) ;
    ...
    {
 fnr2 = (((fnr2 - 2) < (fnr2 * (0.95))) ? (fnr2 - 2) : (fnr2 * (0.95))) ;
 fnc2 = (((fnc2 - 2) < (fnc2 * (0.95))) ? (fnc2 - 2) : (fnc2 * (0.95))) ;
 ;
 ;
 fnr2 = (((fnr_min) > (fnr2)) ? (fnr_min) : (fnr2)) ;
 fnc2 = (((fnc_min) > (fnc2)) ? (fnc_min) : (fnc2)) ;
 ;
 if (fnr2 % 2 == 0) fnr2++ ;
 newsize = fnr2 * fnc2 ;
 ...
 return ((0)) ;
    ...
    Work->Flublock = (DoubleComplex *) (Numeric->Memory + eloc) ;
