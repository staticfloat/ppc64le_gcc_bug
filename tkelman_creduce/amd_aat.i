# 1 "AMD/Source/amd_aat.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "AMD/Source/amd_aat.c"
# 18 "AMD/Source/amd_aat.c"
...
{
    long p1, p2, p, i, j, pj, pj2, k, nzdiag, nzboth, nz ;
    double sym ;
    size_t nzaat ;
    ...
    if (Info != (double *) 
# 40 "AMD/Source/amd_aat.c" 3 4
                          ((void *)0)
# 40 "AMD/Source/amd_aat.c"
                              )
    {
...
# 153 "AMD/Source/amd_aat.c"
 ...
 nzaat += Len [k] ;
    ...
    if (Info != (double *) 
# 173 "AMD/Source/amd_aat.c" 3 4
                          ((void *)0)
# 173 "AMD/Source/amd_aat.c"
                              )
    {
 Info [0] = 0 ;
 Info [1] = n ;
