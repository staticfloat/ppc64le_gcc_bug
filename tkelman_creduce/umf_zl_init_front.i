# 1 "UMFPACK/Source/umf_init_front.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "UMFPACK/Source/umf_init_front.c"
# 10 "UMFPACK/Source/umf_init_front.c"
...
# 11 "UMFPACK/Source/umf_init_front.c" 2
...
# 12 "UMFPACK/Source/umf_init_front.c" 2
...
# 13 "UMFPACK/Source/umf_init_front.c" 2
...
static void zero_init_front (long m, long n, DoubleComplex *Fcblock, long d)
{
    long i, j ;
    DoubleComplex *F, *Fj = Fcblock ;
    for (j = 0 ; j < m ; j++)
    {
 F = Fj ;
 Fj += d ;
 for (i = 0 ; i < n ; i++)
 {
     ...
     { (*F).component [0] = 0. ; (*F).component [1] = 0. ; } ;
     F++ ;
 }
    }
}
...
)
{
    ...
    long i, j, fnr_curr, row, col, *Frows, *Fcols,
 *Fcpos, *Frpos, fncols, fnrows, *Wrow, fnr2, fnc2, rrdeg, ccdeg, *Wm,
 fnrows_extended ;
    DoubleComplex *Fcblock, *Fl, *Wy, *Wx ;
# 65 "UMFPACK/Source/umf_init_front.c"
    if (Work->do_grow)
    {
 fnr2 = (1.2) * Work->fnrows_new + 2 ;
 fnc2 = (1.2) * Work->fncols_new + 2 ;
 if (!umfzl_grow_front (Numeric, fnr2, fnc2, Work,
 ...
 fnrows = ccdeg ;
    ...
    Work->fnrows = fnrows ;
# 178 "UMFPACK/Source/umf_init_front.c"
    Wrow = Work->Wrow ;
...
# 195 "UMFPACK/Source/umf_init_front.c"
 ;
 if (Wrow == Fcols)
 {
...
# 265 "UMFPACK/Source/umf_init_front.c"
    return ((1)) ;
