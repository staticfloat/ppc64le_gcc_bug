# 1 "UMFPACK/Source/umf_singletons.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "UMFPACK/Source/umf_singletons.c"
# 39 "UMFPACK/Source/umf_singletons.c"
...
# 40 "UMFPACK/Source/umf_singletons.c" 2
...
# 41 "UMFPACK/Source/umf_singletons.c" 2
# 125 "UMFPACK/Source/umf_singletons.c"
static void create_row_form
(
...
static int order_singletons
(
    long k,
    long head,
    long tail,
    long Next [ ],
    long Xdeg [ ], long Xperm [ ], const long Xp [ ], const long Xi [ ],
    long Ydeg [ ], long Yperm [ ], const long Yp [ ], const long Yi [ ]



)
{
    long xpivot, x, y, ypivot, p, p2, deg ;
# 190 "UMFPACK/Source/umf_singletons.c"
    while (head != (-1))
    {
...
# 229 "UMFPACK/Source/umf_singletons.c"
 ypivot = (-1) ;
 p2 = Xp [xpivot+1] ;
 ...
 Xdeg [xpivot] = (-(1)-2) ;
 Ydeg [ypivot] = (-(Ydeg [ypivot])-2) ;


 Xperm [k] = xpivot ;
 Yperm [k] = ypivot ;
 k++ ;
# 301 "UMFPACK/Source/umf_singletons.c"
    }
# 312 "UMFPACK/Source/umf_singletons.c"
    return (k) ;
}
...
static long find_any_singletons
(
...
{
    long n1, col, row, row_form, head, tail, n1r, n1c ;
...
static long find_user_singletons
(
...
{
    long n1, col, row, p, p2, pivcol, pivrow, found, k, n1r, n1c ;
 ...
 if (found)
 {
     ...
     ;
# 551 "UMFPACK/Source/umf_singletons.c"
     p2 = Ap [pivcol+1] ;
...
# 635 "UMFPACK/Source/umf_singletons.c"
     ;
     ;
     ;
...
# 689 "UMFPACK/Source/umf_singletons.c"
static long finish_permutation
(
    long n1,
    long nx,
    long Xdeg [ ],
...
)
{
    ...
    {
 x = (Xuser != (long *) 
# 706 "UMFPACK/Source/umf_singletons.c" 3 4
                      ((void *)0)
# 706 "UMFPACK/Source/umf_singletons.c"
                          ) ? Xuser [k] : k ;
 ;
 deg = Xdeg [x] ;
 if (deg == 0)
...
{
    long n1, s, col, row, p, p1, p2, cdeg, last_row, is_sym, k,
 nempty_row, nempty_col, max_cdeg, max_rdeg, n1c, n1r ;
# 790 "UMFPACK/Source/umf_singletons.c"
...
# 832 "UMFPACK/Source/umf_singletons.c" 3 4
                             ((void *)0)
# 832 "UMFPACK/Source/umf_singletons.c"
                                 )
    {
 ...
 n1 = find_any_singletons (n_row, n_col, Ap, Ai,
  Cdeg, Rdeg, Cperm, Rperm, &n1r, &n1c, Rp, Ri, W, Next) ;
    ...
    if (Quser != (long *) 
# 867 "UMFPACK/Source/umf_singletons.c" 3 4
                        ((void *)0) 
# 867 "UMFPACK/Source/umf_singletons.c"
                             && strategy == 3)
    {
 ...
 nempty_row = finish_permutation (n1, n_row, Rdeg, (long *) 
# 877 "UMFPACK/Source/umf_singletons.c" 3 4
                                                          ((void *)0)
# 877 "UMFPACK/Source/umf_singletons.c"
                                                              , Rperm,
     &max_rdeg) ;
    }
...
# 901 "UMFPACK/Source/umf_singletons.c"
