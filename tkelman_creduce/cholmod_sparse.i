# 1 "CHOLMOD/Core/cholmod_sparse.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "CHOLMOD/Core/cholmod_sparse.c"
# 38 "CHOLMOD/Core/cholmod_sparse.c"
...
# 39 "CHOLMOD/Core/cholmod_sparse.c" 2
...
# 40 "CHOLMOD/Core/cholmod_sparse.c" 2
# 53 "CHOLMOD/Core/cholmod_sparse.c"
...
)
{
    ...
    { if (Common == 
# 77 "CHOLMOD/Core/cholmod_sparse.c" 3 4
   ((void *)0)
# 77 "CHOLMOD/Core/cholmod_sparse.c"
   ) { return (
# 77 "CHOLMOD/Core/cholmod_sparse.c" 3 4
   ((void *)0)
# 77 "CHOLMOD/Core/cholmod_sparse.c"
...
# 77 "CHOLMOD/Core/cholmod_sparse.c"
    ...
    {
 cholmod_l_error ((-4), "CHOLMOD/Core/cholmod_sparse.c", 80, "rectangular matrix with stype != 0 invalid", Common) ;
 return (
# 81 "CHOLMOD/Core/cholmod_sparse.c" 3 4
        ((void *)0)
# 81 "CHOLMOD/Core/cholmod_sparse.c"
            ) ;
    }
    if (xtype < 0 || xtype > 3)
    {
 cholmod_l_error ((-4), "CHOLMOD/Core/cholmod_sparse.c", 85, "xtype invalid", Common) ;
 return (
# 86 "CHOLMOD/Core/cholmod_sparse.c" 3 4
        ((void *)0)
# 86 "CHOLMOD/Core/cholmod_sparse.c"
            ) ;
    }

    (void) cholmod_l_add_size_t (ncol, 2, &ok) ;
    if (!ok || nrow > 0x7fffffffffffffffL || ncol > 0x7fffffffffffffffL || nzmax > 0x7fffffffffffffffL)
    {
 cholmod_l_error ((-3), "CHOLMOD/Core/cholmod_sparse.c", 92, "problem too large", Common) ;
 return (
# 93 "CHOLMOD/Core/cholmod_sparse.c" 3 4
        ((void *)0)
# 93 "CHOLMOD/Core/cholmod_sparse.c"
            ) ;
    }
    Common->status = 0 ;
    ...
    A = cholmod_l_malloc (sizeof (cholmod_sparse), 1, Common) ;
    if (Common->status < 0)
    {
 return (
# 104 "CHOLMOD/Core/cholmod_sparse.c" 3 4
        ((void *)0)
# 104 "CHOLMOD/Core/cholmod_sparse.c"
            ) ;
    }
   
                                                            ;

    nzmax = (((1) > (nzmax)) ? (1) : (nzmax)) ;
    ...
    A->nz = 
# 120 "CHOLMOD/Core/cholmod_sparse.c" 3 4
           ((void *)0) 
# 120 "CHOLMOD/Core/cholmod_sparse.c"
                ;
    A->p = 
# 121 "CHOLMOD/Core/cholmod_sparse.c" 3 4
          ((void *)0) 
# 121 "CHOLMOD/Core/cholmod_sparse.c"
               ;
    A->i = 
# 122 "CHOLMOD/Core/cholmod_sparse.c" 3 4
          ((void *)0) 
# 122 "CHOLMOD/Core/cholmod_sparse.c"
               ;
    A->x = 
# 123 "CHOLMOD/Core/cholmod_sparse.c" 3 4
          ((void *)0) 
# 123 "CHOLMOD/Core/cholmod_sparse.c"
               ;
    A->z = 
# 124 "CHOLMOD/Core/cholmod_sparse.c" 3 4
          ((void *)0) 
# 124 "CHOLMOD/Core/cholmod_sparse.c"
               ;


    A->sorted = (nrow <= 1) ? 1 : sorted ;
    ...
    A->p = cholmod_l_malloc (((size_t) ncol)+1, sizeof (long), Common) ;
    if (!packed)
    {
 A->nz = cholmod_l_malloc (ncol, sizeof (long), Common) ;
    }


    nzmax0 = 0 ;
    cholmod_l_realloc_multiple (nzmax, 1, xtype, &(A->i), 
# 142 "CHOLMOD/Core/cholmod_sparse.c" 3 4
                                                        ((void *)0)
# 142 "CHOLMOD/Core/cholmod_sparse.c"
                                                            , &(A->x), &(A->z),
     &nzmax0, Common) ;
 ...
 return (
# 148 "CHOLMOD/Core/cholmod_sparse.c" 3 4
        ((void *)0)
# 148 "CHOLMOD/Core/cholmod_sparse.c"
            ) ;
    }
...
# 181 "CHOLMOD/Core/cholmod_sparse.c"
...
)
{
    ...
    { if (Common == 
# 192 "CHOLMOD/Core/cholmod_sparse.c" 3 4
   ((void *)0)
# 192 "CHOLMOD/Core/cholmod_sparse.c"
   ) { return (0) ; } if (Common->itype != 2 || Common->dtype != 0) { Common->status = (-4) ; return (0) ; } } ;

    if (AHandle == 
# 194 "CHOLMOD/Core/cholmod_sparse.c" 3 4
                  ((void *)0)
# 194 "CHOLMOD/Core/cholmod_sparse.c"
                      )
    {
 ...
 return (1) ;
    ...
    A = *AHandle ;
    if (A == 
# 200 "CHOLMOD/Core/cholmod_sparse.c" 3 4
            ((void *)0)
# 200 "CHOLMOD/Core/cholmod_sparse.c"
                )
    {
 ...
 return (1) ;
    ...
    n = A->ncol ;
    nz = A->nzmax ;
    A->p = cholmod_l_free (n+1, sizeof (long), A->p, Common) ;
    A->i = cholmod_l_free (nz, sizeof (long), A->i, Common) ;
    A->nz = cholmod_l_free (n, sizeof (long), A->nz, Common) ;

    switch (A->xtype)
    {
 case 1:
     A->x = cholmod_l_free (nz, sizeof (double), A->x, Common) ;
     break ;

 case 2:
     A->x = cholmod_l_free (nz, 2*sizeof (double), A->x, Common) ;
     break ;

 case 3:
     A->x = cholmod_l_free (nz, sizeof (double), A->x, Common) ;
     A->z = cholmod_l_free (nz, sizeof (double), A->z, Common) ;
     break ;
    }

    *AHandle = cholmod_l_free (1, sizeof (cholmod_sparse), (*AHandle), Common) ;
    return (1) ;
}
# 243 "CHOLMOD/Core/cholmod_sparse.c"
int cholmod_l_reallocate_sparse
(
...
)
{
    ...
    { if (Common == 
# 258 "CHOLMOD/Core/cholmod_sparse.c" 3 4
   ((void *)0)
# 258 "CHOLMOD/Core/cholmod_sparse.c"
   ) { return (0) ; } if (Common->itype != 2 || Common->dtype != 0) { Common->status = (-4) ; return (0) ; } } ;
    { if ((A) == 
# 259 "CHOLMOD/Core/cholmod_sparse.c" 3 4
   ((void *)0)
# 259 "CHOLMOD/Core/cholmod_sparse.c"
   ) { if (Common->status != (-2)) { cholmod_l_error ((-4), "CHOLMOD/Core/cholmod_sparse.c", 259, "argument missing", Common) ; } return (0) ; } } ;
    { if ((A)->xtype < (0) || (A)->xtype > (3) || ((A)->xtype != 0 && ((A)->x) == 
# 260 "CHOLMOD/Core/cholmod_sparse.c" 3 4
   ((void *)0)
# 260 "CHOLMOD/Core/cholmod_sparse.c"
   ) || ((A)->xtype == 3 && ((A)->z) == 
# 260 "CHOLMOD/Core/cholmod_sparse.c" 3 4
   ((void *)0)
# 260 "CHOLMOD/Core/cholmod_sparse.c"
   )) { if (Common->status != (-2)) { cholmod_l_error ((-4), "CHOLMOD/Core/cholmod_sparse.c", 260, "invalid xtype", Common) ; } return (0) ; } } ;
    Common->status = 0 ;
    ...
    cholmod_l_realloc_multiple ((((1) > (nznew)) ? (1) : (nznew)), 1, A->xtype, &(A->i), 
# 269 "CHOLMOD/Core/cholmod_sparse.c" 3 4
                                                                   ((void *)0)
# 269 "CHOLMOD/Core/cholmod_sparse.c"
                                                                       ,
     &(A->x), &(A->z), &(A->nzmax), Common) ;

    return (Common->status == 0) ;
}
# 282 "CHOLMOD/Core/cholmod_sparse.c"
cholmod_sparse *cholmod_l_speye
(
...
)
{
    ...
    { if (Common == 
# 301 "CHOLMOD/Core/cholmod_sparse.c" 3 4
   ((void *)0)
# 301 "CHOLMOD/Core/cholmod_sparse.c"
   ) { return (
# 301 "CHOLMOD/Core/cholmod_sparse.c" 3 4
   ((void *)0)
# 301 "CHOLMOD/Core/cholmod_sparse.c"
...
# 301 "CHOLMOD/Core/cholmod_sparse.c"
    ...
    A = cholmod_l_allocate_sparse (nrow, ncol, n, 1, 1, 0, xtype,
     Common) ;

    if (Common->status < 0)
    {
 return (
# 314 "CHOLMOD/Core/cholmod_sparse.c" 3 4
        ((void *)0)
# 314 "CHOLMOD/Core/cholmod_sparse.c"
            ) ;
    }
...
# 378 "CHOLMOD/Core/cholmod_sparse.c"
cholmod_sparse *cholmod_l_spzeros
(
...
)
{
    ...
    { if (Common == 
# 394 "CHOLMOD/Core/cholmod_sparse.c" 3 4
   ((void *)0)
# 394 "CHOLMOD/Core/cholmod_sparse.c"
   ) { return (
# 394 "CHOLMOD/Core/cholmod_sparse.c" 3 4
   ((void *)0)
# 394 "CHOLMOD/Core/cholmod_sparse.c"
...
# 394 "CHOLMOD/Core/cholmod_sparse.c"
    ...
    return (cholmod_l_allocate_sparse (nrow, ncol, nzmax, 1, 1, 0, xtype,
     Common)) ;
}
# 416 "CHOLMOD/Core/cholmod_sparse.c"
long cholmod_l_nnz
(
...
)
{
    ...
    { if (Common == 
# 432 "CHOLMOD/Core/cholmod_sparse.c" 3 4
   ((void *)0)
# 432 "CHOLMOD/Core/cholmod_sparse.c"
   ) { return ((-1)) ; } if (Common->itype != 2 || Common->dtype != 0) { Common->status = (-4) ; return ((-1)) ; } } ;
    { if ((A) == 
# 433 "CHOLMOD/Core/cholmod_sparse.c" 3 4
   ((void *)0)
# 433 "CHOLMOD/Core/cholmod_sparse.c"
   ) { if (Common->status != (-2)) { cholmod_l_error ((-4), "CHOLMOD/Core/cholmod_sparse.c", 433, "argument missing", Common) ; } return ((-1)) ; } } ;
    { if ((A)->xtype < (0) || (A)->xtype > (3) || ((A)->xtype != 0 && ((A)->x) == 
# 434 "CHOLMOD/Core/cholmod_sparse.c" 3 4
   ((void *)0)
# 434 "CHOLMOD/Core/cholmod_sparse.c"
   ) || ((A)->xtype == 3 && ((A)->z) == 
# 434 "CHOLMOD/Core/cholmod_sparse.c" 3 4
   ((void *)0)
# 434 "CHOLMOD/Core/cholmod_sparse.c"
   )) { if (Common->status != (-2)) { cholmod_l_error ((-4), "CHOLMOD/Core/cholmod_sparse.c", 434, "invalid xtype", Common) ; } return ((-1)) ; } } ;
    Common->status = 0 ;
 ...
 Ap = A->p ;
 { if ((Ap) == 
# 445 "CHOLMOD/Core/cholmod_sparse.c" 3 4
((void *)0)
# 445 "CHOLMOD/Core/cholmod_sparse.c"
) { if (Common->status != (-2)) { cholmod_l_error ((-4), "CHOLMOD/Core/cholmod_sparse.c", 445, "argument missing", Common) ; } return ((-1)) ; } } ;
 nz = Ap [ncol] ;
    }
    else
    {
 Anz = A->nz ;
 { if ((Anz) == 
# 451 "CHOLMOD/Core/cholmod_sparse.c" 3 4
((void *)0)
# 451 "CHOLMOD/Core/cholmod_sparse.c"
) { if (Common->status != (-2)) { cholmod_l_error ((-4), "CHOLMOD/Core/cholmod_sparse.c", 451, "argument missing", Common) ; } return ((-1)) ; } } ;
 nz = 0 ;
 for (j = 0 ; j < ncol ; j++)
 {
     nz += (((0) > (Anz [j])) ? (0) : (Anz [j])) ;
...
# 477 "CHOLMOD/Core/cholmod_sparse.c"
cholmod_sparse *cholmod_l_copy_sparse
(
...
)
{
    ...
    cholmod_sparse *C ;
    long p, pend, j, ncol, packed, nzmax, nz, xtype ;
    ...
    { if (Common == 
# 494 "CHOLMOD/Core/cholmod_sparse.c" 3 4
   ((void *)0)
# 494 "CHOLMOD/Core/cholmod_sparse.c"
   ) { return (
# 494 "CHOLMOD/Core/cholmod_sparse.c" 3 4
   ((void *)0)
# 494 "CHOLMOD/Core/cholmod_sparse.c"
...
# 494 "CHOLMOD/Core/cholmod_sparse.c"
    ...
    { if ((A) == 
# 495 "CHOLMOD/Core/cholmod_sparse.c" 3 4
   ((void *)0)
# 495 "CHOLMOD/Core/cholmod_sparse.c"
   ) { if (Common->status != (-2)) { cholmod_l_error ((-4), "CHOLMOD/Core/cholmod_sparse.c", 495, "argument missing", Common) ; } return (
# 495 "CHOLMOD/Core/cholmod_sparse.c" 3 4
   ((void *)0)
# 495 "CHOLMOD/Core/cholmod_sparse.c"
   ) ; } } ;
    { if ((A)->xtype < (0) || (A)->xtype > (3) || ((A)->xtype != 0 && ((A)->x) == 
# 496 "CHOLMOD/Core/cholmod_sparse.c" 3 4
   ((void *)0)
# 496 "CHOLMOD/Core/cholmod_sparse.c"
   ) || ((A)->xtype == 3 && ((A)->z) == 
# 496 "CHOLMOD/Core/cholmod_sparse.c" 3 4
   ((void *)0)
# 496 "CHOLMOD/Core/cholmod_sparse.c"
   )) { if (Common->status != (-2)) { cholmod_l_error ((-4), "CHOLMOD/Core/cholmod_sparse.c", 496, "invalid xtype", Common) ; } return (
# 496 "CHOLMOD/Core/cholmod_sparse.c" 3 4
   ((void *)0)
# 496 "CHOLMOD/Core/cholmod_sparse.c"
   ) ; } } ;
    ...
    {
 cholmod_l_error ((-4), "CHOLMOD/Core/cholmod_sparse.c", 499, "rectangular matrix with stype != 0 invalid", Common) ;
 return (
# 500 "CHOLMOD/Core/cholmod_sparse.c" 3 4
        ((void *)0)
# 500 "CHOLMOD/Core/cholmod_sparse.c"
            ) ;
    }
    Common->status = 0 ;
    ;
    ...
    C = cholmod_l_allocate_sparse (A->nrow, A->ncol, A->nzmax, A->sorted,
     A->packed, A->stype, A->xtype, Common) ;

    if (Common->status < 0)
    {
 return (
# 528 "CHOLMOD/Core/cholmod_sparse.c" 3 4
        ((void *)0)
# 528 "CHOLMOD/Core/cholmod_sparse.c"
            ) ;
    }
