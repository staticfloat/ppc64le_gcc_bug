# 1 "CHOLMOD/Core/cholmod_band.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "CHOLMOD/Core/cholmod_band.c"
# 46 "CHOLMOD/Core/cholmod_band.c"
...
# 47 "CHOLMOD/Core/cholmod_band.c" 2
...
# 48 "CHOLMOD/Core/cholmod_band.c" 2

static cholmod_sparse *band
(
...
{
    double *Ax, *Cx ;
    long packed, nz, j, p, pend, i, ncol, nrow, jlo, jhi, ilo, ihi, sorted,
 values, diag ;
    long *Ap, *Anz, *Ai, *Cp, *Ci ;
    cholmod_sparse *C ;
    ...
    { if (Common == 
# 72 "CHOLMOD/Core/cholmod_band.c" 3 4
   ((void *)0)
# 72 "CHOLMOD/Core/cholmod_band.c"
   ) { return (
# 72 "CHOLMOD/Core/cholmod_band.c" 3 4
   ((void *)0)
# 72 "CHOLMOD/Core/cholmod_band.c"
...
# 72 "CHOLMOD/Core/cholmod_band.c"
    ...
    { if ((A) == 
# 73 "CHOLMOD/Core/cholmod_band.c" 3 4
   ((void *)0)
# 73 "CHOLMOD/Core/cholmod_band.c"
   ) { if (Common->status != (-2)) { cholmod_l_error ((-4), "CHOLMOD/Core/cholmod_band.c", 73, "argument missing", Common) ; } return (
# 73 "CHOLMOD/Core/cholmod_band.c" 3 4
   ((void *)0)
# 73 "CHOLMOD/Core/cholmod_band.c"
   ) ; } } ;
...
# 75 "CHOLMOD/Core/cholmod_band.c" 3 4
   ((void *)0)
# 75 "CHOLMOD/Core/cholmod_band.c"
   ) || ((A)->xtype == 3 && ((A)->z) == 
# 75 "CHOLMOD/Core/cholmod_band.c" 3 4
   ((void *)0)
# 75 "CHOLMOD/Core/cholmod_band.c"
...
# 75 "CHOLMOD/Core/cholmod_band.c"
 ...
 cholmod_l_error ((-4), "CHOLMOD/Core/cholmod_band.c", 82, "cannot operate on unpacked matrix in-place", Common) ;
 return (
# 83 "CHOLMOD/Core/cholmod_band.c" 3 4
        ((void *)0)
# 83 "CHOLMOD/Core/cholmod_band.c"
            ) ;
    }
    Common->status = 0 ;
 ...
 C = cholmod_l_allocate_sparse (A->nrow, ncol, nz, sorted, 1,
  A->stype, values ? A->xtype : 0, Common) ;
 if (Common->status < 0)
 {
     return (
# 189 "CHOLMOD/Core/cholmod_band.c" 3 4
            ((void *)0)
# 189 "CHOLMOD/Core/cholmod_band.c"
                ) ;
 }
    }
 ...
 ;
 cholmod_l_reallocate_sparse (nz, A, Common) ;
 ;
    }
...
{
    return (band (A, k1, k2, mode, 0, Common)) ;
}
...
{
    return (band (A, k1, k2, mode, 1, Common) != 
# 372 "CHOLMOD/Core/cholmod_band.c" 3 4
                                                   ((void *)0)
# 372 "CHOLMOD/Core/cholmod_band.c"
                                                       ) ;
}
