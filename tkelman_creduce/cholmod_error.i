# 1 "CHOLMOD/Core/cholmod_error.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "CHOLMOD/Core/cholmod_error.c"
# 15 "CHOLMOD/Core/cholmod_error.c"
...
# 16 "CHOLMOD/Core/cholmod_error.c" 2
...
# 17 "CHOLMOD/Core/cholmod_error.c" 2
# 34 "CHOLMOD/Core/cholmod_error.c"
int cholmod_l_error
(
...
{
    { if (Common == 
# 45 "CHOLMOD/Core/cholmod_error.c" 3 4
   ((void *)0)
# 45 "CHOLMOD/Core/cholmod_error.c"
...
# 54 "CHOLMOD/Core/cholmod_error.c" 3 4
                                      ((void *)0)
# 54 "CHOLMOD/Core/cholmod_error.c"
                                          )
 {
  ...
  SuiteSparse_config.printf_func ("CHOLMOD warning: %s\n",
                    message) ;
  fflush (
# 60 "CHOLMOD/Core/cholmod_error.c" 3 4
         stdout
# 60 "CHOLMOD/Core/cholmod_error.c"
               ) ;
  fflush (
# 61 "CHOLMOD/Core/cholmod_error.c" 3 4
         stderr
# 61 "CHOLMOD/Core/cholmod_error.c"
               ) ;
     }
  ...
  SuiteSparse_config.printf_func ("CHOLMOD error: %s\n",
                    message) ;
  fflush (
# 67 "CHOLMOD/Core/cholmod_error.c" 3 4
         stdout
# 67 "CHOLMOD/Core/cholmod_error.c"
               ) ;
  fflush (
# 68 "CHOLMOD/Core/cholmod_error.c" 3 4
         stderr
# 68 "CHOLMOD/Core/cholmod_error.c"
               ) ;
     }
 }
 ...
 if (Common->error_handler != 
# 74 "CHOLMOD/Core/cholmod_error.c" 3 4
                             ((void *)0)
# 74 "CHOLMOD/Core/cholmod_error.c"
                                 )
 {
