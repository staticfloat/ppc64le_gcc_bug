# 1 "UMFPACK/Source/umf_malloc.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "UMFPACK/Source/umf_malloc.c"
# 17 "UMFPACK/Source/umf_malloc.c"
...
# 18 "UMFPACK/Source/umf_malloc.c" 2
...
# 19 "UMFPACK/Source/umf_malloc.c" 2
# 40 "UMFPACK/Source/umf_malloc.c"
 void *umf_l_malloc
(
    long n_objects,
    size_t size_of_object
)
{
    size_t size ;
    void *p ;
# 61 "UMFPACK/Source/umf_malloc.c"
    ;

    p = SuiteSparse_malloc (n_objects, size_of_object) ;

    ;
# 77 "UMFPACK/Source/umf_malloc.c"
    return (p) ;
}
