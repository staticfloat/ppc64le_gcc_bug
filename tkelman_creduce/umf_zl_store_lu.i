# 1 "UMFPACK/Source/umf_store_lu.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "UMFPACK/Source/umf_store_lu.c"
# 15 "UMFPACK/Source/umf_store_lu.c"
...
# 16 "UMFPACK/Source/umf_store_lu.c" 2
...
# 17 "UMFPACK/Source/umf_store_lu.c" 2
...
# 18 "UMFPACK/Source/umf_store_lu.c" 2
...
# 19 "UMFPACK/Source/umf_store_lu.c" 2
 ...
 *Uilen, *Lip, *Uip, *Li, *Ui, pivcol_position, newLchain, newUchain,
 ...
 Lnz [64] ;
# 63 "UMFPACK/Source/umf_store_lu.c"
    fnrows = Work->fnrows ;
    fncols = Work->fncols ;
    fnpiv = Work->fnpiv ;
    ...
    nb = Work->nb ;
# 119 "UMFPACK/Source/umf_store_lu.c"
    Pivrow = Work->Pivrow ;
    Pivcol = Work->Pivcol ;
 ...
 pivrow = Pivrow [kk] ;
 pivcol = Pivcol [kk] ;
# 168 "UMFPACK/Source/umf_store_lu.c"
 ;
 ;
 ...
 lnz2i = 0 ;
 lnz2x = llen ;
# 242 "UMFPACK/Source/umf_store_lu.c"
...
# 320 "UMFPACK/Source/umf_store_lu.c"
 ...
 if (newLchain)
 {
     ...
     ;
# 422 "UMFPACK/Source/umf_store_lu.c"
  for (i = kk + 1 ; i < fnpiv ; i++)
  {
      DoubleComplex x ;
      long row2, pos ;
 ...
 {
     ;
# 501 "UMFPACK/Source/umf_store_lu.c"
  for (i = kk + 1 ; i < fnpiv ; i++)
  {
      DoubleComplex x ;
      long row2, pos ;
 ...
 ;
 ;
# 555 "UMFPACK/Source/umf_store_lu.c"
     Numeric->lnz += lnz ;
     Numeric->all_lnz += lnz ;
     Lnz [kk] = lnz ;
 ...
 pivrow = Pivrow [kk] ;
 pivcol = Pivcol [kk] ;
# 615 "UMFPACK/Source/umf_store_lu.c"
 ...
 ;
# 674 "UMFPACK/Source/umf_store_lu.c"
     for (i = kk + 1 ; i < fnpiv ; i++)
     {
...
# 744 "UMFPACK/Source/umf_store_lu.c"
 p = umfzl_mem_alloc_head_block (Numeric, size) ;
 if (!p)
 {
     long r2, c2 ;
 ...
 {
     ;
# 895 "UMFPACK/Source/umf_store_lu.c"
  for (i = kk + 1 ; i < fnpiv ; i++)
  {
      DoubleComplex x ;
      long col2, pos ;
 ...
 else
 {
     ...
     ;
# 973 "UMFPACK/Source/umf_store_lu.c"
  for (i = kk + 1 ; i < fnpiv ; i++)
  {
      DoubleComplex x ;
      long col2, pos ;
 ...
 ;
 ;
# 1027 "UMFPACK/Source/umf_store_lu.c"
     Numeric->unz += unz ;
     Numeric->all_unz += unz ;
