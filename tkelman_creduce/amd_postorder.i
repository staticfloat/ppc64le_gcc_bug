# 1 "AMD/Source/amd_postorder.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "AMD/Source/amd_postorder.c"
# 13 "AMD/Source/amd_postorder.c"
...
# 14 "AMD/Source/amd_postorder.c" 2
...
{
    long i, j, k, parent, frsize, f, fprev, maxfrsize, bigfprev, bigf, fnext ;
...
# 102 "AMD/Source/amd_postorder.c"
    for (i = 0 ; i < nn ; i++)
    {
 if (Nv [i] > 0 && Child [i] != (-1))
 {
# 121 "AMD/Source/amd_postorder.c"
     fprev = (-1) ;
     maxfrsize = (-1) ;
     bigfprev = (-1) ;
     bigf = (-1) ;
...
# 180 "AMD/Source/amd_postorder.c"
 }
    }
 ...
 {
     ;
     k = amd_l_post_tree (i, k, Child, Sibling, Order, Stack
