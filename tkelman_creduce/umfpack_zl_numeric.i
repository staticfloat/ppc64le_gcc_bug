# 1 "UMFPACK/Source/umfpack_numeric.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "UMFPACK/Source/umfpack_numeric.c"
# 21 "UMFPACK/Source/umfpack_numeric.c"
...
# 22 "UMFPACK/Source/umfpack_numeric.c" 2
# 1 "UMFPACK/Source/umf_valid_symbolic.h" 1





 long umfzl_valid_symbolic
(
    SymbolicType *Symbolic
) ;
# 23 "UMFPACK/Source/umfpack_numeric.c" 2
...
# 24 "UMFPACK/Source/umfpack_numeric.c" 2
# 1 "UMFPACK/Source/umf_kernel.h" 1
...
# 25 "UMFPACK/Source/umfpack_numeric.c" 2
...
# 26 "UMFPACK/Source/umfpack_numeric.c" 2
...
# 27 "UMFPACK/Source/umfpack_numeric.c" 2
# 1 "UMFPACK/Source/umf_realloc.h" 1
...
# 28 "UMFPACK/Source/umfpack_numeric.c" 2





static long work_alloc
(
    WorkType *Work,
    SymbolicType *Symbolic
) ;
...
)
{
    ...
    double Info2 [90], alloc_init, relpt, relpt2, droptol,
 front_alloc_init, stats [2] ;
    double *Info ;
    WorkType WorkSpace, *Work ;
    NumericType *Numeric ;
    SymbolicType *Symbolic ;
    long n_row, n_col, n_inner, newsize, i, status, *inew, npiv, ulen, scale ;
    Unit *mnew ;
    ...
    umfpack_tic (stats) ;
# 111 "UMFPACK/Source/umfpack_numeric.c"
    relpt = ((Control != (double *) 
# 111 "UMFPACK/Source/umfpack_numeric.c" 3 4
           ((void *)0)
# 111 "UMFPACK/Source/umfpack_numeric.c"
           ) ? (((Control [3]) != (Control [3])) ? 0.1 : Control [3]) : 0.1)
                                  ;
    relpt2 = ((Control != (double *) 
# 113 "UMFPACK/Source/umfpack_numeric.c" 3 4
            ((void *)0)
# 113 "UMFPACK/Source/umfpack_numeric.c"
            ) ? (((Control [15]) != (Control [15])) ? 0.001 : Control [15]) : 0.001)
                                      ;
    alloc_init = ((Control != (double *) 
# 115 "UMFPACK/Source/umfpack_numeric.c" 3 4
                ((void *)0)
# 115 "UMFPACK/Source/umfpack_numeric.c"
                ) ? (((Control [6]) != (Control [6])) ? 0.7 : Control [6]) : 0.7) ;
    front_alloc_init = ((Control != (double *) 
# 116 "UMFPACK/Source/umfpack_numeric.c" 3 4
                      ((void *)0)
# 116 "UMFPACK/Source/umfpack_numeric.c"
                      ) ? (((Control [17]) != (Control [17])) ? 0.5 : Control [17]) : 0.5)
                                   ;
    scale = ((Control != (double *) 
# 118 "UMFPACK/Source/umfpack_numeric.c" 3 4
           ((void *)0)
# 118 "UMFPACK/Source/umfpack_numeric.c"
           ) ? (((Control [16]) != (Control [16])) ? 1 : Control [16]) : 1) ;
    droptol = ((Control != (double *) 
# 119 "UMFPACK/Source/umfpack_numeric.c" 3 4
             ((void *)0)
# 119 "UMFPACK/Source/umfpack_numeric.c"
    ...
    droptol = (((0.0) > (droptol)) ? (0.0) : (droptol)) ;
 ...
 scale = 1 ;
    ...
    if (User_Info != (double *) 
# 131 "UMFPACK/Source/umfpack_numeric.c" 3 4
                               ((void *)0)
# 131 "UMFPACK/Source/umfpack_numeric.c"
                                   )
    {
 ...
 for (i = 0 ; i < 90 ; i++)
 {
    ...
    Numeric = (NumericType *) 
# 156 "UMFPACK/Source/umfpack_numeric.c" 3 4
                             ((void *)0) 
# 156 "UMFPACK/Source/umfpack_numeric.c"
                                  ;
    if (!umfzl_valid_symbolic (Symbolic))
    {
 Info [0] = (-4) ;
 return ((-4)) ;
    }
 ...
 alloc_init = (((1.0) < (alloc_init)) ? (1.0) : (alloc_init)) ;
 alloc_init *= (1.2) ;
    }
    ...
    if (((!((Symbolic->dnum_mem_init_usage * sizeof (Unit)) * (1.0+1e-8) <= (double) 0x7fffffffffffffffL)) || ((Symbolic->dnum_mem_init_usage * sizeof (Unit)) != (Symbolic->dnum_mem_init_usage * sizeof (Unit)))))
    {
 ...
 return ((-5)) ;
    ...
    Info [2] = Ap [n_col] ;
    *NumericHandle = (void *) 
# 199 "UMFPACK/Source/umfpack_numeric.c" 3 4
                             ((void *)0) 
# 199 "UMFPACK/Source/umfpack_numeric.c"
                                  ;
# 216 "UMFPACK/Source/umfpack_numeric.c"
    Work = &WorkSpace ;
    Work->n_row = n_row ;
    Work->n_col = n_col ;
 ...
 return ((-1)) ;
    ...
    ;
# 247 "UMFPACK/Source/umfpack_numeric.c"
 ...
 return ((-1)) ;
    ...
    Numeric->scale = scale ;
                                               ...
                                               ;
# 288 "UMFPACK/Source/umfpack_numeric.c"
    ;
    status = umfzl_kernel (Ap, Ai, Ax,
 ...
 return (status) ;
    ...
    Info [74] = Work->nforced ;
    Info [45] = Numeric->init_usage ;
    if (Symbolic->prefer_diagonal)
    {
 Info [76] = Work->noff_diagonal ;
    }
    ...
    npiv = Numeric->npiv ;
    ulen = Numeric->ulen ;
# 327 "UMFPACK/Source/umfpack_numeric.c"
    ...
    ;
                                       ...
                                       ;
# 348 "UMFPACK/Source/umfpack_numeric.c"
    if (npiv < n_row)
    {

 inew = (long *) umf_l_realloc (Numeric->Lpos, npiv+1, sizeof (long)) ;
 if (inew)
 {
     Numeric->Lpos = inew ;
 }
 inew = (long *) umf_l_realloc (Numeric->Uilen, npiv+1, sizeof (long)) ;
 if (inew)
 {
     Numeric->Uilen = inew ;
 }
 inew = (long *) umf_l_realloc (Numeric->Uip, npiv+1, sizeof (long)) ;
 if (inew)
 {
     Numeric->Uip = inew ;
 }
 ...
 inew = (long *) umf_l_realloc (Numeric->Upos, npiv+1, sizeof (long)) ;
 if (inew)
 {
     Numeric->Upos = inew ;
 }
 inew = (long *) umf_l_realloc (Numeric->Lilen, npiv+1, sizeof (long)) ;
 if (inew)
 {
     Numeric->Lilen = inew ;
 }
 inew = (long *) umf_l_realloc (Numeric->Lip, npiv+1, sizeof (long)) ;
 if (inew)
 {
     Numeric->Lip = inew ;
 }
    }
# 396 "UMFPACK/Source/umfpack_numeric.c"
    ;
    ;
    if (ulen > 0 && ulen < n_col)
    {
 inew = (long *) umf_l_realloc (Numeric->Upattern, ulen+1, sizeof (long)) ;
 if (inew)
 {
     Numeric->Upattern = inew ;
 }
    }
# 416 "UMFPACK/Source/umfpack_numeric.c"
    newsize = Numeric->ihead ;
    if (newsize < Numeric->size)
    {
 mnew = (Unit *) umf_l_realloc (Numeric->Memory, newsize, sizeof (Unit)) ;
 if (mnew)
 {
 ...
 0) ;
    ...
    Info [73] = Numeric->alloc_init ;
    Info [60] = Numeric->ngarbage ;
    Info [61] = Numeric->nrealloc ;
    Info [62] = Numeric->ncostly ;
    Info [63] = Numeric->isize ;
    Info [64] = Numeric->nLentries + Numeric->nUentries +
     Numeric->npiv ;
    Info [66] = Numeric->nnzpiv ;
    Info [69] = Numeric->rsmin ;
    Info [70] = Numeric->rsmax ;
    Info [68] = Numeric->scale ;


    Info [77] = Numeric->all_lnz + n_inner ;
    Info [78] = Numeric->all_unz + Numeric->nnzpiv ;
    Info [79] =
   (Numeric->all_lnz - Numeric->lnz)
 + (Numeric->all_unz - Numeric->unz) ;


    if (((Numeric->min_udiag) == 0.)
     || ((Numeric->max_udiag) == 0.)
     || ((Numeric->min_udiag) != (Numeric->min_udiag))
     || ((Numeric->max_udiag) != (Numeric->max_udiag)))
    {
 ...
 Numeric->rcond = Numeric->min_udiag / Numeric->max_udiag ;
    ...
    Info [71] = Numeric->min_udiag ;
    Info [72] = Numeric->max_udiag ;
    Info [67] = Numeric->rcond ;

    if (Numeric->nnzpiv < n_inner
    || ((Numeric->rcond) == 0.) || ((Numeric->rcond) != (Numeric->rcond)))
    {
...
# 531 "UMFPACK/Source/umfpack_numeric.c"
static long numeric_alloc
(
    NumericType **NumericHandle,
    SymbolicType *Symbolic,
...
)
{
    ...
    n_col = Symbolic->n_col ;
    n_inner = (((n_row) < (n_col)) ? (n_row) : (n_col)) ;
    *NumericHandle = (NumericType *) 
# 548 "UMFPACK/Source/umfpack_numeric.c" 3 4
                                    ((void *)0) 
# 548 "UMFPACK/Source/umfpack_numeric.c"
                                         ;



    Numeric = (NumericType *) umf_l_malloc (1, sizeof (NumericType)) ;
 ...
 return ((0)) ;
    ...
    *NumericHandle = Numeric ;
    ...
    Numeric->D = (DoubleComplex *) umf_l_malloc (n_inner+1, sizeof (DoubleComplex)) ;
    Numeric->Rperm = (long *) umf_l_malloc (n_row+1, sizeof (long)) ;
    Numeric->Cperm = (long *) umf_l_malloc (n_col+1, sizeof (long)) ;
    Numeric->Lpos = (long *) umf_l_malloc (n_row+1, sizeof (long)) ;
    Numeric->Lilen = (long *) umf_l_malloc (n_col+1, sizeof (long)) ;
    Numeric->Lip = (long *) umf_l_malloc (n_col+1, sizeof (long)) ;
    Numeric->Upos = (long *) umf_l_malloc (n_col+1, sizeof (long)) ;
    Numeric->Uilen = (long *) umf_l_malloc (n_row+1, sizeof (long)) ;
    Numeric->Uip = (long *) umf_l_malloc (n_row+1, sizeof (long)) ;
    ...
    {
 ;
 Numeric->Rs = (double *) umf_l_malloc (n_row, sizeof (double)) ;
    }
    else
    {
 ;
 Numeric->Rs = (double *) 
# 583 "UMFPACK/Source/umfpack_numeric.c" 3 4
                         ((void *)0) 
# 583 "UMFPACK/Source/umfpack_numeric.c"
                              ;
    }

    Numeric->Memory = (Unit *) 
# 586 "UMFPACK/Source/umfpack_numeric.c" 3 4
                              ((void *)0) 
# 586 "UMFPACK/Source/umfpack_numeric.c"
                                   ;
    ...
    Numeric->Upattern = (long *) 
# 593 "UMFPACK/Source/umfpack_numeric.c" 3 4
                               ((void *)0) 
# 593 "UMFPACK/Source/umfpack_numeric.c"
                                    ;

    if (!Numeric->D || !Numeric->Rperm || !Numeric->Cperm || !Numeric->Upos ||
 !Numeric->Lpos || !Numeric->Lilen || !Numeric->Uilen || !Numeric->Lip ||
 !Numeric->Uip || (scale != 0 && !Numeric->Rs))
    {
 return ((0)) ;
    }
 ...
 nsize = (alloc_init * Symbolic->num_mem_usage_est) + 1 ;
    ...
    nsize = (((min_usage) > (nsize)) ? (min_usage) : (nsize)) ;



    bsize = ((double) 0x7fffffffffffffffL) / sizeof (Unit) - 1 ;
    ;
    nsize = (((nsize) < (bsize)) ? (nsize) : (bsize)) ;

    Numeric->size = (long) nsize ;
    ...
    while (trying)
    {
 Numeric->Memory = (Unit *) umf_l_malloc (Numeric->size, sizeof (Unit)) ;
 if (Numeric->Memory)
 {
     ;
     return ((1)) ;
 ...
 Numeric->size = (long)
     ((0.95) * ((double) Numeric->size)) ;
 Numeric->size = (((min_usage) > (Numeric->size)) ? (min_usage) : (Numeric->size)) ;
    }

    return ((0)) ;
}
# 661 "UMFPACK/Source/umfpack_numeric.c"
static long work_alloc
(
    WorkType *Work,
    SymbolicType *Symbolic
)
{
    ...
    maxnrows = (((n_row) < (maxnrows)) ? (n_row) : (maxnrows)) ;
    maxncols = Symbolic->maxncols + Symbolic->nb ;
    maxncols = (((n_col) < (maxncols)) ? (n_col) : (maxncols)) ;
    maxnrc = (((maxnrows) > (maxncols)) ? (maxnrows) : (maxncols)) ;
    ...
    Work->Wx = (DoubleComplex *) umf_l_malloc (maxnrows + 1, sizeof (DoubleComplex)) ;
    Work->Wy = (DoubleComplex *) umf_l_malloc (maxnrows + 1, sizeof (DoubleComplex)) ;
    Work->Frpos = (long *) umf_l_malloc (n_row + 1, sizeof (long)) ;
    Work->Lpattern = (long *) umf_l_malloc (n_row + 1, sizeof (long)) ;
    Work->Fcpos = (long *) umf_l_malloc (n_col + 1, sizeof (long)) ;
    Work->Wp = (long *) umf_l_malloc (nn + 1, sizeof (long)) ;
    Work->Wrp = (long *) umf_l_malloc ((((n_col) > (maxnrows)) ? (n_col) : (maxnrows)) + 1, sizeof (long)) ;
    Work->Frows = (long *) umf_l_malloc (maxnrows + 1, sizeof (long)) ;
    Work->Wm = (long *) umf_l_malloc (maxnrows + 1, sizeof (long)) ;
    Work->Fcols = (long *) umf_l_malloc (maxncols + 1, sizeof (long)) ;
    Work->Wio = (long *) umf_l_malloc (maxncols + 1, sizeof (long)) ;
    Work->Woi = (long *) umf_l_malloc (maxncols + 1, sizeof (long)) ;
    Work->Woo = (long *) umf_l_malloc (maxnrc + 1, sizeof (long));
    Work->elen = (n_col - n1) + (n_row - n1) + (((n_col-n1) < (n_row-n1)) ? (n_col-n1) : (n_row-n1)) + 1 ;
    Work->E = (long *) umf_l_malloc (Work->elen, sizeof (long)) ;
    Work->Front_new1strow = (long *) umf_l_malloc (nfr + 1, sizeof (long)) ;
 ...
 && Work->E && Work->Front_new1strow && Work->Wx && Work->Wy) ;
    ...
    if (Symbolic->prefer_diagonal)
    {
 Work->Diagonal_map = (long *) umf_l_malloc (nn, sizeof (long)) ;
 Work->Diagonal_imap = (long *) umf_l_malloc (nn, sizeof (long)) ;
 ok = ok && Work->Diagonal_map && Work->Diagonal_imap ;
    }
    else
    {

 Work->Diagonal_map = (long *) 
# 719 "UMFPACK/Source/umfpack_numeric.c" 3 4
                             ((void *)0) 
# 719 "UMFPACK/Source/umfpack_numeric.c"
                                  ;
 Work->Diagonal_imap = (long *) 
# 720 "UMFPACK/Source/umfpack_numeric.c" 3 4
                              ((void *)0) 
# 720 "UMFPACK/Source/umfpack_numeric.c"
                                   ;
    }


    Work->Upattern = (long *) umf_l_malloc (n_col + 1, sizeof (long)) ;
    ok = ok && Work->Upattern ;


    Work->Flublock = (DoubleComplex *) 
# 728 "UMFPACK/Source/umfpack_numeric.c" 3 4
                              ((void *)0) 
# 728 "UMFPACK/Source/umfpack_numeric.c"
                                   ;
    Work->Flblock = (DoubleComplex *) 
# 729 "UMFPACK/Source/umfpack_numeric.c" 3 4
                              ((void *)0) 
# 729 "UMFPACK/Source/umfpack_numeric.c"
                                   ;
    Work->Fublock = (DoubleComplex *) 
# 730 "UMFPACK/Source/umfpack_numeric.c" 3 4
                              ((void *)0) 
# 730 "UMFPACK/Source/umfpack_numeric.c"
                                   ;
    Work->Fcblock = (DoubleComplex *) 
# 731 "UMFPACK/Source/umfpack_numeric.c" 3 4
                              ((void *)0) 
# 731 "UMFPACK/Source/umfpack_numeric.c"
                                   ;
...
)
{
 ...
 Work->Wx = (DoubleComplex *) umf_l_free ((void *) Work->Wx) ;
 Work->Wy = (DoubleComplex *) umf_l_free ((void *) Work->Wy) ;
 Work->Frpos = (long *) umf_l_free ((void *) Work->Frpos) ;
 Work->Fcpos = (long *) umf_l_free ((void *) Work->Fcpos) ;
 Work->Lpattern = (long *) umf_l_free ((void *) Work->Lpattern) ;
 Work->Upattern = (long *) umf_l_free ((void *) Work->Upattern) ;
 Work->Wp = (long *) umf_l_free ((void *) Work->Wp) ;
 Work->Wrp = (long *) umf_l_free ((void *) Work->Wrp) ;
 Work->Frows = (long *) umf_l_free ((void *) Work->Frows) ;
 Work->Fcols = (long *) umf_l_free ((void *) Work->Fcols) ;
 Work->Wio = (long *) umf_l_free ((void *) Work->Wio) ;
 Work->Woi = (long *) umf_l_free ((void *) Work->Woi) ;
 Work->Woo = (long *) umf_l_free ((void *) Work->Woo) ;
 Work->Wm = (long *) umf_l_free ((void *) Work->Wm) ;
 Work->E = (long *) umf_l_free ((void *) Work->E) ;
 Work->Front_new1strow =
     (long *) umf_l_free ((void *) Work->Front_new1strow) ;


 Work->Diagonal_map = (long *) umf_l_free ((void *) Work->Diagonal_map) ;
 Work->Diagonal_imap = (long *) umf_l_free ((void *) Work->Diagonal_imap) ;
    }
    ;
}
# 783 "UMFPACK/Source/umfpack_numeric.c"
static void error
(
    NumericType **Numeric,
    WorkType *Work
