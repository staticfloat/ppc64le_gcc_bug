# 1 "UMFPACK/Source/umf_set_stats.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "UMFPACK/Source/umf_set_stats.c"
# 18 "UMFPACK/Source/umf_set_stats.c"
...
# 19 "UMFPACK/Source/umf_set_stats.c" 2
...
# 20 "UMFPACK/Source/umf_set_stats.c" 2
...
# 21 "UMFPACK/Source/umf_set_stats.c" 2
...
)
{
 ...
 num_On_size2, num_usage, sym_maxncols, sym_maxnrows, elen, n1 ;
    ...
    sym_maxncols = (((Symbolic->maxncols + Symbolic->nb) < (n_col)) ? (Symbolic->maxncols + Symbolic->nb) : (n_col)) ;
    sym_maxnrows = (((Symbolic->maxnrows + Symbolic->nb) < (n_row)) ? (Symbolic->maxnrows + Symbolic->nb) : (n_row)) ;
    elen = (n_col - n1) + (n_row - n1) + (((n_col - n1) < (n_row - n1)) ? (n_col - n1) : (n_row - n1)) + 1 ;


    sym_size = umfzl_symbolic_usage (Symbolic->n_row, Symbolic->n_col,
 Symbolic->nchains, Symbolic->nfr, Symbolic->esize, prefer_diagonal) ;



    num_On_size1 =
 (ceil ((sizeof (NumericType) * ((double) 1)) / sizeof (Unit)))
 + (ceil ((sizeof (DoubleComplex) * ((double) n_inner+1)) / sizeof (Unit)))
 + 4 * (ceil ((sizeof (long) * ((double) n_row+1)) / sizeof (Unit)))
 + 4 * (ceil ((sizeof (long) * ((double) n_col+1)) / sizeof (Unit)))
 + (scale ? (ceil ((sizeof (DoubleComplex) * ((double) n_row)) / sizeof (Unit))) : 0) ;
 ...
 (ceil ((sizeof (NumericType) * ((double) 1)) / sizeof (Unit)))
 + (ceil ((sizeof (DoubleComplex) * ((double) n_inner+1)) / sizeof (Unit)))
 + (ceil ((sizeof (long) * ((double) n_row+1)) / sizeof (Unit)))
 + (ceil ((sizeof (long) * ((double) n_col+1)) / sizeof (Unit)))
 + 6 * (ceil ((sizeof (long) * ((double) npiv+1)) / sizeof (Unit)))
 + (scale ? (ceil ((sizeof (DoubleComplex) * ((double) n_row)) / sizeof (Unit))) : 0) ;
    ...
    Info [46 + what] = max_usage ;


    Info [47 + what] = num_mem_size ;


    Info [40 + what] =
 num_On_size2
 + num_mem_size
 + (ceil ((sizeof (long) * ((double) ulen+1)) / sizeof (Unit))) ;
    ...
    Info [48 + what] = maxfrsize ;
    Info [49 + what] = maxnrows ;
    Info [50 + what] = maxncols ;
    ;
    ;
 ...
 2 * (ceil ((sizeof (DoubleComplex) * ((double) sym_maxnrows + 1)) / sizeof (Unit)))
 + 2 * (ceil ((sizeof (long) * ((double) n_row+1)) / sizeof (Unit)))
 + 2 * (ceil ((sizeof (long) * ((double) n_col+1)) / sizeof (Unit)))
 + (ceil ((sizeof (long) * ((double) nn + 1)) / sizeof (Unit)))
 + (ceil ((sizeof (long) * ((double) (((n_col) > (sym_maxnrows)) ? (n_col) : (sym_maxnrows)) + 1)) / sizeof (Unit)))
 + 2 * (ceil ((sizeof (long) * ((double) sym_maxnrows + 1)) / sizeof (Unit)))
 + 3 * (ceil ((sizeof (long) * ((double) sym_maxncols + 1)) / sizeof (Unit)))
 + (ceil ((sizeof (long) * ((double) (((sym_maxnrows) > (sym_maxncols)) ? (sym_maxnrows) : (sym_maxncols)) + 1)) / sizeof (Unit)))
 + (ceil ((sizeof (long) * ((double) elen)) / sizeof (Unit)))
 + (ceil ((sizeof (long) * ((double) Symbolic->nfr + 1)) / sizeof (Unit)))
 + ((n_row == n_col) ? (2 * (ceil ((sizeof (long) * ((double) nn)) / sizeof (Unit)))) : 0) ;
 ...
 + max_usage ;
    ...
    Info [41 + what] =
 (((Symbolic->peak_sym_usage) > (num_usage)) ? (Symbolic->peak_sym_usage) : (num_usage)) ;
