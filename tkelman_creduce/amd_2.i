# 1 "AMD/Source/amd_2.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "AMD/Source/amd_2.c"
# 16 "AMD/Source/amd_2.c"
...
# 17 "AMD/Source/amd_2.c" 2





static long clear_flag (long wflg, long wbig, long W [ ], long n)
{
    long x ;
    if (wflg < 2 || wflg >= wbig)
    {
...
{
# 460 "AMD/Source/amd_2.c"
    long deg, degme, dext, lemax, e, elenme, eln, i, ilast, inext, j,
 jlast, jnext, k, knt1, knt2, knt3, lenj, ln, me, mindeg, nel, nleft,
 nvi, nvj, nvpiv, slenme, wbig, we, wflg, wnvi, ok, ndense, ncmpa,
 dense, aggressive ;

    unsigned long hash ;
# 516 "AMD/Source/amd_2.c"
    double f, r, ndiv, s, nms_lu, nms_ldl, dmax, alpha, lnz, lnzme ;
# 538 "AMD/Source/amd_2.c"
    long p, p1, p2, p3, p4, pdst, pend, pj, pme, pme1, pme2, pn, psrc ;
# 568 "AMD/Source/amd_2.c"
    ;
    ;
    ...
    if (Control != (double *) 
# 585 "AMD/Source/amd_2.c" 3 4
                             ((void *)0)
# 585 "AMD/Source/amd_2.c"
                                 )
    {
 alpha = Control [0] ;
 ...
 dense = alpha * sqrt ((double) n) ;
    ...
    dense = (((16) > (dense)) ? (16) : (dense)) ;
    dense = (((n) < (dense)) ? (n) : (dense)) ;
...
# 631 "AMD/Source/amd_2.c"
    wbig = 0x7fffffffffffffffL - n ;
...
# 1013 "AMD/Source/amd_2.c"
 wflg = clear_flag (wflg, wbig, W, n) ;
# 1033 "AMD/Source/amd_2.c"
 ;
...
# 1523 "AMD/Source/amd_2.c"
 if (Info != (double *) 
# 1523 "AMD/Source/amd_2.c" 3 4
                       ((void *)0)
# 1523 "AMD/Source/amd_2.c"
                           )
 {
...
# 1553 "AMD/Source/amd_2.c"
    ...
    if (Info != (double *) 
# 1559 "AMD/Source/amd_2.c" 3 4
                          ((void *)0)
# 1559 "AMD/Source/amd_2.c"
                              )
    {


 f = ndense ;
 dmax = (((dmax) > ((double) ndense)) ? (dmax) : ((double) ndense)) ;
...
# 1708 "AMD/Source/amd_2.c"
    for (i = 0 ; i < n ; i++)
    {
 if (Nv [i] == 0)
 {
# 1720 "AMD/Source/amd_2.c"
     ;
     j = Pe [i] ;
     ;
     ;
  ...
  ;
    ...
    amd_l_postorder (n, Pe, Nv, Elen,
 W,
 Head, Next, Last) ;
# 1778 "AMD/Source/amd_2.c"
    for (k = 0 ; k < n ; k++)
    {
 Head [k] = (-1) ;
 Next [k] = (-1) ;
