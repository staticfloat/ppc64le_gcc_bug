# 1 "UMFPACK/Source/umf_get_memory.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "UMFPACK/Source/umf_get_memory.c"
# 18 "UMFPACK/Source/umf_get_memory.c"
...
# 19 "UMFPACK/Source/umf_get_memory.c" 2
...
# 20 "UMFPACK/Source/umf_get_memory.c" 2
...
# 21 "UMFPACK/Source/umf_get_memory.c" 2
...
# 22 "UMFPACK/Source/umf_get_memory.c" 2
...
# 23 "UMFPACK/Source/umf_get_memory.c" 2
...
# 24 "UMFPACK/Source/umf_get_memory.c" 2
...
# 25 "UMFPACK/Source/umf_get_memory.c" 2
...
)
{
    ...
    long i, minsize, newsize, newmem, costly, row, col, *Row_tlen, *Col_tlen,
 n_row, n_col, *Row_degree, *Col_degree ;
    Unit *mnew, *p ;
# 50 "UMFPACK/Source/umf_get_memory.c"
    n_row = Work->n_row ;
    n_col = Work->n_col ;
 ...
 if ((Col_degree [col] >= 0))
 {
    ...
    needunits += umfzl_tuple_lengths (Numeric, Work, &tsize) ;
    nsize += tsize ;
    needunits += 2 ;
# 93 "UMFPACK/Source/umf_get_memory.c"
    ;
    ...
    newsize = (long) ((1.2) * ((double) minsize)) ;
    nsize *= (1.2) ;
    nsize += 1 ;
 ...
 newsize = (((newsize) > (minsize)) ? (newsize) : (minsize)) ;
    ...
    newsize = (((newsize) > (Numeric->size)) ? (newsize) : (Numeric->size)) ;
    ...
    mnew = (Unit *) 
# 131 "UMFPACK/Source/umf_get_memory.c" 3 4
                   ((void *)0) 
# 131 "UMFPACK/Source/umf_get_memory.c"
                        ;
    while (!mnew)
    {
 ...
 if (!mnew)
 {
  ...
  newsize = (long) ((0.95) * ((double) newsize)) ;
  newsize = (((minsize) > (newsize)) ? (minsize) : (newsize)) ;
     }
 }
    }
    ;
 ...
 dr = Work->fnr_curr ;
 dc = Work->fnc_curr ;
 Work->Flublock = (DoubleComplex *) (Numeric->Memory + Work->E [0]) ;
 ...
 umfzl_mem_free_tail_block (Numeric, i) ;
 ...
 if (costly)
 {
    ...
    umfzl_garbage_collection (Numeric, Work, r2, c2, do_Fcpos) ;





    return (umfzl_build_tuples (Numeric, Work)) ;
}
