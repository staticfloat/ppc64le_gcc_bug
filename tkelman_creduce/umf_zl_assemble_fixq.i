# 1 "UMFPACK/Source/umf_assemble.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "UMFPACK/Source/umf_assemble.c"
# 14 "UMFPACK/Source/umf_assemble.c"
...
# 15 "UMFPACK/Source/umf_assemble.c" 2
...
# 16 "UMFPACK/Source/umf_assemble.c" 2
...
# 17 "UMFPACK/Source/umf_assemble.c" 2
...
# 312 "UMFPACK/Source/umf_assemble.c"
}
# 322 "UMFPACK/Source/umf_assemble.c"
 void umfzl_assemble_fixq
 ...
 *Fcpos,
 fnrows,
 fncols ;
# 373 "UMFPACK/Source/umf_assemble.c"
    fncols = Work->fncols ;
    fnrows = Work->fnrows ;
    Fcpos = Work->Fcpos ;
    Frpos = Work->Frpos ;
    ...
    rdeg0 = Work->rdeg0 ;
    cdeg0 = Work->cdeg0 ;
# 420 "UMFPACK/Source/umf_assemble.c"
    Fcblock = Work->Fcblock ;
...
# 1034 "UMFPACK/Source/umf_assemble.c"
    if (Work->any_skip)
    {
...
# 1065 "UMFPACK/Source/umf_assemble.c"
    if (Work->any_skip)
    {
...
# 1215 "UMFPACK/Source/umf_assemble.c"
}
