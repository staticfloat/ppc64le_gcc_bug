# 1 "CHOLMOD/Core/cholmod_common.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "CHOLMOD/Core/cholmod_common.c"
# 36 "CHOLMOD/Core/cholmod_common.c"
...
# 37 "CHOLMOD/Core/cholmod_common.c" 2
...
# 38 "CHOLMOD/Core/cholmod_common.c" 2
# 54 "CHOLMOD/Core/cholmod_common.c"
int cholmod_l_start
(
    cholmod_common *Common
)
{
    ...
    if (Common == 
# 61 "CHOLMOD/Core/cholmod_common.c" 3 4
                 ((void *)0)
# 61 "CHOLMOD/Core/cholmod_common.c"
                     )
    {
 return (0) ;
    }
...
# 70 "CHOLMOD/Core/cholmod_common.c" 3 4
                           ((void *)0) 
# 70 "CHOLMOD/Core/cholmod_common.c"
                                ;
    ...
    Common->try_catch = 0 ;
# 112 "CHOLMOD/Core/cholmod_common.c"
    Common->nrow = 0 ;
    Common->mark = (-1) ;
    Common->xworksize = 0 ;
    Common->iworksize = 0 ;
    Common->Flag = 
# 116 "CHOLMOD/Core/cholmod_common.c" 3 4
                  ((void *)0) 
# 116 "CHOLMOD/Core/cholmod_common.c"
                       ;
    Common->Head = 
# 117 "CHOLMOD/Core/cholmod_common.c" 3 4
                  ((void *)0) 
# 117 "CHOLMOD/Core/cholmod_common.c"
                       ;
    Common->Iwork = 
# 118 "CHOLMOD/Core/cholmod_common.c" 3 4
                   ((void *)0) 
# 118 "CHOLMOD/Core/cholmod_common.c"
                        ;
    Common->Xwork = 
# 119 "CHOLMOD/Core/cholmod_common.c" 3 4
                   ((void *)0) 
# 119 "CHOLMOD/Core/cholmod_common.c"
                        ;
    Common->no_workspace_reallocate = 0 ;
    ...
    Common->malloc_count = 0 ;
    Common->memory_usage = 0 ;
    Common->memory_inuse = 0 ;
    ...
    Common->SPQR_flopcount_bound = 0 ;
    Common->SPQR_tol_used = 0 ;
    Common->SPQR_norm_E_fro = 0 ;

    Common->SPQR_grain = 1 ;
    Common->SPQR_small = 1e6 ;
    Common->SPQR_shrink = 1 ;
    Common->SPQR_nthreads = 0 ;

    Common->SPQR_flopcount = 0 ;
    Common->SPQR_analyze_time = 0 ;
    Common->SPQR_factorize_time = 0 ;
    Common->SPQR_solve_time = 0 ;
    ...
    Common->cublasHandle = 
# 176 "CHOLMOD/Core/cholmod_common.c" 3 4
                          ((void *)0) 
# 176 "CHOLMOD/Core/cholmod_common.c"
                               ;
    Common->cublasEventPotrf [0] = 
# 177 "CHOLMOD/Core/cholmod_common.c" 3 4
                                  ((void *)0) 
# 177 "CHOLMOD/Core/cholmod_common.c"
                                       ;
    Common->cublasEventPotrf [1] = 
# 178 "CHOLMOD/Core/cholmod_common.c" 3 4
                                  ((void *)0) 
# 178 "CHOLMOD/Core/cholmod_common.c"
                                       ;
    Common->cublasEventPotrf [2] = 
# 179 "CHOLMOD/Core/cholmod_common.c" 3 4
                                  ((void *)0) 
# 179 "CHOLMOD/Core/cholmod_common.c"
                                       ;
    for (k = 0 ; k < 8 ; k++)
    {
        Common->gpuStream [k] = 
# 182 "CHOLMOD/Core/cholmod_common.c" 3 4
                               ((void *)0) 
# 182 "CHOLMOD/Core/cholmod_common.c"
                                    ;
        Common->updateCBuffersFree [k] = 
# 183 "CHOLMOD/Core/cholmod_common.c" 3 4
                                        ((void *)0) 
# 183 "CHOLMOD/Core/cholmod_common.c"
                                             ;
    }
    Common->updateCKernelsComplete = 
# 185 "CHOLMOD/Core/cholmod_common.c" 3 4
                                    ((void *)0)
# 185 "CHOLMOD/Core/cholmod_common.c"
                                        ;


    Common->dev_mempool = 
# 188 "CHOLMOD/Core/cholmod_common.c" 3 4
                         ((void *)0)
# 188 "CHOLMOD/Core/cholmod_common.c"
                             ;
    Common->dev_mempool_size = 0;
    Common->host_pinned_mempool = 
# 190 "CHOLMOD/Core/cholmod_common.c" 3 4
                                 ((void *)0)
# 190 "CHOLMOD/Core/cholmod_common.c"
                                     ;
...
# 240 "CHOLMOD/Core/cholmod_common.c"
int cholmod_l_defaults
(
    cholmod_common *Common
)
{
    ...
    { if (Common == 
# 247 "CHOLMOD/Core/cholmod_common.c" 3 4
   ((void *)0)
# 247 "CHOLMOD/Core/cholmod_common.c"
...
# 306 "CHOLMOD/Core/cholmod_common.c"
 ...
 Common->method [i].ordering = 2 ;


 Common->method [i].prune_dense = 10.0 ;


 Common->method [i].prune_dense2 = -1 ;
 Common->method [i].aggressive = 1 ;
 Common->method [i].order_for_lu = 0 ;


 Common->method [i].nd_small = 200 ;
 Common->method [i].nd_compress = 1 ;
 Common->method [i].nd_camd = 1 ;
 Common->method [i].nd_components = 0 ;
 Common->method [i].nd_oksep = 1.0 ;


 Common->method [i].fl = (-1) ;
 Common->method [i].lnz = (-1) ;
    }
    ...
    Common->method [2].ordering = 3 ;
    Common->method [3].ordering = 4 ;
    Common->method [4].ordering = 0 ;


    Common->method [5].ordering = 4 ;
    Common->method [5].nd_small = 20000 ;


    Common->method [6].ordering = 4 ;
    Common->method [6].nd_small = 4 ;
    Common->method [6].nd_camd = 0 ;


    Common->method [7].ordering = 4 ;
    Common->method [7].prune_dense = -1. ;


    Common->method [8].ordering = 5 ;
...
# 391 "CHOLMOD/Core/cholmod_common.c"
int cholmod_l_finish
(
    cholmod_common *Common
)
{
...
# 411 "CHOLMOD/Core/cholmod_common.c"
...
)
{
    ...
    { if (Common == 
# 431 "CHOLMOD/Core/cholmod_common.c" 3 4
   ((void *)0)
# 431 "CHOLMOD/Core/cholmod_common.c"
   ) { return (0) ; } if (Common->itype != 2 || Common->dtype != 0) { Common->status = (-4) ; return (0) ; } } ;
    Common->status = 0 ;
    ...
    nrow1 = cholmod_l_add_size_t (nrow, 1, &ok) ;
    if (!ok)
    {

 Common->status = (-3) ;
 cholmod_l_free_work (Common) ;
 return (0) ;
    }
 ...
 Common->Flag = cholmod_l_free (Common->nrow, sizeof (long), Common->Flag,
  Common) ;
 Common->Head = cholmod_l_free (Common->nrow+1,sizeof (long), Common->Head,
  Common) ;
 Common->Flag = cholmod_l_malloc (nrow, sizeof (long), Common) ;
 Common->Head = cholmod_l_malloc (nrow1, sizeof (long), Common) ;
 ...
 for (i = 0 ; i <= (long) (nrow) ; i++)
 {
    ...
    iworksize = (((1) > (iworksize)) ? (1) : (iworksize)) ;
 ...
 cholmod_l_free (Common->iworksize, sizeof (long), Common->Iwork, Common) ;
 Common->Iwork = cholmod_l_malloc (iworksize, sizeof (long), Common) ;
 ...
 if (Common->status < 0)
 {
    ...
    xworksize = (((1) > (xworksize)) ? (1) : (xworksize)) ;
 ...
 cholmod_l_free (Common->xworksize, sizeof (double), Common->Xwork,
  Common) ;
 Common->Xwork = cholmod_l_malloc (xworksize, sizeof (double), Common) ;
...
# 570 "CHOLMOD/Core/cholmod_common.c"
int cholmod_l_free_work
(
    cholmod_common *Common
)
{
    { if (Common == 
# 575 "CHOLMOD/Core/cholmod_common.c" 3 4
   ((void *)0)
# 575 "CHOLMOD/Core/cholmod_common.c"
   ) { return (0) ; } if (Common->itype != 2 || Common->dtype != 0) { Common->status = (-4) ; return (0) ; } } ;
    Common->Flag = cholmod_l_free (Common->nrow, sizeof (long),
     Common->Flag, Common) ;
    Common->Head = cholmod_l_free (Common->nrow+1, sizeof (long),
     Common->Head, Common) ;
    Common->Iwork = cholmod_l_free (Common->iworksize, sizeof (long),
     Common->Iwork, Common) ;
    Common->Xwork = cholmod_l_free (Common->xworksize, sizeof (double),
     Common->Xwork, Common) ;
    Common->nrow = 0 ;
    Common->iworksize = 0 ;
    Common->xworksize = 0 ;
...
# 606 "CHOLMOD/Core/cholmod_common.c"
long cholmod_l_clear_flag
(
    cholmod_common *Common
)
{
    ...
    { if (Common == 
# 613 "CHOLMOD/Core/cholmod_common.c" 3 4
   ((void *)0)
# 613 "CHOLMOD/Core/cholmod_common.c"
...
# 639 "CHOLMOD/Core/cholmod_common.c"
size_t cholmod_l_maxrank
(
...
)
{
    size_t maxrank ;
    { if (Common == 
# 648 "CHOLMOD/Core/cholmod_common.c" 3 4
   ((void *)0)
# 648 "CHOLMOD/Core/cholmod_common.c"
   ) { return (0) ; } if (Common->itype != 2 || Common->dtype != 0) { Common->status = (-4) ; return (0) ; } } ;
 ...
 maxrank = (((maxrank) < (((size_t) (-1)) / (n * sizeof (double)))) ? (maxrank) : (((size_t) (-1)) / (n * sizeof (double)))) ;
    }
    if (maxrank <= 2)
    {
 maxrank = 2 ;
...
# 689 "CHOLMOD/Core/cholmod_common.c"
double cholmod_l_dbound
(
...
)
{
    double dbound ;
    { if (Common == 
# 698 "CHOLMOD/Core/cholmod_common.c" 3 4
   ((void *)0)
# 698 "CHOLMOD/Core/cholmod_common.c"
   ) { return (0) ; } if (Common->itype != 2 || Common->dtype != 0) { Common->status = (-4) ; return (0) ; } } ;
    if (!((dj) != (dj)))
    {
 ...
 if (dj < 0)
 {
  ...
  if (Common->status == 0)
  {
      cholmod_l_error ((2), "CHOLMOD/Core/cholmod_common.c", 710, "diagonal below threshold", Common) ;
  }
     }
 }
 else
 {
  ...
  if (Common->status == 0)
  {
      cholmod_l_error ((2), "CHOLMOD/Core/cholmod_common.c", 722, "diagonal below threshold", Common) ;
  }
     }
 }
    }
