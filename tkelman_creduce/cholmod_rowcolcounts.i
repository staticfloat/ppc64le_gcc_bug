# 1 "CHOLMOD/Cholesky/cholmod_rowcolcounts.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "CHOLMOD/Cholesky/cholmod_rowcolcounts.c"
# 53 "CHOLMOD/Cholesky/cholmod_rowcolcounts.c"
...
# 54 "CHOLMOD/Cholesky/cholmod_rowcolcounts.c" 2
...
# 55 "CHOLMOD/Cholesky/cholmod_rowcolcounts.c" 2
...
# 91 "CHOLMOD/Cholesky/cholmod_rowcolcounts.c"
...
(
    ...
    long SetParent [ ],
# 113 "CHOLMOD/Cholesky/cholmod_rowcolcounts.c"
    long Level [ ]
)
{
    long prevleaf, q, s, sparent ;
 ...
 if (RowCount != 
# 149 "CHOLMOD/Cholesky/cholmod_rowcolcounts.c" 3 4
                ((void *)0)
# 149 "CHOLMOD/Cholesky/cholmod_rowcolcounts.c"
                    )
 {
...
{
    double fl, ff ;
    long *Ap, *Ai, *Anz, *PrevNbr, *SetParent, *Head, *PrevLeaf, *Anext, *Ipost,
 *Iwork ;
    long i, j, r, k, len, s, p, pend, inew, stype, nf, anz, inode, parent,
 nrow, ncol, packed, use_fset, jj ;
    ...
    { if (Common == 
# 221 "CHOLMOD/Cholesky/cholmod_rowcolcounts.c" 3 4
   ((void *)0)
# 221 "CHOLMOD/Cholesky/cholmod_rowcolcounts.c"
   ) { return (0) ; } if (Common->itype != 2 || Common->dtype != 0) { Common->status = (-4) ; return (0) ; } } ;
    { if ((A) == 
# 222 "CHOLMOD/Cholesky/cholmod_rowcolcounts.c" 3 4
   ((void *)0)
# 222 "CHOLMOD/Cholesky/cholmod_rowcolcounts.c"
   ) { if (Common->status != (-2)) { cholmod_l_error ((-4), "CHOLMOD/Cholesky/cholmod_rowcolcounts.c", 222, "argument missing", Common) ; } return (0) ; } } ;
    { if ((Parent) == 
# 223 "CHOLMOD/Cholesky/cholmod_rowcolcounts.c" 3 4
   ((void *)0)
# 223 "CHOLMOD/Cholesky/cholmod_rowcolcounts.c"
   ) { if (Common->status != (-2)) { cholmod_l_error ((-4), "CHOLMOD/Cholesky/cholmod_rowcolcounts.c", 223, "argument missing", Common) ; } return (0) ; } } ;
    { if ((Post) == 
# 224 "CHOLMOD/Cholesky/cholmod_rowcolcounts.c" 3 4
   ((void *)0)
# 224 "CHOLMOD/Cholesky/cholmod_rowcolcounts.c"
   ) { if (Common->status != (-2)) { cholmod_l_error ((-4), "CHOLMOD/Cholesky/cholmod_rowcolcounts.c", 224, "argument missing", Common) ; } return (0) ; } } ;
    { if ((ColCount) == 
# 225 "CHOLMOD/Cholesky/cholmod_rowcolcounts.c" 3 4
   ((void *)0)
# 225 "CHOLMOD/Cholesky/cholmod_rowcolcounts.c"
   ) { if (Common->status != (-2)) { cholmod_l_error ((-4), "CHOLMOD/Cholesky/cholmod_rowcolcounts.c", 225, "argument missing", Common) ; } return (0) ; } } ;
    { if ((First) == 
# 226 "CHOLMOD/Cholesky/cholmod_rowcolcounts.c" 3 4
   ((void *)0)
# 226 "CHOLMOD/Cholesky/cholmod_rowcolcounts.c"
   ) { if (Common->status != (-2)) { cholmod_l_error ((-4), "CHOLMOD/Cholesky/cholmod_rowcolcounts.c", 226, "argument missing", Common) ; } return (0) ; } } ;
    { if ((Level) == 
# 227 "CHOLMOD/Cholesky/cholmod_rowcolcounts.c" 3 4
   ((void *)0)
# 227 "CHOLMOD/Cholesky/cholmod_rowcolcounts.c"
   ) { if (Common->status != (-2)) { cholmod_l_error ((-4), "CHOLMOD/Cholesky/cholmod_rowcolcounts.c", 227, "argument missing", Common) ; } return (0) ; } } ;
    { if ((A)->xtype < (0) || (A)->xtype > (3) || ((A)->xtype != 0 && ((A)->x) == 
# 228 "CHOLMOD/Cholesky/cholmod_rowcolcounts.c" 3 4
   ((void *)0)
# 228 "CHOLMOD/Cholesky/cholmod_rowcolcounts.c"
   ) || ((A)->xtype == 3 && ((A)->z) == 
# 228 "CHOLMOD/Cholesky/cholmod_rowcolcounts.c" 3 4
   ((void *)0)
# 228 "CHOLMOD/Cholesky/cholmod_rowcolcounts.c"
   )) { if (Common->status != (-2)) { cholmod_l_error ((-4), "CHOLMOD/Cholesky/cholmod_rowcolcounts.c", 228, "invalid xtype", Common) ; } return (0) ; } } ;
    stype = A->stype ;
    if (stype > 0)
    {

 cholmod_l_error ((-4), "CHOLMOD/Cholesky/cholmod_rowcolcounts.c", 233, "symmetric upper not supported", Common) ;
 return (0) ;
    }
    Common->status = 0 ;
    ...
    w = cholmod_l_mult_size_t (nrow, 2, &ok) ;
    w = cholmod_l_add_size_t (w, (stype ? 0 : ncol), &ok) ;
    if (!ok)
    {
 cholmod_l_error ((-3), "CHOLMOD/Cholesky/cholmod_rowcolcounts.c", 250, "problem too large", Common) ;
 return (0) ;
    }

    cholmod_l_allocate_work (nrow, w, 0, Common) ;
    if (Common->status < 0)
    {
 return (0) ;
    }
    ...
    SetParent = Iwork ;
    PrevNbr = Iwork + nrow ;
    Anext = Iwork + 2*((size_t) nrow) ;
    PrevLeaf = Common->Flag ;
    Head = Common->Head ;
# 291 "CHOLMOD/Cholesky/cholmod_rowcolcounts.c"
    for (i = 0 ; i < nrow ; i++)
    {
 First [i] = (-1) ;
    }
 ...
 use_fset = (fset != 
# 345 "CHOLMOD/Cholesky/cholmod_rowcolcounts.c" 3 4
                    ((void *)0)
# 345 "CHOLMOD/Cholesky/cholmod_rowcolcounts.c"
                        ) ;
 if (use_fset)
 {
     nf = fsize ;
  ...
  if (j < 0 || j > ncol || Anext [j] != -2)
  {
      ...
      cholmod_l_error ((-4), "CHOLMOD/Cholesky/cholmod_rowcolcounts.c", 362, "fset invalid", Common) ;
      return (0) ;
  }
 ...
 for (jj = 0 ; jj < nf ; jj++)
 {
  ...
  Head [k] = j ;
    ...
    if (RowCount != 
# 406 "CHOLMOD/Cholesky/cholmod_rowcolcounts.c" 3 4
                   ((void *)0)
# 406 "CHOLMOD/Cholesky/cholmod_rowcolcounts.c"
                       )
    {
 for (i = 0 ; i < nrow ; i++)
 {
