# 1 "UMFPACK/Source/umf_kernel.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "UMFPACK/Source/umf_kernel.c"
# 19 "UMFPACK/Source/umf_kernel.c"
...
# 20 "UMFPACK/Source/umf_kernel.c" 2
...
# 21 "UMFPACK/Source/umf_kernel.c" 2
# 1 "UMFPACK/Source/umf_kernel_init.h" 1
...
# 22 "UMFPACK/Source/umf_kernel.c" 2
# 1 "UMFPACK/Source/umf_init_front.h" 1





 long umfzl_init_front
(
    NumericType *Numeric,
    WorkType *Work
) ;
# 23 "UMFPACK/Source/umf_kernel.c" 2
# 1 "UMFPACK/Source/umf_start_front.h" 1





 long umfzl_start_front
(
    long chain,
    NumericType *Numeric,
    WorkType *Work,
...
# 24 "UMFPACK/Source/umf_kernel.c" 2
# 1 "UMFPACK/Source/umf_assemble.h" 1
...
# 25 "UMFPACK/Source/umf_kernel.c" 2
# 1 "UMFPACK/Source/umf_scale_column.h" 1





 void umfzl_scale_column
(
    NumericType *Numeric,
    WorkType *Work
) ;
# 26 "UMFPACK/Source/umf_kernel.c" 2
...
# 27 "UMFPACK/Source/umf_kernel.c" 2
# 1 "UMFPACK/Source/umf_create_element.h" 1





 long umfzl_create_element
(
    NumericType *Numeric,
    WorkType *Work,
    SymbolicType *Symbolic
) ;
# 28 "UMFPACK/Source/umf_kernel.c" 2
# 1 "UMFPACK/Source/umf_extend_front.h" 1





 long umfzl_extend_front
(
    NumericType *Numeric,
    WorkType *Work
) ;
# 29 "UMFPACK/Source/umf_kernel.c" 2
...
# 30 "UMFPACK/Source/umf_kernel.c" 2
# 1 "UMFPACK/Source/umf_store_lu.h" 1
...
# 31 "UMFPACK/Source/umf_kernel.c" 2
# 1 "UMFPACK/Source/umf_kernel_wrapup.h" 1





 void umfzl_kernel_wrapup
(
    NumericType *Numeric,
    SymbolicType *Symbolic,
    WorkType *Work
) ;
# 32 "UMFPACK/Source/umf_kernel.c" 2
...
# 105 "UMFPACK/Source/umf_kernel.c"
 ...
 { if (! (umfzl_start_front (chain, Numeric, Work, Symbolic))) { return ((-1)) ; }} ;
 ...
 for (Work->frontid = f1 ; Work->frontid <= f2 ; Work->frontid++)
 {
     ...
     jmax = (((128) < (Work->ncand)) ? (128) : (Work->ncand)) ;
  ...
  if (Work->do_update)
  {
      umfzl_blas3_update (Work) ;
      if (drop)
      {
   { if (! (umfzl_store_lu_drop (Numeric, Work))) { return ((-1)) ; }} ;
      }
      else
      {
   { if (! (umfzl_store_lu (Numeric, Work))) { return ((-1)) ; }} ;
      }
  }
  ...
  if (Work->do_extend)
  {
      ...
      { if (! (umfzl_extend_front (Numeric, Work))) { return ((-1)) ; }} ;
  }
  else
  {

      { if (! (umfzl_create_element (Numeric, Work, Symbolic))) { return ((-1)) ; }} ;
      { if (! (umfzl_init_front (Numeric, Work))) { return ((-1)) ; }} ;
  }
  ...
  if (evaporate)
  {
      ...
      (void) umfzl_create_element (Numeric, Work, Symbolic) ;
      Work->fnrows = 0 ;
      Work->fncols = 0 ;
  }
     }
 }
# 270 "UMFPACK/Source/umf_kernel.c"
 umfzl_blas3_update (Work) ;
 if (drop)
 {
     { if (! (umfzl_store_lu_drop (Numeric, Work))) { return ((-1)) ; }} ;
