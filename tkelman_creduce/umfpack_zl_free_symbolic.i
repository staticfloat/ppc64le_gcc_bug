# 1 "UMFPACK/Source/umfpack_free_symbolic.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "UMFPACK/Source/umfpack_free_symbolic.c"
# 15 "UMFPACK/Source/umfpack_free_symbolic.c"
...
# 16 "UMFPACK/Source/umfpack_free_symbolic.c" 2
...
# 17 "UMFPACK/Source/umfpack_free_symbolic.c" 2
...
)
{
 ...
 return ;
    ...
    (void) umf_l_free ((void *) Symbolic->Cperm_init) ;
    (void) umf_l_free ((void *) Symbolic->Rperm_init) ;
    (void) umf_l_free ((void *) Symbolic->Front_npivcol) ;
    (void) umf_l_free ((void *) Symbolic->Front_parent) ;
    (void) umf_l_free ((void *) Symbolic->Front_1strow) ;
    (void) umf_l_free ((void *) Symbolic->Front_leftmostdesc) ;
    (void) umf_l_free ((void *) Symbolic->Chain_start) ;
    (void) umf_l_free ((void *) Symbolic->Chain_maxrows) ;
    (void) umf_l_free ((void *) Symbolic->Chain_maxcols) ;
    (void) umf_l_free ((void *) Symbolic->Cdeg) ;
    (void) umf_l_free ((void *) Symbolic->Rdeg) ;


    (void) umf_l_free ((void *) Symbolic->Esize) ;


    (void) umf_l_free ((void *) Symbolic->Diagonal_map) ;

    (void) umf_l_free ((void *) Symbolic) ;
    *SymbolicHandle = (void *) 
# 54 "UMFPACK/Source/umfpack_free_symbolic.c" 3 4
                              ((void *)0) 
# 54 "UMFPACK/Source/umfpack_free_symbolic.c"
                                   ;
}
