# 1 "UMFPACK/Source/umf_blas3_update.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "UMFPACK/Source/umf_blas3_update.c"
# 10 "UMFPACK/Source/umf_blas3_update.c"
...
# 11 "UMFPACK/Source/umf_blas3_update.c" 2
# 1 "UMFPACK/Source/umf_blas3_update.h" 1





 void umfzl_blas3_update
(
    WorkType *Work
) ;
# 12 "UMFPACK/Source/umf_blas3_update.c" 2
...
)
{
 ...
 return ;
    ...
    U = Work->Fublock ;
    LU = Work->Flublock ;
# 62 "UMFPACK/Source/umf_blas3_update.c"
    if (k == 1)
    {


 { double alpha [2] = {-1,0} ; { int M = m, N = n, LDA = d, INCX = 1, INCY = 1 ; if ((sizeof (int) < sizeof (long)) && !((((int) M) == ((long) m)) && (((int) N) == ((long) n)) && (((int) LDA) == ((long) d)) && (((int) INCX) == ((long) 1)) && (((int) INCY) == ((long) 1)))) { blas_ok = (0) ; } if (!(sizeof (int) < sizeof (long)) || blas_ok) { zgeru_ (&M, &N, alpha, (double *) L, &INCX, (double *) U, &INCY, (double *) C, &LDA) ; } } ; } ;
 ...
 if (!blas_ok)
 {
     ...
     for (j = 0 ; j < n ; j++)
     {
  DoubleComplex u_j = U [j] ;
  if (((((u_j).component [0]) != 0.) || (((u_j).component [1]) != 0.)))
  {
...
#pragma ivdep
   ...
   { ; (*c_ij).component [0] -= (*l_is).component [0] * (u_j).component [0] - (*l_is).component [1] * (u_j).component [1] ; (*c_ij).component [1] -= (*l_is).component [1] * (u_j).component [0] + (*l_is).component [0] * (u_j).component [1] ; } ;
   c_ij++ ;
   l_is++ ;
      }
  }
 ...
 { double alpha [2] = {1,0} ; { int M = n, N = k, LDA = nb, LDB = dc ; if ((sizeof (int) < sizeof (long)) && !((((int) M) == ((long) n)) && (((int) N) == ((long) k)) && (((int) LDA) == ((long) nb)) && (((int) LDB) == ((long) dc)))) { blas_ok = (0) ; } if (!(sizeof (int) < sizeof (long)) || blas_ok) { ztrsm_ ("R", "L", "T", "U", &M, &N, alpha, (double *) LU, &LDA, (double *) U, &LDB); } } ; } ;
 ...
 if (!blas_ok)
 {
  ...
  for (i = s+1 ; i < k ; i++)
  {
      DoubleComplex l_is = LU [i+s*nb] ;
      if (((((l_is).component [0]) != 0.) || (((l_is).component [1]) != 0.)))
      {
...
#pragma ivdep
   for (j = 0 ; j < n ; j++)
   {
       ...
       { ; (*u_ij).component [0] -= (l_is).component [0] * (*u_sj).component [0] - (l_is).component [1] * (*u_sj).component [1] ; (*u_ij).component [1] -= (l_is).component [1] * (*u_sj).component [0] + (l_is).component [0] * (*u_sj).component [1] ; } ;
       u_ij++ ;
       u_sj++ ;
   }
      }
 ...
 { double alpha [2] = {-1,0}, beta [2] = {1,0} ; { int M = m, N = n, K = k, LDA = d, LDB = dc, LDC = d ; if ((sizeof (int) < sizeof (long)) && !((((int) M) == ((long) m)) && (((int) N) == ((long) n)) && (((int) K) == ((long) k)) && (((int) LDA) == ((long) d)) && (((int) LDB) == ((long) dc)) && (((int) LDC) == ((long) d)))) { blas_ok = (0) ; } if (!(sizeof (int) < sizeof (long)) || blas_ok) { zgemm_ ("N", "T", &M, &N, &K, alpha, (double *) L, &LDA, (double *) U, &LDB, beta, (double *) C, &LDC) ; } } ; } ;
 ...
 if (!blas_ok)
 {
  ...
  for (j = 0 ; j < n ; j++)
  {
      DoubleComplex u_sj = U [j+s*dc] ;
      if (((((u_sj).component [0]) != 0.) || (((u_sj).component [1]) != 0.)))
      {
   DoubleComplex *c_ij, *l_is ;
   c_ij = & C [j*d] ;
   l_is = & L [s*d] ;
#pragma ivdep
   for (i = 0 ; i < m ; i++)
   {
       ...
       { ; (*c_ij).component [0] -= (*l_is).component [0] * (u_sj).component [0] - (*l_is).component [1] * (u_sj).component [1] ; (*c_ij).component [1] -= (*l_is).component [1] * (u_sj).component [0] + (*l_is).component [0] * (u_sj).component [1] ; } ;
       c_ij++ ;
       l_is++ ;
   }
      }
...
# 174 "UMFPACK/Source/umf_blas3_update.c"
    ;
}
