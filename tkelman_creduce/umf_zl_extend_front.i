# 1 "UMFPACK/Source/umf_extend_front.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "UMFPACK/Source/umf_extend_front.c"
# 12 "UMFPACK/Source/umf_extend_front.c"
...
# 13 "UMFPACK/Source/umf_extend_front.c" 2
...
# 14 "UMFPACK/Source/umf_extend_front.c" 2
...
# 15 "UMFPACK/Source/umf_extend_front.c" 2





static void zero_front (
    DoubleComplex *Flblock, DoubleComplex *Fublock, DoubleComplex *Fcblock,
    long fnrows, long fncols, long fnr_curr, long fnc_curr,
    long fnpiv, long fnrows_extended, long fncols_extended)
{
    long j, i ;
    DoubleComplex *F, *Fj, *Fi ;
...
#pragma ivdep
 for (i = fnrows ; i < fnrows_extended ; i++)
 {
     ...
     { F->component [0] = 0. ; F->component [1] = 0. ; F++ ; } ;
 }
    }
...
)
{
 ...
 fnrows, fncols, pos, fnpiv, *Wm ;
    ...
    fnpiv = Work->fnpiv ;
# 127 "UMFPACK/Source/umf_extend_front.c"
    if (Work->do_grow)
    {
 fnr2 = (1.2) * Work->fnrows_new + 2 ;
 fnc2 = (1.2) * Work->fncols_new + 2 ;
...
# 185 "UMFPACK/Source/umf_extend_front.c"
 ...
 {
     Fl [i] = Wy [i] ;
# 209 "UMFPACK/Source/umf_extend_front.c"
 }
 ...
 for (i = 0 ; i < ccdeg ; i++)
 {
  ...
  Frpos [row] = pos ;
    ...
    ;
# 266 "UMFPACK/Source/umf_extend_front.c"
...
# 376 "UMFPACK/Source/umf_extend_front.c"
