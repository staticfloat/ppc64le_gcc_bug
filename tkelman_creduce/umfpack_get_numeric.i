# 1 "umfpack_get_numeric.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "umfpack_get_numeric.c"
# 25 "umfpack_get_numeric.c"
# 1 "umf_internal.h" 1
# 25 "umf_internal.h"
...
)
{
    ...
    NumericType *Numeric ;
    long getL, getU, *Rperm, *Cperm, k, nn, n_row, n_col, *Wi, *Pattern,
 n_inner ;
    double *Rs1 ;
    DoubleComplex *D ;
    ...
    Wi = (long *) 
# 104 "umfpack_get_numeric.c" 3 4
                ((void *)0) 
# 104 "umfpack_get_numeric.c"
                     ;
    Pattern = (long *) 
# 105 "umfpack_get_numeric.c" 3 4
                     ((void *)0) 
# 105 "umfpack_get_numeric.c"
                          ;
 ...
 return ((-3)) ;
    ...
    if (getL || getU)
    {
 Wi = (long *) umf_l_malloc (nn, sizeof (long)) ;
 Pattern = (long *) umf_l_malloc (nn, sizeof (long)) ;
 if (!Wi || !Pattern)
 {
     (void) umf_l_free ((void *) Wi) ;
     (void) umf_l_free ((void *) Pattern) ;
     ;
     ;
     return ((-1)) ;
 }
 ;
    ...
    if (P != (long *) 
# 148 "umfpack_get_numeric.c" 3 4
                    ((void *)0)
# 148 "umfpack_get_numeric.c"
                        )
    {
 Rperm = Numeric->Rperm ;
 for (k = 0 ; k < n_row ; k++)
 {
    ...
    if (Q != (long *) 
# 157 "umfpack_get_numeric.c" 3 4
                    ((void *)0)
# 157 "umfpack_get_numeric.c"
                        )
    {
 Cperm = Numeric->Cperm ;
 for (k = 0 ; k < n_col ; k++)
 ...
 get_U (Up, Ui, Ux,
    ...
    if (Dx != (double *) 
# 184 "umfpack_get_numeric.c" 3 4
                        ((void *)0)
# 184 "umfpack_get_numeric.c"
                            )
    {
 D = Numeric->D ;

 if (((Dz) != (double *) 
# 188 "umfpack_get_numeric.c" 3 4
    ((void *)0)
# 188 "umfpack_get_numeric.c"
    ))
 {
     for (k = 0 ; k < n_inner ; k++)
     {
 ...
 else
 {
     for (k = 0 ; k < n_inner ; k++)
     {
         Dx [2*k ] = ((D [k]).component [0]) ;
         Dx [2*k+1] = ((D [k]).component [1]) ;
     }
 }
# 213 "umfpack_get_numeric.c"
    }
    ...
    if (p_do_recip != (long *) 
# 220 "umfpack_get_numeric.c" 3 4
                             ((void *)0)
# 220 "umfpack_get_numeric.c"
                                 )
    {
 ...
 *p_do_recip = Numeric->do_recip ;
    ...
    if (Rs != (double *) 
# 229 "umfpack_get_numeric.c" 3 4
                        ((void *)0)
# 229 "umfpack_get_numeric.c"
                            )
    {
 Rs1 = Numeric->Rs ;
 if (Rs1 == (double *) 
# 232 "umfpack_get_numeric.c" 3 4
                      ((void *)0)
# 232 "umfpack_get_numeric.c"
                          )
 {
...
)
{
    ...
    long split = ((Lz) != (double *) 
# 344 "umfpack_get_numeric.c" 3 4
               ((void *)0)
# 344 "umfpack_get_numeric.c"
               ) ;
 ...
 if (deg > 0)
 {
  ...
  if (((((value).component [0]) != 0.) || (((value).component [1]) != 0.)))
  {
   ...
   Lz [p] = ((value).component [1]) ;
      ...
      {
   Lx [2*p ] = ((value).component [0]) ;
   Lx [2*p+1] = ((value).component [1]) ;
      }
...
# 623 "umfpack_get_numeric.c"
    ;
}
# 687 "umfpack_get_numeric.c"
static void get_U
(
    long Up [ ],
    long Ui [ ],
...
)
{
    ...
    long deg, j, *ip, col, *Upos, *Uilen, *Uip, n_col, ulen, *Usi,
        unz2, p, k, up, newUchain, pos, npiv, n1 ;

    long split = ((Uz) != (double *) 
# 709 "umfpack_get_numeric.c" 3 4
               ((void *)0)
# 709 "umfpack_get_numeric.c"
               ) ;
# 719 "umfpack_get_numeric.c"
    ;
    n_col = Numeric->n_col ;
    n1 = Numeric->n1 ;
    npiv = Numeric->npiv ;
 ...
 ;
 ;
 Wi [col] = ((((D [col]).component [0]) != 0.) || (((D [col]).component [1]) != 0.)) ;
 ;
 ...
 Wi [col] = Up [col+1] ;
    ...
    for (col = 0 ; col < npiv ; col++)
    {
 if (((((D [col]).component [0]) != 0.) || (((D [col]).component [1]) != 0.)))
 {
     p = --(Wi [col]) ;
     Ui [p] = col ;
  ...
  Uz [p] = ((D [col]).component [1]) ;
     ...
     {
  Ux [2*p ] = ((D [col]).component [0]) ;
  Ux [2*p+1] = ((D [col]).component [1]) ;
     }
 ...
 for (j = deg-1 ; j >= 0 ; j--)
 {
  ...
  {
      Ux [2*p ] = ((value).component [0]) ;
      Ux [2*p+1] = ((value).component [1]) ;
  }
