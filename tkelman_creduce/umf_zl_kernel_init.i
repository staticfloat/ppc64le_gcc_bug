# 1 "UMFPACK/Source/umf_kernel_init.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "UMFPACK/Source/umf_kernel_init.c"
# 21 "UMFPACK/Source/umf_kernel_init.c"
...
# 22 "UMFPACK/Source/umf_kernel_init.c" 2
...
# 23 "UMFPACK/Source/umf_kernel_init.c" 2
# 1 "UMFPACK/Source/umf_tuple_lengths.h" 1
...
# 24 "UMFPACK/Source/umf_kernel_init.c" 2
# 1 "UMFPACK/Source/umf_build_tuples.h" 1
...
# 25 "UMFPACK/Source/umf_kernel_init.c" 2
# 1 "UMFPACK/Source/umf_mem_init_memoryspace.h" 1
...
# 26 "UMFPACK/Source/umf_kernel_init.c" 2
...
# 27 "UMFPACK/Source/umf_kernel_init.c" 2
# 1 "UMFPACK/Source/umf_mem_alloc_head_block.h" 1
...
# 28 "UMFPACK/Source/umf_kernel_init.c" 2
...
# 29 "UMFPACK/Source/umf_kernel_init.c" 2
...
# 30 "UMFPACK/Source/umf_kernel_init.c" 2
# 1 "UMFPACK/Source/umf_scale.h" 1
...
# 31 "UMFPACK/Source/umf_kernel_init.c" 2
...
)
{
 ...
 len_new++ ;
    ...
    ;
# 104 "UMFPACK/Source/umf_kernel_init.c"
    *p_p = pnew ;
    *p_len = len_new ;
...
# 131 "UMFPACK/Source/umf_kernel_init.c"
    return (pnew) ;
}
...
# 171 "UMFPACK/Source/umf_kernel_init.c" 3 4
               ((void *)0)
# 171 "UMFPACK/Source/umf_kernel_init.c"
               ) ;
...
# 306 "UMFPACK/Source/umf_kernel_init.c"
    Work->cdeg0 = 1 ;
    Work->rdeg0 = 1 ;
    ...
    drop = (droptol > 0) ;
# 354 "UMFPACK/Source/umf_kernel_init.c"
...
# 470 "UMFPACK/Source/umf_kernel_init.c"
    ;
 ...
 ;
 ;
# 497 "UMFPACK/Source/umf_kernel_init.c"
 for (k = 0 ; k < nn ; k++)
 {
...
# 511 "UMFPACK/Source/umf_kernel_init.c"
    }
...
# 591 "UMFPACK/Source/umf_kernel_init.c" 3 4
                              ((void *)0) 
# 591 "UMFPACK/Source/umf_kernel_init.c"
                                   ;
    Work->Flblock = (DoubleComplex *) 
# 592 "UMFPACK/Source/umf_kernel_init.c" 3 4
                              ((void *)0) 
# 592 "UMFPACK/Source/umf_kernel_init.c"
                                   ;
    Work->Fublock = (DoubleComplex *) 
# 593 "UMFPACK/Source/umf_kernel_init.c" 3 4
                              ((void *)0) 
# 593 "UMFPACK/Source/umf_kernel_init.c"
                                   ;
    Work->Fcblock = (DoubleComplex *) 
# 594 "UMFPACK/Source/umf_kernel_init.c" 3 4
                              ((void *)0) 
# 594 "UMFPACK/Source/umf_kernel_init.c"
                                   ;
  ...
  *(Rpx [newrow]++) = x ;
  ...
  C [clen] = x ;
  clen++ ;
# 862 "UMFPACK/Source/umf_kernel_init.c"
     }
 }
...
# 979 "UMFPACK/Source/umf_kernel_init.c"
    Col_degree [n_col] = 0 ;
...
# 1064 "UMFPACK/Source/umf_kernel_init.c"
    return ((1)) ;
}
