# 1 "UMFPACK/Source/umf_symbolic_usage.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "UMFPACK/Source/umf_symbolic_usage.c"
# 12 "UMFPACK/Source/umf_symbolic_usage.c"
...
# 13 "UMFPACK/Source/umf_symbolic_usage.c" 2
...
# 14 "UMFPACK/Source/umf_symbolic_usage.c" 2
...
)
{
    ...
    units =
 (ceil ((sizeof (SymbolicType) * ((double) 1)) / sizeof (Unit)))
 + 2 * (ceil ((sizeof (long) * ((double) n_col+1)) / sizeof (Unit)))
 + 2 * (ceil ((sizeof (long) * ((double) n_row+1)) / sizeof (Unit)))
 + 3 * (ceil ((sizeof (long) * ((double) nchains+1)) / sizeof (Unit)))
 + 4 * (ceil ((sizeof (long) * ((double) nfr+1)) / sizeof (Unit))) ;


    units += (ceil ((sizeof (long) * ((double) esize)) / sizeof (Unit))) ;


    if (prefer_diagonal)
    {
 units += (ceil ((sizeof (long) * ((double) n_col+1)) / sizeof (Unit))) ;
    }
