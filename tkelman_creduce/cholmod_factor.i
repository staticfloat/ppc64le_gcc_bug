# 1 "CHOLMOD/Core/cholmod_factor.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "CHOLMOD/Core/cholmod_factor.c"
# 48 "CHOLMOD/Core/cholmod_factor.c"
...
# 49 "CHOLMOD/Core/cholmod_factor.c" 2
...
# 50 "CHOLMOD/Core/cholmod_factor.c" 2
# 72 "CHOLMOD/Core/cholmod_factor.c"
cholmod_factor *cholmod_l_allocate_factor
(
...
)
{
    ...
    { if (Common == 
# 85 "CHOLMOD/Core/cholmod_factor.c" 3 4
   ((void *)0)
# 85 "CHOLMOD/Core/cholmod_factor.c"
   ) { return (0) ; } if (Common->itype != 2 || Common->dtype != 0) { Common->status = (-4) ; return (0) ; } } ;
    Common->status = 0 ;


    (void) cholmod_l_add_size_t (n, 2, &ok) ;
    if (!ok || n > 0x7fffffffffffffffL)
    {
 cholmod_l_error ((-3), "CHOLMOD/Core/cholmod_factor.c", 92, "problem too large", Common) ;
 return (
# 93 "CHOLMOD/Core/cholmod_factor.c" 3 4
        ((void *)0)
# 93 "CHOLMOD/Core/cholmod_factor.c"
            ) ;
    }

    L = cholmod_l_malloc (sizeof (cholmod_factor), 1, Common) ;
    if (Common->status < 0)
    {
 return (
# 99 "CHOLMOD/Core/cholmod_factor.c" 3 4
        ((void *)0)
# 99 "CHOLMOD/Core/cholmod_factor.c"
            ) ;
    }
    L->n = n ;
    L->is_ll = 0 ;
    ...
    L->ordering = 0 ;
    L->Perm = cholmod_l_malloc (n, sizeof (long), Common) ;
    L->IPerm = 
# 112 "CHOLMOD/Core/cholmod_factor.c" 3 4
              ((void *)0) 
# 112 "CHOLMOD/Core/cholmod_factor.c"
                   ;
    L->ColCount = cholmod_l_malloc (n, sizeof (long), Common) ;


    L->nzmax = 0 ;
    L->p = 
# 117 "CHOLMOD/Core/cholmod_factor.c" 3 4
          ((void *)0) 
# 117 "CHOLMOD/Core/cholmod_factor.c"
               ;
    L->i = 
# 118 "CHOLMOD/Core/cholmod_factor.c" 3 4
          ((void *)0) 
# 118 "CHOLMOD/Core/cholmod_factor.c"
               ;
    L->x = 
# 119 "CHOLMOD/Core/cholmod_factor.c" 3 4
          ((void *)0) 
# 119 "CHOLMOD/Core/cholmod_factor.c"
               ;
    L->z = 
# 120 "CHOLMOD/Core/cholmod_factor.c" 3 4
          ((void *)0) 
# 120 "CHOLMOD/Core/cholmod_factor.c"
               ;
    L->nz = 
# 121 "CHOLMOD/Core/cholmod_factor.c" 3 4
           ((void *)0) 
# 121 "CHOLMOD/Core/cholmod_factor.c"
                ;
    L->next = 
# 122 "CHOLMOD/Core/cholmod_factor.c" 3 4
             ((void *)0) 
# 122 "CHOLMOD/Core/cholmod_factor.c"
                  ;
    L->prev = 
# 123 "CHOLMOD/Core/cholmod_factor.c" 3 4
             ((void *)0) 
# 123 "CHOLMOD/Core/cholmod_factor.c"
                  ;
    ...
    L->maxcsize = 0 ;
    L->super = 
# 131 "CHOLMOD/Core/cholmod_factor.c" 3 4
              ((void *)0) 
# 131 "CHOLMOD/Core/cholmod_factor.c"
                   ;
    L->pi = 
# 132 "CHOLMOD/Core/cholmod_factor.c" 3 4
           ((void *)0) 
# 132 "CHOLMOD/Core/cholmod_factor.c"
                ;
    L->px = 
# 133 "CHOLMOD/Core/cholmod_factor.c" 3 4
           ((void *)0) 
# 133 "CHOLMOD/Core/cholmod_factor.c"
                ;
    L->s = 
# 134 "CHOLMOD/Core/cholmod_factor.c" 3 4
          ((void *)0) 
# 134 "CHOLMOD/Core/cholmod_factor.c"
               ;
    L->useGPU = 0;
 ...
 return (
# 143 "CHOLMOD/Core/cholmod_factor.c" 3 4
        ((void *)0)
# 143 "CHOLMOD/Core/cholmod_factor.c"
            ) ;
    }
...
# 171 "CHOLMOD/Core/cholmod_factor.c"
...
)
{
    ...
    { if (Common == 
# 182 "CHOLMOD/Core/cholmod_factor.c" 3 4
   ((void *)0)
# 182 "CHOLMOD/Core/cholmod_factor.c"
   ) { return (0) ; } if (Common->itype != 2 || Common->dtype != 0) { Common->status = (-4) ; return (0) ; } } ;

    if (LHandle == 
# 184 "CHOLMOD/Core/cholmod_factor.c" 3 4
                  ((void *)0)
# 184 "CHOLMOD/Core/cholmod_factor.c"
                      )
    {
 ...
 return (1) ;
    ...
    L = *LHandle ;
    if (L == 
# 190 "CHOLMOD/Core/cholmod_factor.c" 3 4
            ((void *)0)
# 190 "CHOLMOD/Core/cholmod_factor.c"
                )
    {
 ...
 return (1) ;
    ...
    lnz = L->nzmax ;
    s = L->nsuper + 1 ;
    xs = (L->is_super) ? ((long) (L->xsize)) : (lnz) ;
    ss = L->ssize ;


    cholmod_l_free (n, sizeof (long), L->Perm, Common) ;
    cholmod_l_free (n, sizeof (long), L->IPerm, Common) ;
    cholmod_l_free (n, sizeof (long), L->ColCount, Common) ;


    cholmod_l_free (n+1, sizeof (long), L->p, Common) ;
    cholmod_l_free (lnz, sizeof (long), L->i, Common) ;
    cholmod_l_free (n, sizeof (long), L->nz, Common) ;
    cholmod_l_free (n+2, sizeof (long), L->next, Common) ;
    cholmod_l_free (n+2, sizeof (long), L->prev, Common) ;


    cholmod_l_free (s, sizeof (long), L->pi, Common) ;
    cholmod_l_free (s, sizeof (long), L->px, Common) ;
    cholmod_l_free (s, sizeof (long), L->super, Common) ;
    cholmod_l_free (ss, sizeof (long), L->s, Common) ;


    if (L->xtype == 1)
    {
 cholmod_l_free (xs, sizeof (double), L->x, Common) ;
    }
    else if (L->xtype == 2)
    {
 cholmod_l_free (xs, 2*sizeof (double), L->x, Common) ;
    }
    else if (L->xtype == 3)
    {
 cholmod_l_free (xs, sizeof (double), L->x, Common) ;
 cholmod_l_free (xs, sizeof (double), L->z, Common) ;
    }

    *LHandle = cholmod_l_free (1, sizeof (cholmod_factor), (*LHandle), Common) ;
    return (1) ;
}
# 250 "CHOLMOD/Core/cholmod_factor.c"
int cholmod_l_reallocate_factor
(
...
)
{
    ...
    { if (Common == 
# 264 "CHOLMOD/Core/cholmod_factor.c" 3 4
   ((void *)0)
# 264 "CHOLMOD/Core/cholmod_factor.c"
   ) { return (0) ; } if (Common->itype != 2 || Common->dtype != 0) { Common->status = (-4) ; return (0) ; } } ;
    { if ((L) == 
# 265 "CHOLMOD/Core/cholmod_factor.c" 3 4
   ((void *)0)
# 265 "CHOLMOD/Core/cholmod_factor.c"
   ) { if (Common->status != (-2)) { cholmod_l_error ((-4), "CHOLMOD/Core/cholmod_factor.c", 265, "argument missing", Common) ; } return (0) ; } } ;
    { if ((L)->xtype < (1) || (L)->xtype > (3) || ((L)->xtype != 0 && ((L)->x) == 
# 266 "CHOLMOD/Core/cholmod_factor.c" 3 4
   ((void *)0)
# 266 "CHOLMOD/Core/cholmod_factor.c"
   ) || ((L)->xtype == 3 && ((L)->z) == 
# 266 "CHOLMOD/Core/cholmod_factor.c" 3 4
   ((void *)0)
# 266 "CHOLMOD/Core/cholmod_factor.c"
   )) { if (Common->status != (-2)) { cholmod_l_error ((-4), "CHOLMOD/Core/cholmod_factor.c", 266, "invalid xtype", Common) ; } return (0) ; } } ;
    ;
    if (L->is_super)
    {

 cholmod_l_error ((-4), "CHOLMOD/Core/cholmod_factor.c", 271, "L invalid", Common) ;
 return (0) ;
    }
    Common->status = 0 ;
    ;
    ...
    cholmod_l_realloc_multiple (nznew, 1, L->xtype, &(L->i), 
# 281 "CHOLMOD/Core/cholmod_factor.c" 3 4
                                                           ((void *)0)
# 281 "CHOLMOD/Core/cholmod_factor.c"
                                                               ,
     &(L->x), &(L->z), &(L->nzmax), Common) ;
    return (Common->status == 0) ;
}
# 298 "CHOLMOD/Core/cholmod_factor.c"
int cholmod_l_reallocate_column
(
...
)
{
    double xneed ;
    double *Lx, *Lz ;
    long *Lp, *Lprev, *Lnext, *Li, *Lnz ;
    long n, pold, pnew, len, k, tail ;
    ...
    { if (Common == 
# 318 "CHOLMOD/Core/cholmod_factor.c" 3 4
   ((void *)0)
# 318 "CHOLMOD/Core/cholmod_factor.c"
   ) { return (0) ; } if (Common->itype != 2 || Common->dtype != 0) { Common->status = (-4) ; return (0) ; } } ;
    { if ((L) == 
# 319 "CHOLMOD/Core/cholmod_factor.c" 3 4
   ((void *)0)
# 319 "CHOLMOD/Core/cholmod_factor.c"
   ) { if (Common->status != (-2)) { cholmod_l_error ((-4), "CHOLMOD/Core/cholmod_factor.c", 319, "argument missing", Common) ; } return (0) ; } } ;
    { if ((L)->xtype < (1) || (L)->xtype > (3) || ((L)->xtype != 0 && ((L)->x) == 
# 320 "CHOLMOD/Core/cholmod_factor.c" 3 4
   ((void *)0)
# 320 "CHOLMOD/Core/cholmod_factor.c"
   ) || ((L)->xtype == 3 && ((L)->z) == 
# 320 "CHOLMOD/Core/cholmod_factor.c" 3 4
   ((void *)0)
# 320 "CHOLMOD/Core/cholmod_factor.c"
   )) { if (Common->status != (-2)) { cholmod_l_error ((-4), "CHOLMOD/Core/cholmod_factor.c", 320, "invalid xtype", Common) ; } return (0) ; } } ;
    if (L->is_super)
    {
 cholmod_l_error ((-4), "CHOLMOD/Core/cholmod_factor.c", 323, "L must be simplicial", Common) ;
 return (0) ;
    }
    n = L->n ;
    if (j >= L->n || need == 0)
    {
 cholmod_l_error ((-4), "CHOLMOD/Core/cholmod_factor.c", 329, "j invalid", Common) ;
 return (0) ;
    }
    Common->status = 0 ;
 ...
 if (xneed > ((size_t) (-1)) ||
  !cholmod_l_reallocate_factor ((long) xneed, L, Common))
 {

     cholmod_l_change_factor (0, L->is_ll, 0, 1,
      1, L, Common) ;
     cholmod_l_error ((-2), "CHOLMOD/Core/cholmod_factor.c", 394, "out of memory; L now symbolic", Common) ;
     return (0) ;
 }

                                          ;

 cholmod_l_pack_factor (L, Common) ;
 ;
...
# 491 "CHOLMOD/Core/cholmod_factor.c"
int cholmod_l_pack_factor
(
...
{
    double *Lx, *Lz ;
    long *Lp, *Li, *Lnz, *Lnext ;
    long pnew, j, k, pold, len, n, head, tail, grow2 ;
    ...
    { if (Common == 
# 507 "CHOLMOD/Core/cholmod_factor.c" 3 4
   ((void *)0)
# 507 "CHOLMOD/Core/cholmod_factor.c"
   ) { return (0) ; } if (Common->itype != 2 || Common->dtype != 0) { Common->status = (-4) ; return (0) ; } } ;
    { if ((L) == 
# 508 "CHOLMOD/Core/cholmod_factor.c" 3 4
   ((void *)0)
# 508 "CHOLMOD/Core/cholmod_factor.c"
   ) { if (Common->status != (-2)) { cholmod_l_error ((-4), "CHOLMOD/Core/cholmod_factor.c", 508, "argument missing", Common) ; } return (0) ; } } ;
    { if ((L)->xtype < (0) || (L)->xtype > (3) || ((L)->xtype != 0 && ((L)->x) == 
# 509 "CHOLMOD/Core/cholmod_factor.c" 3 4
   ((void *)0)
# 509 "CHOLMOD/Core/cholmod_factor.c"
   ) || ((L)->xtype == 3 && ((L)->z) == 
# 509 "CHOLMOD/Core/cholmod_factor.c" 3 4
   ((void *)0)
# 509 "CHOLMOD/Core/cholmod_factor.c"
   )) { if (Common->status != (-2)) { cholmod_l_error ((-4), "CHOLMOD/Core/cholmod_factor.c", 509, "invalid xtype", Common) ; } return (0) ; } } ;
    Common->status = 0 ;
    ;
    ;
 ...
 len = (((len + grow2) < (n - j)) ? (len + grow2) : (n - j)) ;
 pnew = (((Lp [j] + len) < (Lp [Lnext [j]])) ? (Lp [j] + len) : (Lp [Lnext [j]])) ;
    }
    ;
    return (1) ;
}
# 605 "CHOLMOD/Core/cholmod_factor.c"
cholmod_sparse *cholmod_l_factor_to_sparse
(
...
)
{
    ...
    { if (Common == 
# 619 "CHOLMOD/Core/cholmod_factor.c" 3 4
   ((void *)0)
# 619 "CHOLMOD/Core/cholmod_factor.c"
   ) { return (
# 619 "CHOLMOD/Core/cholmod_factor.c" 3 4
   ((void *)0)
# 619 "CHOLMOD/Core/cholmod_factor.c"
...
# 619 "CHOLMOD/Core/cholmod_factor.c"
    ...
    { if ((L) == 
# 620 "CHOLMOD/Core/cholmod_factor.c" 3 4
   ((void *)0)
# 620 "CHOLMOD/Core/cholmod_factor.c"
   ) { if (Common->status != (-2)) { cholmod_l_error ((-4), "CHOLMOD/Core/cholmod_factor.c", 620, "argument missing", Common) ; } return (
# 620 "CHOLMOD/Core/cholmod_factor.c" 3 4
   ((void *)0)
# 620 "CHOLMOD/Core/cholmod_factor.c"
   ) ; } } ;
    { if ((L)->xtype < (1) || (L)->xtype > (3) || ((L)->xtype != 0 && ((L)->x) == 
# 621 "CHOLMOD/Core/cholmod_factor.c" 3 4
   ((void *)0)
# 621 "CHOLMOD/Core/cholmod_factor.c"
   ) || ((L)->xtype == 3 && ((L)->z) == 
# 621 "CHOLMOD/Core/cholmod_factor.c" 3 4
   ((void *)0)
# 621 "CHOLMOD/Core/cholmod_factor.c"
   )) { if (Common->status != (-2)) { cholmod_l_error ((-4), "CHOLMOD/Core/cholmod_factor.c", 621, "invalid xtype", Common) ; } return (
# 621 "CHOLMOD/Core/cholmod_factor.c" 3 4
   ((void *)0)
# 621 "CHOLMOD/Core/cholmod_factor.c"
   ) ; } } ;
    ...
    if (!cholmod_l_change_factor (L->xtype, L->is_ll, 0, 1, 1, L,
  Common))
    {
 cholmod_l_error ((-4), "CHOLMOD/Core/cholmod_factor.c", 633, "cannot convert L", Common) ;
 return (
# 634 "CHOLMOD/Core/cholmod_factor.c" 3 4
        ((void *)0)
# 634 "CHOLMOD/Core/cholmod_factor.c"
            ) ;
    }
    ...
    Lsparse = cholmod_l_malloc (sizeof (cholmod_sparse), 1, Common) ;
    if (Common->status < 0)
    {
 return (
# 645 "CHOLMOD/Core/cholmod_factor.c" 3 4
        ((void *)0)
# 645 "CHOLMOD/Core/cholmod_factor.c"
            ) ;
    }
    ...
    Lsparse->z = L->z ;
    Lsparse->nz = 
# 655 "CHOLMOD/Core/cholmod_factor.c" 3 4
                 ((void *)0) 
# 655 "CHOLMOD/Core/cholmod_factor.c"
                      ;
    Lsparse->stype = 0 ;
    ...
    L->p = 
# 669 "CHOLMOD/Core/cholmod_factor.c" 3 4
          ((void *)0) 
# 669 "CHOLMOD/Core/cholmod_factor.c"
               ;
    L->i = 
# 670 "CHOLMOD/Core/cholmod_factor.c" 3 4
          ((void *)0) 
# 670 "CHOLMOD/Core/cholmod_factor.c"
               ;
    L->x = 
# 671 "CHOLMOD/Core/cholmod_factor.c" 3 4
          ((void *)0) 
# 671 "CHOLMOD/Core/cholmod_factor.c"
               ;
    L->z = 
# 672 "CHOLMOD/Core/cholmod_factor.c" 3 4
          ((void *)0) 
# 672 "CHOLMOD/Core/cholmod_factor.c"
               ;
    L->xtype = 0 ;
    cholmod_l_change_factor (0, 0, 0, 1, 1, L,
     Common) ;

    return (Lsparse) ;
}
# 694 "CHOLMOD/Core/cholmod_factor.c"
...
)
{
    ...
    long *Perm, *ColCount, *Lp, *Li, *Lnz, *Lnext, *Lprev, *Lsuper, *Lpi, *Lpx,
 *Ls, *Perm2, *ColCount2, *L2p, *L2i, *L2nz, *L2next, *L2prev, *L2super,
 *L2pi, *L2px, *L2s ;
    long n, j, p, pend, s, xsize, ssize, nsuper ;
    ...
    { if (Common == 
# 713 "CHOLMOD/Core/cholmod_factor.c" 3 4
   ((void *)0)
# 713 "CHOLMOD/Core/cholmod_factor.c"
   ) { return (
# 713 "CHOLMOD/Core/cholmod_factor.c" 3 4
   ((void *)0)
# 713 "CHOLMOD/Core/cholmod_factor.c"
...
# 713 "CHOLMOD/Core/cholmod_factor.c"
    ...
    { if ((L) == 
# 714 "CHOLMOD/Core/cholmod_factor.c" 3 4
   ((void *)0)
# 714 "CHOLMOD/Core/cholmod_factor.c"
   ) { if (Common->status != (-2)) { cholmod_l_error ((-4), "CHOLMOD/Core/cholmod_factor.c", 714, "argument missing", Common) ; } return (
# 714 "CHOLMOD/Core/cholmod_factor.c" 3 4
   ((void *)0)
# 714 "CHOLMOD/Core/cholmod_factor.c"
   ) ; } } ;
    { if ((L)->xtype < (0) || (L)->xtype > (3) || ((L)->xtype != 0 && ((L)->x) == 
# 715 "CHOLMOD/Core/cholmod_factor.c" 3 4
   ((void *)0)
# 715 "CHOLMOD/Core/cholmod_factor.c"
   ) || ((L)->xtype == 3 && ((L)->z) == 
# 715 "CHOLMOD/Core/cholmod_factor.c" 3 4
   ((void *)0)
# 715 "CHOLMOD/Core/cholmod_factor.c"
   )) { if (Common->status != (-2)) { cholmod_l_error ((-4), "CHOLMOD/Core/cholmod_factor.c", 715, "invalid xtype", Common) ; } return (
# 715 "CHOLMOD/Core/cholmod_factor.c" 3 4
   ((void *)0)
# 715 "CHOLMOD/Core/cholmod_factor.c"
   ) ; } } ;
    ...
    L2 = cholmod_l_allocate_factor (n, Common) ;
    if (Common->status < 0)
    {
 return (
# 729 "CHOLMOD/Core/cholmod_factor.c" 3 4
        ((void *)0)
# 729 "CHOLMOD/Core/cholmod_factor.c"
            ) ;
    }
    ;
 ...
 ColCount2 [j] = ColCount [j] ;
    ...
    if (L->xtype != 0 && !(L->super))
    {
# 763 "CHOLMOD/Core/cholmod_factor.c"
 L2->nzmax = L->nzmax ;
 if (!cholmod_l_change_factor (L->xtype, L->is_ll, 0, -1, 1,
      L2, Common))
 {
     cholmod_l_free_factor (&L2, Common) ;
     return (
# 768 "CHOLMOD/Core/cholmod_factor.c" 3 4
            ((void *)0)
# 768 "CHOLMOD/Core/cholmod_factor.c"
                ) ;
 }
 ;
 ...
 if (!cholmod_l_change_factor (L->xtype, 1, 1, 1, 1, L2,
      Common))
 {
     cholmod_l_free_factor (&L2, Common) ;
     return (
# 872 "CHOLMOD/Core/cholmod_factor.c" 3 4
            ((void *)0)
# 872 "CHOLMOD/Core/cholmod_factor.c"
                ) ;
 }
