# 1 "UMFPACK/Source/umf_scale_column.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "UMFPACK/Source/umf_scale_column.c"
# 15 "UMFPACK/Source/umf_scale_column.c"
...
# 16 "UMFPACK/Source/umf_scale_column.c" 2
...
# 17 "UMFPACK/Source/umf_scale_column.c" 2
...
# 18 "UMFPACK/Source/umf_scale_column.c" 2
...
# 19 "UMFPACK/Source/umf_scale_column.c" 2
# 30 "UMFPACK/Source/umf_scale_column.c"
static void shift_pivot_row (DoubleComplex *Fd, DoubleComplex *Fs, DoubleComplex *Fe, long len, long d)
{
    long j ;
#pragma ivdep
    for (j = 0 ; j < len ; j++)
...
)
{
    ...
    long k, k1, fnr_curr, fnrows, fncols, *Frpos, *Fcpos, pivrow, pivcol,
 *Frows, *Fcols, fnc_curr, fnpiv, *Row_tuples, nb,
 *Col_tuples, *Rperm, *Cperm, fspos, col2, row2 ;
# 68 "UMFPACK/Source/umf_scale_column.c"
    fnrows = Work->fnrows ;
    fncols = Work->fncols ;
    fnpiv = Work->fnpiv ;
    ...
    nb = Work->nb ;
# 135 "UMFPACK/Source/umf_scale_column.c"
    fspos = Fcpos [pivcol] ;
...
#pragma ivdep
 ...
 Fcpos [col2] = fspos ;
    ...
    Fcpos [pivcol] = (-1) ;
# 212 "UMFPACK/Source/umf_scale_column.c"
    fspos = Frpos [pivrow] ;
...
#pragma ivdep
     ...
     {
  ;
  { (Fd [j * nb]).component [0] = 0. ; (Fd [j * nb]).component [1] = 0. ; } ;
     }
...
#pragma ivdep
 ...
 Frpos [row2] = fspos ;
    ...
    Frpos [pivrow] = (-1) ;
# 373 "UMFPACK/Source/umf_scale_column.c"
    ...
    umfzl_mem_free_tail_block (Numeric, Row_tuples [pivrow]) ;
    umfzl_mem_free_tail_block (Numeric, Col_tuples [pivcol]) ;
...
# 426 "UMFPACK/Source/umf_scale_column.c"
    Work->fnpiv++ ;
