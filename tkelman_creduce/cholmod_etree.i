# 1 "CHOLMOD/Cholesky/cholmod_etree.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "CHOLMOD/Cholesky/cholmod_etree.c"
# 38 "CHOLMOD/Cholesky/cholmod_etree.c"
...
# 39 "CHOLMOD/Cholesky/cholmod_etree.c" 2
...
# 40 "CHOLMOD/Cholesky/cholmod_etree.c" 2
...
{
    long *Ap, *Ai, *Anz, *Ancestor, *Prev, *Iwork ;
    long i, j, jprev, p, pend, nrow, ncol, packed, stype ;
    size_t s ;
    int ok = 1 ;
    ...
    { if (Common == 
# 103 "CHOLMOD/Cholesky/cholmod_etree.c" 3 4
   ((void *)0)
# 103 "CHOLMOD/Cholesky/cholmod_etree.c"
   ) { return (0) ; } if (Common->itype != 2 || Common->dtype != 0) { Common->status = (-4) ; return (0) ; } } ;
    { if ((A) == 
# 104 "CHOLMOD/Cholesky/cholmod_etree.c" 3 4
   ((void *)0)
# 104 "CHOLMOD/Cholesky/cholmod_etree.c"
   ) { if (Common->status != (-2)) { cholmod_l_error ((-4), "CHOLMOD/Cholesky/cholmod_etree.c", 104, "argument missing", Common) ; } return (0) ; } } ;
    { if ((Parent) == 
# 105 "CHOLMOD/Cholesky/cholmod_etree.c" 3 4
   ((void *)0)
# 105 "CHOLMOD/Cholesky/cholmod_etree.c"
   ) { if (Common->status != (-2)) { cholmod_l_error ((-4), "CHOLMOD/Cholesky/cholmod_etree.c", 105, "argument missing", Common) ; } return (0) ; } } ;
    { if ((A)->xtype < (0) || (A)->xtype > (3) || ((A)->xtype != 0 && ((A)->x) == 
# 106 "CHOLMOD/Cholesky/cholmod_etree.c" 3 4
   ((void *)0)
# 106 "CHOLMOD/Cholesky/cholmod_etree.c"
   ) || ((A)->xtype == 3 && ((A)->z) == 
# 106 "CHOLMOD/Cholesky/cholmod_etree.c" 3 4
   ((void *)0)
# 106 "CHOLMOD/Cholesky/cholmod_etree.c"
   )) { if (Common->status != (-2)) { cholmod_l_error ((-4), "CHOLMOD/Cholesky/cholmod_etree.c", 106, "invalid xtype", Common) ; } return (0) ; } } ;
    Common->status = 0 ;
    ...
    s = cholmod_l_add_size_t (A->nrow, (stype ? 0 : A->ncol), &ok) ;
    if (!ok)
    {
 cholmod_l_error ((-3), "CHOLMOD/Cholesky/cholmod_etree.c", 119, "problem too large", Common) ;
 return (0) ;
    }
 ...
 cholmod_l_error ((-4), "CHOLMOD/Cholesky/cholmod_etree.c", 219, "symmetric lower not supported", Common) ;
 return (0) ;
    }
