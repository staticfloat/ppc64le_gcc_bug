# 1 "CHOLMOD/Core/cholmod_transpose.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "CHOLMOD/Core/cholmod_transpose.c"
# 115 "CHOLMOD/Core/cholmod_transpose.c"
...
# 116 "CHOLMOD/Core/cholmod_transpose.c" 2
...
# 117 "CHOLMOD/Core/cholmod_transpose.c" 2
...
# 1 "CHOLMOD/Core/t_cholmod_transpose.c" 1
# 17 "CHOLMOD/Core/t_cholmod_transpose.c"
# 1 "CHOLMOD/Include/cholmod_template.h" 1
# 18 "CHOLMOD/Core/t_cholmod_transpose.c" 2
# 32 "CHOLMOD/Core/t_cholmod_transpose.c"
static int p_cholmod_transpose_unsym
(
...
{
    double *Ax, *Az, *Fx, *Fz ;
    long *Ap, *Anz, *Ai, *Fp, *Fnz, *Fj, *Wi, *Iwork ;
    long j, p, pend, nrow, ncol, Apacked, use_fset, fp, Fpacked, jj, permute ;
    ...
    if (!(1))
    {
 cholmod_l_error ((-4), "CHOLMOD/Core/t_cholmod_transpose.c", 56, "real/complex mismatch", Common) ;
 return (0) ;
    }
    ...
    use_fset = (fset != 
# 64 "CHOLMOD/Core/t_cholmod_transpose.c" 3 4
                       ((void *)0)
# 64 "CHOLMOD/Core/t_cholmod_transpose.c"
                           ) ;
    nrow = A->nrow ;
    ncol = A->ncol ;
    ...
    permute = (Perm != 
# 76 "CHOLMOD/Core/t_cholmod_transpose.c" 3 4
                      ((void *)0)
# 76 "CHOLMOD/Core/t_cholmod_transpose.c"
                          ) ;
...
# 131 "CHOLMOD/Core/t_cholmod_transpose.c"
static int p_cholmod_transpose_sym
(
...
{
    double *Ax, *Az, *Fx, *Fz ;
    long *Ap, *Anz, *Ai, *Fp, *Fj, *Wi, *Pinv, *Iwork ;
    long p, pend, packed, fp, upper, permute, jold, n, i, j, iold ;
    ...
    if (!(1))
    {
 cholmod_l_error ((-4), "CHOLMOD/Core/t_cholmod_transpose.c", 153, "real/complex mismatch", Common) ;
 return (0) ;
    }
    ...
    permute = (Perm != 
# 161 "CHOLMOD/Core/t_cholmod_transpose.c" 3 4
                      ((void *)0)
# 161 "CHOLMOD/Core/t_cholmod_transpose.c"
                          ) ;
    n = A->nrow ;
    Ap = A->p ;
    Ai = A->i ;
...
# 125 "CHOLMOD/Core/cholmod_transpose.c" 2
...
# 18 "CHOLMOD/Core/t_cholmod_transpose.c" 2
# 32 "CHOLMOD/Core/t_cholmod_transpose.c"
static int r_cholmod_transpose_unsym
(
...
# 131 "CHOLMOD/Core/t_cholmod_transpose.c"
static int r_cholmod_transpose_sym
(
...
# 127 "CHOLMOD/Core/cholmod_transpose.c" 2
...
# 18 "CHOLMOD/Core/t_cholmod_transpose.c" 2
# 32 "CHOLMOD/Core/t_cholmod_transpose.c"
static int c_cholmod_transpose_unsym
(
...
# 76 "CHOLMOD/Core/t_cholmod_transpose.c"
 ...
 for ( ; p < pend ; p++)
 {
     ...
     Fx [2*(fp) ] = Ax [2*(p) ] ; Fx [2*(fp)+1] = -Ax [2*(p)+1] ;
...
# 131 "CHOLMOD/Core/t_cholmod_transpose.c"
static int c_cholmod_transpose_sym
(
...
# 129 "CHOLMOD/Core/cholmod_transpose.c" 2
...
# 18 "CHOLMOD/Core/t_cholmod_transpose.c" 2
# 32 "CHOLMOD/Core/t_cholmod_transpose.c"
static int ct_cholmod_transpose_unsym
(
...
# 131 "CHOLMOD/Core/t_cholmod_transpose.c"
static int ct_cholmod_transpose_sym
(
...
# 132 "CHOLMOD/Core/cholmod_transpose.c" 2
...
# 18 "CHOLMOD/Core/t_cholmod_transpose.c" 2
# 32 "CHOLMOD/Core/t_cholmod_transpose.c"
static int z_cholmod_transpose_unsym
(
...
# 131 "CHOLMOD/Core/t_cholmod_transpose.c"
static int z_cholmod_transpose_sym
(
...
# 134 "CHOLMOD/Core/cholmod_transpose.c" 2
...
# 18 "CHOLMOD/Core/t_cholmod_transpose.c" 2
# 32 "CHOLMOD/Core/t_cholmod_transpose.c"
static int zt_cholmod_transpose_unsym
(
...
# 131 "CHOLMOD/Core/t_cholmod_transpose.c"
static int zt_cholmod_transpose_sym
(
...
# 137 "CHOLMOD/Core/cholmod_transpose.c" 2
# 154 "CHOLMOD/Core/cholmod_transpose.c"
int cholmod_l_transpose_unsym
(
...
{
    long *Fp, *Fnz, *Ap, *Ai, *Anz, *Wi ;
    long nrow, ncol, permute, use_fset, Apacked, Fpacked, p, pend,
 i, j, k, Fsorted, nf, jj, jlast ;
    ...
    { if (Common == 
# 179 "CHOLMOD/Core/cholmod_transpose.c" 3 4
   ((void *)0)
# 179 "CHOLMOD/Core/cholmod_transpose.c"
   ) { return (0) ; } if (Common->itype != 2 || Common->dtype != 0) { Common->status = (-4) ; return (0) ; } } ;
    { if ((A) == 
# 180 "CHOLMOD/Core/cholmod_transpose.c" 3 4
   ((void *)0)
# 180 "CHOLMOD/Core/cholmod_transpose.c"
   ) { if (Common->status != (-2)) { cholmod_l_error ((-4), "CHOLMOD/Core/cholmod_transpose.c", 180, "argument missing", Common) ; } return (0) ; } } ;
    { if ((F) == 
# 181 "CHOLMOD/Core/cholmod_transpose.c" 3 4
   ((void *)0)
# 181 "CHOLMOD/Core/cholmod_transpose.c"
   ) { if (Common->status != (-2)) { cholmod_l_error ((-4), "CHOLMOD/Core/cholmod_transpose.c", 181, "argument missing", Common) ; } return (0) ; } } ;
    { if ((A)->xtype < (0) || (A)->xtype > (3) || ((A)->xtype != 0 && ((A)->x) == 
# 182 "CHOLMOD/Core/cholmod_transpose.c" 3 4
   ((void *)0)
# 182 "CHOLMOD/Core/cholmod_transpose.c"
   ) || ((A)->xtype == 3 && ((A)->z) == 
# 182 "CHOLMOD/Core/cholmod_transpose.c" 3 4
   ((void *)0)
# 182 "CHOLMOD/Core/cholmod_transpose.c"
   )) { if (Common->status != (-2)) { cholmod_l_error ((-4), "CHOLMOD/Core/cholmod_transpose.c", 182, "invalid xtype", Common) ; } return (0) ; } } ;
    { if ((F)->xtype < (0) || (F)->xtype > (3) || ((F)->xtype != 0 && ((F)->x) == 
# 183 "CHOLMOD/Core/cholmod_transpose.c" 3 4
   ((void *)0)
# 183 "CHOLMOD/Core/cholmod_transpose.c"
   ) || ((F)->xtype == 3 && ((F)->z) == 
# 183 "CHOLMOD/Core/cholmod_transpose.c" 3 4
   ((void *)0)
# 183 "CHOLMOD/Core/cholmod_transpose.c"
   )) { if (Common->status != (-2)) { cholmod_l_error ((-4), "CHOLMOD/Core/cholmod_transpose.c", 183, "invalid xtype", Common) ; } return (0) ; } } ;
    if (A->nrow != F->ncol || A->ncol != F->nrow)
    {
 cholmod_l_error ((-4), "CHOLMOD/Core/cholmod_transpose.c", 186, "F has the wrong dimensions", Common) ;
 return (0) ;
    }
    Common->status = 0 ;
    ...
    nf = fsize ;
    use_fset = (fset != 
# 196 "CHOLMOD/Core/cholmod_transpose.c" 3 4
                       ((void *)0)
# 196 "CHOLMOD/Core/cholmod_transpose.c"
                           ) ;
    nrow = A->nrow ;
    ncol = A->ncol ;
    ...
    permute = (Perm != 
# 206 "CHOLMOD/Core/cholmod_transpose.c" 3 4
                      ((void *)0)
# 206 "CHOLMOD/Core/cholmod_transpose.c"
                          ) ;
    ...
    s = cholmod_l_add_size_t (nrow, ((fset != 
# 220 "CHOLMOD/Core/cholmod_transpose.c" 3 4
                                            ((void *)0)
# 220 "CHOLMOD/Core/cholmod_transpose.c"
                                                ) ? ncol : 0), &ok) ;
    if (!ok)
    {
 cholmod_l_error ((-3), "CHOLMOD/Core/cholmod_transpose.c", 223, "problem too large", Common) ;
 return (0) ;
    }

    cholmod_l_allocate_work (0, s, 0, Common) ;
    if (Common->status < 0)
    {
 return (0) ;
    }
 ...
 for (k = 0 ; k < nrow ; k++)
 {
     ...
     {
  cholmod_l_error ((-4), "CHOLMOD/Core/cholmod_transpose.c", 250, "invalid permutation", Common) ;
  return (0) ;
     }
     Wi [i] = 0 ;
 }
 ...
 for (k = 0 ; k < nf ; k++)
 {
     ...
     {
  cholmod_l_error ((-4), "CHOLMOD/Core/cholmod_transpose.c", 268, "invalid fset", Common) ;
  return (0) ;
     }
     Wi [j] = 0 ;
 }
 ...
 for (i = 0 ; i < nrow ; i++)
 {
    ...
    if (p > (long) (F->nzmax))
    {
 cholmod_l_error ((-4), "CHOLMOD/Core/cholmod_transpose.c", 412, "F is too small", Common) ;
 return (0) ;
    }
...
# 479 "CHOLMOD/Core/cholmod_transpose.c"
int cholmod_l_transpose_sym
(
...
{
    long *Ap, *Anz, *Ai, *Fp, *Wi, *Pinv, *Iwork ;
    long p, pend, packed, upper, permute, jold, n, i, j, k, iold ;
    size_t s ;
    int ok = 1 ;
    ...
    { if (Common == 
# 501 "CHOLMOD/Core/cholmod_transpose.c" 3 4
   ((void *)0)
# 501 "CHOLMOD/Core/cholmod_transpose.c"
   ) { return (0) ; } if (Common->itype != 2 || Common->dtype != 0) { Common->status = (-4) ; return (0) ; } } ;
    { if ((A) == 
# 502 "CHOLMOD/Core/cholmod_transpose.c" 3 4
   ((void *)0)
# 502 "CHOLMOD/Core/cholmod_transpose.c"
   ) { if (Common->status != (-2)) { cholmod_l_error ((-4), "CHOLMOD/Core/cholmod_transpose.c", 502, "argument missing", Common) ; } return (0) ; } } ;
    { if ((F) == 
# 503 "CHOLMOD/Core/cholmod_transpose.c" 3 4
   ((void *)0)
# 503 "CHOLMOD/Core/cholmod_transpose.c"
   ) { if (Common->status != (-2)) { cholmod_l_error ((-4), "CHOLMOD/Core/cholmod_transpose.c", 503, "argument missing", Common) ; } return (0) ; } } ;
    { if ((A)->xtype < (0) || (A)->xtype > (3) || ((A)->xtype != 0 && ((A)->x) == 
# 504 "CHOLMOD/Core/cholmod_transpose.c" 3 4
   ((void *)0)
# 504 "CHOLMOD/Core/cholmod_transpose.c"
   ) || ((A)->xtype == 3 && ((A)->z) == 
# 504 "CHOLMOD/Core/cholmod_transpose.c" 3 4
   ((void *)0)
# 504 "CHOLMOD/Core/cholmod_transpose.c"
   )) { if (Common->status != (-2)) { cholmod_l_error ((-4), "CHOLMOD/Core/cholmod_transpose.c", 504, "invalid xtype", Common) ; } return (0) ; } } ;
    { if ((F)->xtype < (0) || (F)->xtype > (3) || ((F)->xtype != 0 && ((F)->x) == 
# 505 "CHOLMOD/Core/cholmod_transpose.c" 3 4
   ((void *)0)
# 505 "CHOLMOD/Core/cholmod_transpose.c"
   ) || ((F)->xtype == 3 && ((F)->z) == 
# 505 "CHOLMOD/Core/cholmod_transpose.c" 3 4
   ((void *)0)
# 505 "CHOLMOD/Core/cholmod_transpose.c"
   )) { if (Common->status != (-2)) { cholmod_l_error ((-4), "CHOLMOD/Core/cholmod_transpose.c", 505, "invalid xtype", Common) ; } return (0) ; } } ;
    if (A->nrow != A->ncol || A->stype == 0)
    {

 cholmod_l_error ((-4), "CHOLMOD/Core/cholmod_transpose.c", 509, "matrix must be symmetric", Common) ;
 return (0) ;
    }
    if (A->nrow != F->ncol || A->ncol != F->nrow)
    {
 cholmod_l_error ((-4), "CHOLMOD/Core/cholmod_transpose.c", 514, "F has the wrong dimensions", Common) ;
 return (0) ;
    }
    Common->status = 0 ;
    ...
    permute = (Perm != 
# 523 "CHOLMOD/Core/cholmod_transpose.c" 3 4
                      ((void *)0)
# 523 "CHOLMOD/Core/cholmod_transpose.c"
                          ) ;
    n = A->nrow ;
    Ap = A->p ;
    Ai = A->i ;
    ...
    s = cholmod_l_add_size_t (n, ((Perm != 
# 539 "CHOLMOD/Core/cholmod_transpose.c" 3 4
                                         ((void *)0)
# 539 "CHOLMOD/Core/cholmod_transpose.c"
                                             ) ? n : 0), &ok) ;
    if (!ok)
    {
 cholmod_l_error ((-3), "CHOLMOD/Core/cholmod_transpose.c", 542, "problem too large", Common) ;
 return (0) ;
    }
 ...
 for (k = 0 ; k < n ; k++)
 {
     ...
     if (i < 0 || i > n || Pinv [i] != (-1))
     {
  cholmod_l_error ((-4), "CHOLMOD/Core/cholmod_transpose.c", 575, "invalid permutation", Common) ;
  return (0) ;
     }
     Pinv [i] = k ;
 }
 ...
 Wi [i] = Fp [i] ;
    ...
    if (p > (long) (F->nzmax))
    {
 cholmod_l_error ((-4), "CHOLMOD/Core/cholmod_transpose.c", 771, "F is too small", Common) ;
 return (0) ;
    }
 ...
 F->sorted = !permute ;
 F->packed = 1 ;
 F->stype = - (((A->stype) < 0) ? (-1) : (((A->stype) > 0) ? 1 : 0)) ;
 ;
    }
    return (ok) ;
}
# 843 "CHOLMOD/Core/cholmod_transpose.c"
...
{
    return (cholmod_l_ptranspose (A, values, 
# 854 "CHOLMOD/Core/cholmod_transpose.c" 3 4
                                           ((void *)0)
# 854 "CHOLMOD/Core/cholmod_transpose.c"
                                               , 
# 854 "CHOLMOD/Core/cholmod_transpose.c" 3 4
                                                 ((void *)0)
# 854 "CHOLMOD/Core/cholmod_transpose.c"
...
# 874 "CHOLMOD/Core/cholmod_transpose.c"
cholmod_sparse *cholmod_l_ptranspose
(
...
)
{
    long *Ap, *Anz ;
    cholmod_sparse *F ;
    long nrow, ncol, use_fset, j, jj, fnz, packed, stype, nf, xtype ;
    size_t ineed ;
    int ok = 1 ;
    ...
    { if (Common == 
# 899 "CHOLMOD/Core/cholmod_transpose.c" 3 4
   ((void *)0)
# 899 "CHOLMOD/Core/cholmod_transpose.c"
   ) { return (
# 899 "CHOLMOD/Core/cholmod_transpose.c" 3 4
   ((void *)0)
# 899 "CHOLMOD/Core/cholmod_transpose.c"
...
# 899 "CHOLMOD/Core/cholmod_transpose.c"
    ...
    { if ((A) == 
# 900 "CHOLMOD/Core/cholmod_transpose.c" 3 4
   ((void *)0)
# 900 "CHOLMOD/Core/cholmod_transpose.c"
   ) { if (Common->status != (-2)) { cholmod_l_error ((-4), "CHOLMOD/Core/cholmod_transpose.c", 900, "argument missing", Common) ; } return (0) ; } } ;
    { if ((A)->xtype < (0) || (A)->xtype > (3) || ((A)->xtype != 0 && ((A)->x) == 
# 901 "CHOLMOD/Core/cholmod_transpose.c" 3 4
   ((void *)0)
# 901 "CHOLMOD/Core/cholmod_transpose.c"
   ) || ((A)->xtype == 3 && ((A)->z) == 
# 901 "CHOLMOD/Core/cholmod_transpose.c" 3 4
   ((void *)0)
# 901 "CHOLMOD/Core/cholmod_transpose.c"
   )) { if (Common->status != (-2)) { cholmod_l_error ((-4), "CHOLMOD/Core/cholmod_transpose.c", 901, "invalid xtype", Common) ; } return (
# 901 "CHOLMOD/Core/cholmod_transpose.c" 3 4
   ((void *)0)
# 901 "CHOLMOD/Core/cholmod_transpose.c"
   ) ; } } ;
 ...
 use_fset = 0 ;
 if (Perm != 
# 915 "CHOLMOD/Core/cholmod_transpose.c" 3 4
            ((void *)0)
# 915 "CHOLMOD/Core/cholmod_transpose.c"
                )
 {
     ineed = cholmod_l_mult_size_t (A->nrow, 2, &ok) ;
 }
 else
 {
     ineed = A->nrow ;
    ...
    {
 use_fset = (fset != 
# 926 "CHOLMOD/Core/cholmod_transpose.c" 3 4
                    ((void *)0)
# 926 "CHOLMOD/Core/cholmod_transpose.c"
                        ) ;
 if (use_fset)
 {
     ineed = (((A->nrow) > (A->ncol)) ? (A->nrow) : (A->ncol)) ;
 }
 else
 {
     ineed = A->nrow ;
    ...
    if (!ok)
    {
 cholmod_l_error ((-3), "CHOLMOD/Core/cholmod_transpose.c", 939, "problem too large", Common) ;
 return (
# 940 "CHOLMOD/Core/cholmod_transpose.c" 3 4
        ((void *)0)
# 940 "CHOLMOD/Core/cholmod_transpose.c"
            ) ;
    }

    cholmod_l_allocate_work (0, ineed, 0, Common) ;
    if (Common->status < 0)
    {
 return (
# 946 "CHOLMOD/Core/cholmod_transpose.c" 3 4
        ((void *)0)
# 946 "CHOLMOD/Core/cholmod_transpose.c"
            ) ;
    }
 ...
 if (use_fset)
 {
  ...
  if (j >= 0 && j < ncol)
  {
      fnz += packed ? (Ap [j+1] - Ap [j]) : (((0) > (Anz [j])) ? (0) : (Anz [j])) ;
  }
     }
 }
 else
 {
    ...
    F = cholmod_l_allocate_sparse (ncol, nrow, fnz, 1, 1, -(((stype) < 0) ? (-1) : (((stype) > 0) ? 1 : 0)),
     xtype, Common) ;
    if (Common->status < 0)
    {
 return (
# 1001 "CHOLMOD/Core/cholmod_transpose.c" 3 4
        ((void *)0)
# 1001 "CHOLMOD/Core/cholmod_transpose.c"
            ) ;
    }
 ...
 ok = cholmod_l_transpose_sym (A, values, Perm, F, Common) ;
    }
    else
    {

 ok = cholmod_l_transpose_unsym (A, values, Perm, fset, nf, F, Common) ;
    }
    ...
    if (!ok)
    {
 cholmod_l_free_sparse (&F, Common) ;
    }
    return (F) ;
}
# 1043 "CHOLMOD/Core/cholmod_transpose.c"
int cholmod_l_sort
(
...
)
{
    ...
    { if (Common == 
# 1059 "CHOLMOD/Core/cholmod_transpose.c" 3 4
   ((void *)0)
# 1059 "CHOLMOD/Core/cholmod_transpose.c"
   ) { return (0) ; } if (Common->itype != 2 || Common->dtype != 0) { Common->status = (-4) ; return (0) ; } } ;
    { if ((A) == 
# 1060 "CHOLMOD/Core/cholmod_transpose.c" 3 4
   ((void *)0)
# 1060 "CHOLMOD/Core/cholmod_transpose.c"
   ) { if (Common->status != (-2)) { cholmod_l_error ((-4), "CHOLMOD/Core/cholmod_transpose.c", 1060, "argument missing", Common) ; } return (0) ; } } ;
    { if ((A)->xtype < (0) || (A)->xtype > (3) || ((A)->xtype != 0 && ((A)->x) == 
# 1061 "CHOLMOD/Core/cholmod_transpose.c" 3 4
   ((void *)0)
# 1061 "CHOLMOD/Core/cholmod_transpose.c"
   ) || ((A)->xtype == 3 && ((A)->z) == 
# 1061 "CHOLMOD/Core/cholmod_transpose.c" 3 4
   ((void *)0)
# 1061 "CHOLMOD/Core/cholmod_transpose.c"
   )) { if (Common->status != (-2)) { cholmod_l_error ((-4), "CHOLMOD/Core/cholmod_transpose.c", 1061, "invalid xtype", Common) ; } return (0) ; } } ;
    Common->status = 0 ;
    nrow = A->nrow ;
    if (nrow <= 1)
    {
 ...
 return (1) ;
    ...
    ncol = A->ncol ;
    cholmod_l_allocate_work (0, (((nrow) > (ncol)) ? (nrow) : (ncol)), 0, Common) ;
    if (Common->status < 0)
    {
 return (0) ;
    }
    ...
    F = cholmod_l_allocate_sparse (ncol, nrow, anz, 1, 1, stype,
     A->xtype, Common) ;
    if (Common->status < 0)
    {
 return (0) ;
 ...
 cholmod_l_transpose_sym (A, 1, 
# 1105 "CHOLMOD/Core/cholmod_transpose.c" 3 4
                              ((void *)0)
# 1105 "CHOLMOD/Core/cholmod_transpose.c"
                                  , F, Common) ;
 A->packed = 1 ;

 cholmod_l_transpose_sym (F, 1, 
# 1108 "CHOLMOD/Core/cholmod_transpose.c" 3 4
                              ((void *)0)
# 1108 "CHOLMOD/Core/cholmod_transpose.c"
                                  , A, Common) ;
    }
    else
    {

 cholmod_l_transpose_unsym (A, 1, 
# 1113 "CHOLMOD/Core/cholmod_transpose.c" 3 4
                                ((void *)0)
# 1113 "CHOLMOD/Core/cholmod_transpose.c"
                                    , 
# 1113 "CHOLMOD/Core/cholmod_transpose.c" 3 4
                                      ((void *)0)
# 1113 "CHOLMOD/Core/cholmod_transpose.c"
 ...
 cholmod_l_transpose_unsym (F, 1, 
# 1116 "CHOLMOD/Core/cholmod_transpose.c" 3 4
                                ((void *)0)
# 1116 "CHOLMOD/Core/cholmod_transpose.c"
                                    , 
# 1116 "CHOLMOD/Core/cholmod_transpose.c" 3 4
                                      ((void *)0)
# 1116 "CHOLMOD/Core/cholmod_transpose.c"
    ...
    anz = Ap [ncol] ;
    ;
    cholmod_l_reallocate_sparse (anz, A, Common) ;
    ;
