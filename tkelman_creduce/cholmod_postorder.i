# 1 "CHOLMOD/Cholesky/cholmod_postorder.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "CHOLMOD/Cholesky/cholmod_postorder.c"
# 16 "CHOLMOD/Cholesky/cholmod_postorder.c"
...
# 17 "CHOLMOD/Cholesky/cholmod_postorder.c" 2
...
# 18 "CHOLMOD/Cholesky/cholmod_postorder.c" 2
# 63 "CHOLMOD/Cholesky/cholmod_postorder.c"
static long dfs
(
    long p,
    long k,
...
# 141 "CHOLMOD/Cholesky/cholmod_postorder.c"
long cholmod_l_postorder
(
...
)
{
    ...
    { if (Common == 
# 162 "CHOLMOD/Cholesky/cholmod_postorder.c" 3 4
   ((void *)0)
# 162 "CHOLMOD/Cholesky/cholmod_postorder.c"
   ) { return ((-1)) ; } if (Common->itype != 2 || Common->dtype != 0) { Common->status = (-4) ; return ((-1)) ; } } ;
    { if ((Parent) == 
# 163 "CHOLMOD/Cholesky/cholmod_postorder.c" 3 4
   ((void *)0)
# 163 "CHOLMOD/Cholesky/cholmod_postorder.c"
   ) { if (Common->status != (-2)) { cholmod_l_error ((-4), "CHOLMOD/Cholesky/cholmod_postorder.c", 163, "argument missing", Common) ; } return ((-1)) ; } } ;
    { if ((Post) == 
# 164 "CHOLMOD/Cholesky/cholmod_postorder.c" 3 4
   ((void *)0)
# 164 "CHOLMOD/Cholesky/cholmod_postorder.c"
   ) { if (Common->status != (-2)) { cholmod_l_error ((-4), "CHOLMOD/Cholesky/cholmod_postorder.c", 164, "argument missing", Common) ; } return ((-1)) ; } } ;
    Common->status = 0 ;
    ...
    s = cholmod_l_mult_size_t (n, 2, &ok) ;
    if (!ok)
    {
 cholmod_l_error ((-3), "CHOLMOD/Cholesky/cholmod_postorder.c", 175, "problem too large", Common) ;
 return ((-1)) ;
    }
 ...
 return ((-1)) ;
    ...
    if (Weight == 
# 199 "CHOLMOD/Cholesky/cholmod_postorder.c" 3 4
                 ((void *)0)
# 199 "CHOLMOD/Cholesky/cholmod_postorder.c"
                     )
    {
