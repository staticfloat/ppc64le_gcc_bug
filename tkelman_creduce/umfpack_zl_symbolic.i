# 1 "UMFPACK/Source/umfpack_symbolic.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "UMFPACK/Source/umfpack_symbolic.c"
# 15 "UMFPACK/Source/umfpack_symbolic.c"
...
# 16 "UMFPACK/Source/umfpack_symbolic.c" 2
...
{
    return (umfpack_zl_qsymbolic (n_row, n_col, Ap, Ai, Ax,

        Az,

        (long *) 
# 36 "UMFPACK/Source/umfpack_symbolic.c" 3 4
               ((void *)0)
# 36 "UMFPACK/Source/umfpack_symbolic.c"
                   , SymbolicHandle, Control, Info)) ;
}
