# 1 "CHOLMOD/Cholesky/cholmod_colamd.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "CHOLMOD/Cholesky/cholmod_colamd.c"
# 30 "CHOLMOD/Cholesky/cholmod_colamd.c"
...
# 31 "CHOLMOD/Cholesky/cholmod_colamd.c" 2
# 1 "COLAMD/Include/colamd.h" 1
# 140 "COLAMD/Include/colamd.h"
...
# 32 "CHOLMOD/Cholesky/cholmod_colamd.c" 2
...
# 33 "CHOLMOD/Cholesky/cholmod_colamd.c" 2
# 42 "CHOLMOD/Cholesky/cholmod_colamd.c"
int cholmod_l_colamd
(
...
)
{
    double knobs [20] ;
    cholmod_sparse *C ;
    long *NewPerm, *Parent, *Post, *Work2n ;
    long k, nrow, ncol ;
    size_t s, alen ;
    int ok = 1 ;
    ...
    { if (Common == 
# 66 "CHOLMOD/Cholesky/cholmod_colamd.c" 3 4
   ((void *)0)
# 66 "CHOLMOD/Cholesky/cholmod_colamd.c"
   ) { return (0) ; } if (Common->itype != 2 || Common->dtype != 0) { Common->status = (-4) ; return (0) ; } } ;
    { if ((A) == 
# 67 "CHOLMOD/Cholesky/cholmod_colamd.c" 3 4
   ((void *)0)
# 67 "CHOLMOD/Cholesky/cholmod_colamd.c"
   ) { if (Common->status != (-2)) { cholmod_l_error ((-4), "CHOLMOD/Cholesky/cholmod_colamd.c", 67, "argument missing", Common) ; } return (0) ; } } ;
    { if ((Perm) == 
# 68 "CHOLMOD/Cholesky/cholmod_colamd.c" 3 4
   ((void *)0)
# 68 "CHOLMOD/Cholesky/cholmod_colamd.c"
   ) { if (Common->status != (-2)) { cholmod_l_error ((-4), "CHOLMOD/Cholesky/cholmod_colamd.c", 68, "argument missing", Common) ; } return (0) ; } } ;
    { if ((A)->xtype < (0) || (A)->xtype > (3) || ((A)->xtype != 0 && ((A)->x) == 
# 69 "CHOLMOD/Cholesky/cholmod_colamd.c" 3 4
   ((void *)0)
# 69 "CHOLMOD/Cholesky/cholmod_colamd.c"
   ) || ((A)->xtype == 3 && ((A)->z) == 
# 69 "CHOLMOD/Cholesky/cholmod_colamd.c" 3 4
   ((void *)0)
# 69 "CHOLMOD/Cholesky/cholmod_colamd.c"
   )) { if (Common->status != (-2)) { cholmod_l_error ((-4), "CHOLMOD/Cholesky/cholmod_colamd.c", 69, "invalid xtype", Common) ; } return (0) ; } } ;
    if (A->stype != 0)
    {
 cholmod_l_error ((-4), "CHOLMOD/Cholesky/cholmod_colamd.c", 72, "matrix must be unsymmetric", Common) ;
 return (0) ;
    }
    Common->status = 0 ;
    ...
    nrow = A->nrow ;
    ncol = A->ncol ;
# 94 "CHOLMOD/Cholesky/cholmod_colamd.c"
    s = cholmod_l_mult_size_t (nrow, 4, &ok) ;
    s = cholmod_l_add_size_t (s, ncol, &ok) ;
    ...
    if (!ok || alen == 0)
    {
 cholmod_l_error ((-3), "CHOLMOD/Cholesky/cholmod_colamd.c", 107, "matrix invalid or too large", Common) ;
 return (0) ;
    }
 ...
 return (0) ;
    ...
    C = cholmod_l_allocate_sparse (ncol, nrow, alen, 1, 1, 0,
     0, Common) ;
    ...
    ok = cholmod_l_transpose_unsym (A, 0, 
# 130 "CHOLMOD/Cholesky/cholmod_colamd.c" 3 4
                                        ((void *)0)
# 130 "CHOLMOD/Cholesky/cholmod_colamd.c"
                                            , fset, fsize, C, Common) ;
    ...
    if (Common->current < 0 || Common->current >= 9)
    {
 ...
 knobs [1] = Common->method[Common->current].prune_dense ;
 knobs [0] = Common->method[Common->current].prune_dense2;
 knobs [2] = Common->method[Common->current].aggressive ;
    }
 ...
 for (k = 0 ; k < nrow ; k++)
 {
    ...
    cholmod_l_free_sparse (&C, Common) ;
 ...
 ok = ok && cholmod_l_analyze_ordering (A, 5, Perm, fset,
  fsize, Parent, Post, 
# 187 "CHOLMOD/Cholesky/cholmod_colamd.c" 3 4
                      ((void *)0)
# 187 "CHOLMOD/Cholesky/cholmod_colamd.c"
                          , 
# 187 "CHOLMOD/Cholesky/cholmod_colamd.c" 3 4
                            ((void *)0)
# 187 "CHOLMOD/Cholesky/cholmod_colamd.c"
