# 1 "CHOLMOD/Core/cholmod_aat.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "CHOLMOD/Core/cholmod_aat.c"
# 35 "CHOLMOD/Core/cholmod_aat.c"
...
# 36 "CHOLMOD/Core/cholmod_aat.c" 2
...
# 37 "CHOLMOD/Core/cholmod_aat.c" 2

cholmod_sparse *cholmod_l_aat
(
...
)
{
    double fjt ;
    double *Ax, *Fx, *Cx, *W ;
    long *Ap, *Anz, *Ai, *Fp, *Fi, *Cp, *Ci, *Flag ;
    cholmod_sparse *C, *F ;
    long packed, j, i, pa, paend, pf, pfend, n, mark, cnz, t, p, values, diag,
 extra ;
    ...
    { if (Common == 
# 62 "CHOLMOD/Core/cholmod_aat.c" 3 4
   ((void *)0)
# 62 "CHOLMOD/Core/cholmod_aat.c"
   ) { return (
# 62 "CHOLMOD/Core/cholmod_aat.c" 3 4
   ((void *)0)
# 62 "CHOLMOD/Core/cholmod_aat.c"
...
# 62 "CHOLMOD/Core/cholmod_aat.c"
    ...
    { if ((A) == 
# 63 "CHOLMOD/Core/cholmod_aat.c" 3 4
   ((void *)0)
# 63 "CHOLMOD/Core/cholmod_aat.c"
   ) { if (Common->status != (-2)) { cholmod_l_error ((-4), "CHOLMOD/Core/cholmod_aat.c", 63, "argument missing", Common) ; } return (
# 63 "CHOLMOD/Core/cholmod_aat.c" 3 4
   ((void *)0)
# 63 "CHOLMOD/Core/cholmod_aat.c"
   ) ; } } ;
...
# 65 "CHOLMOD/Core/cholmod_aat.c" 3 4
   ((void *)0)
# 65 "CHOLMOD/Core/cholmod_aat.c"
   ) || ((A)->xtype == 3 && ((A)->z) == 
# 65 "CHOLMOD/Core/cholmod_aat.c" 3 4
   ((void *)0)
# 65 "CHOLMOD/Core/cholmod_aat.c"
...
# 65 "CHOLMOD/Core/cholmod_aat.c"
    ...
    if (A->stype)
    {
 cholmod_l_error ((-4), "CHOLMOD/Core/cholmod_aat.c", 69, "matrix cannot be symmetric", Common) ;
 return (
# 70 "CHOLMOD/Core/cholmod_aat.c" 3 4
        ((void *)0)
# 70 "CHOLMOD/Core/cholmod_aat.c"
            ) ;
    }
    Common->status = 0 ;
    ...
    diag = (mode >= 0) ;
    n = A->nrow ;
    cholmod_l_allocate_work (n, (((A->ncol) > (A->nrow)) ? (A->ncol) : (A->nrow)), values ? n : 0, Common) ;
    if (Common->status < 0)
    {
 return (
# 83 "CHOLMOD/Core/cholmod_aat.c" 3 4
        ((void *)0)
# 83 "CHOLMOD/Core/cholmod_aat.c"
            ) ;
    }
    ;
    ...
    F = cholmod_l_ptranspose (A, values, 
# 109 "CHOLMOD/Core/cholmod_aat.c" 3 4
                                       ((void *)0)
# 109 "CHOLMOD/Core/cholmod_aat.c"
                                           , fset, fsize, Common) ;
    if (Common->status < 0)
    {
 return (
# 112 "CHOLMOD/Core/cholmod_aat.c" 3 4
        ((void *)0)
# 112 "CHOLMOD/Core/cholmod_aat.c"
            ) ;
    }
 ...
 if (cnz < 0)
 {
    ...
    {
 cholmod_l_error ((-3), "CHOLMOD/Core/cholmod_aat.c", 173, "problem too large", Common) ;
 cholmod_l_clear_flag (Common) ;
 cholmod_l_free_sparse (&F, Common) ;
 return (
# 176 "CHOLMOD/Core/cholmod_aat.c" 3 4
        ((void *)0)
# 176 "CHOLMOD/Core/cholmod_aat.c"
            ) ;
    }
    ...
    C = cholmod_l_allocate_sparse (n, n, cnz + extra, 0, 1, 0,
     values ? A->xtype : 0, Common) ;
    if (Common->status < 0)
    {
 cholmod_l_free_sparse (&F, Common) ;
 return (
# 188 "CHOLMOD/Core/cholmod_aat.c" 3 4
        ((void *)0)
# 188 "CHOLMOD/Core/cholmod_aat.c"
            ) ;
    }
