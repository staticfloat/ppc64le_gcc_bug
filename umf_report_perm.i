...
)
{
    ...
    { if (user || prl >= 4) { if (SuiteSparse_config.printf_func != 
# 28 "umf_report_perm.c" 3 4
   ((void *)0)
# 28 "umf_report_perm.c"
   ) { (void) (SuiteSparse_config.printf_func) ("permutation vector, n = ""%" "ld"". ", n) ; } } ; } ;

    if (n <= 0)
    {
 { if (SuiteSparse_config.printf_func != 
# 32 "umf_report_perm.c" 3 4
((void *)0)
# 32 "umf_report_perm.c"
) { (void) (SuiteSparse_config.printf_func) ("ERROR: length of permutation is <= 0\n\n") ; } } ;
 return ((-6)) ;
    }
 ...
 { if (SuiteSparse_config.printf_func != 
# 39 "umf_report_perm.c" 3 4
((void *)0)
# 39 "umf_report_perm.c"
) { (void) (SuiteSparse_config.printf_func) ("(not present)\n\n") ; } } ;
 return ((0)) ;
    }
...
# 49 "umf_report_perm.c"
 ...
 i = P [k] ;
 { if (prl >= (4)) { { if (SuiteSparse_config.printf_func != 
# 60 "umf_report_perm.c" 3 4
((void *)0)
# 60 "umf_report_perm.c"
) { (void) (SuiteSparse_config.printf_func) ("    ""%" "ld"" : ""%" "ld"" ", (k), (i)) ; } } ; } } ;
 valid = (i >= 0 && i < n) ;
 if (valid)
 {
     valid = W [i] ;
 ...
 if (!valid)
 {
     ...
     { if (SuiteSparse_config.printf_func != 
# 70 "umf_report_perm.c" 3 4
    ((void *)0)
# 70 "umf_report_perm.c"
    ) { (void) (SuiteSparse_config.printf_func) ("ERROR: invalid\n\n") ; } } ;
     return ((-15)) ;
 }
 { if (prl >= (4)) { { if (SuiteSparse_config.printf_func != 
# 73 "umf_report_perm.c" 3 4
((void *)0)
# 73 "umf_report_perm.c"
) { (void) (SuiteSparse_config.printf_func) ("\n") ; } } ; } } ;
 if (prl == 4 && k == 9 && n > 10)
 {
     { if (SuiteSparse_config.printf_func != 
# 76 "umf_report_perm.c" 3 4
    ((void *)0)
# 76 "umf_report_perm.c"
    ) { (void) (SuiteSparse_config.printf_func) ("    ...\n") ; } } ;
     prl-- ;
 }
    }
    ...
    { if (prl >= (4)) { { if (SuiteSparse_config.printf_func != 
# 82 "umf_report_perm.c" 3 4
   ((void *)0)
# 82 "umf_report_perm.c"
   ) { (void) (SuiteSparse_config.printf_func) ("    permutation vector ") ; } } ; } } ;
    { if (user || prl >= 4) { if (SuiteSparse_config.printf_func != 
# 83 "umf_report_perm.c" 3 4
   ((void *)0)
# 83 "umf_report_perm.c"
