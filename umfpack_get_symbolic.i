# 1 "umfpack_get_symbolic.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "umfpack_get_symbolic.c"
# 15 "umfpack_get_symbolic.c"
# 1 "umf_internal.h" 1
# 25 "umf_internal.h"
...
{
    SymbolicType *Symbolic ;
    long k, n_row, n_col, n1, nfr, nchains, *p ;
 ...
 *p_nchains = nchains ;
    ...
    if (P != (long *) 
# 91 "umfpack_get_symbolic.c" 3 4
                    ((void *)0)
# 91 "umfpack_get_symbolic.c"
                        )
    {
 long *Rperm_init, *Diagonal_map ;
 Rperm_init = Symbolic->Rperm_init ;
 Diagonal_map = Symbolic->Diagonal_map ;
 if (Diagonal_map != (long *) 
# 96 "umfpack_get_symbolic.c" 3 4
                            ((void *)0)
# 96 "umfpack_get_symbolic.c"
                                )
 {
     ;
 ...
 else
 {
  ...
  P [k] = Rperm_init [k] ;
    ...
    if (Q != (long *) 
# 115 "umfpack_get_symbolic.c" 3 4
                    ((void *)0)
# 115 "umfpack_get_symbolic.c"
                        )
    {
 ...
 for (k = 0 ; k < n_col ; k++)
 {
    ...
    if (Front_npivcol != (long *) 
# 124 "umfpack_get_symbolic.c" 3 4
                                ((void *)0)
# 124 "umfpack_get_symbolic.c"
                                    )
    {
 ...
 for (k = 0 ; k <= nfr ; k++)
 {
    ...
    if (Front_parent != (long *) 
# 133 "umfpack_get_symbolic.c" 3 4
                               ((void *)0)
# 133 "umfpack_get_symbolic.c"
                                   )
    {
 ...
 for (k = 0 ; k <= nfr ; k++)
 {
    ...
    if (Front_1strow != (long *) 
# 142 "umfpack_get_symbolic.c" 3 4
                               ((void *)0)
# 142 "umfpack_get_symbolic.c"
                                   )
    {
 ...
 for (k = 0 ; k <= nfr ; k++)
 {
    ...
    if (Front_leftmostdesc != (long *) 
# 151 "umfpack_get_symbolic.c" 3 4
                                     ((void *)0)
# 151 "umfpack_get_symbolic.c"
                                         )
    {
 ...
 for (k = 0 ; k <= nfr ; k++)
 {
    ...
    if (Chain_start != (long *) 
# 160 "umfpack_get_symbolic.c" 3 4
                              ((void *)0)
# 160 "umfpack_get_symbolic.c"
                                  )
    {
 ...
 for (k = 0 ; k <= nchains ; k++)
 {
    ...
    if (Chain_maxrows != (long *) 
# 169 "umfpack_get_symbolic.c" 3 4
                                ((void *)0)
# 169 "umfpack_get_symbolic.c"
                                    )
    {
 ...
 Chain_maxrows [nchains] = 0 ;
    ...
    if (Chain_maxcols != (long *) 
# 179 "umfpack_get_symbolic.c" 3 4
                                ((void *)0)
# 179 "umfpack_get_symbolic.c"
                                    )
    {
