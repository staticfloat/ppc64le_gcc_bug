...
# 119 "umfpack_numeric.c"
 ...
 scale = 1 ;
    ...
    if (User_Info != (double *) 
# 131 "umfpack_numeric.c" 3 4
                               ((void *)0)
# 131 "umfpack_numeric.c"
                                   )
    {
 ...
 for (i = 0 ; i < 90 ; i++)
 {
    ...
    Numeric = (NumericType *) 
# 156 "umfpack_numeric.c" 3 4
                             ((void *)0) 
# 156 "umfpack_numeric.c"
                                  ;
 ...
 return ((-5)) ;
    ...
    Info [2] = Ap [n_col] ;
    *NumericHandle = (void *) 
# 199 "umfpack_numeric.c" 3 4
                             ((void *)0) 
# 199 "umfpack_numeric.c"
                                  ;
# 216 "umfpack_numeric.c"
    Work = &WorkSpace ;
    Work->n_row = n_row ;
    Work->n_col = n_col ;
...
# 548 "umfpack_numeric.c" 3 4
                                    ((void *)0) 
# 548 "umfpack_numeric.c"
                                         ;
 ...
 ;
 Numeric->Rs = (double *) 
# 583 "umfpack_numeric.c" 3 4
                         ((void *)0) 
# 583 "umfpack_numeric.c"
                              ;
    }

    Numeric->Memory = (Unit *) 
# 586 "umfpack_numeric.c" 3 4
                              ((void *)0) 
# 586 "umfpack_numeric.c"
                                   ;
...
# 593 "umfpack_numeric.c" 3 4
                               ((void *)0) 
# 593 "umfpack_numeric.c"
                                    ;
...
# 719 "umfpack_numeric.c" 3 4
                             ((void *)0) 
# 719 "umfpack_numeric.c"
                                  ;
 Work->Diagonal_imap = (long *) 
# 720 "umfpack_numeric.c" 3 4
                              ((void *)0) 
# 720 "umfpack_numeric.c"
                                   ;
    }
...
# 728 "umfpack_numeric.c" 3 4
                              ((void *)0) 
# 728 "umfpack_numeric.c"
                                   ;
    Work->Flblock = (DoubleComplex *) 
# 729 "umfpack_numeric.c" 3 4
                              ((void *)0) 
# 729 "umfpack_numeric.c"
                                   ;
    Work->Fublock = (DoubleComplex *) 
# 730 "umfpack_numeric.c" 3 4
                              ((void *)0) 
# 730 "umfpack_numeric.c"
                                   ;
    Work->Fcblock = (DoubleComplex *) 
# 731 "umfpack_numeric.c" 3 4
                              ((void *)0) 
# 731 "umfpack_numeric.c"
                                   ;
