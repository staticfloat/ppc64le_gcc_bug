...
# 41 "umf_singletons.c" 2
# 125 "umf_singletons.c"
...
# 229 "umf_singletons.c"
 ...
 Yperm [k] = ypivot ;
 k++ ;
# 301 "umf_singletons.c"
    }
# 312 "umf_singletons.c"
    return (k) ;
}
...
)
{
    ...
    {
 x = (Xuser != (long *) 
# 706 "umf_singletons.c" 3 4
                      ((void *)0)
# 706 "umf_singletons.c"
                          ) ? Xuser [k] : k ;
 ;
 deg = Xdeg [x] ;
 if (deg == 0)
...
# 832 "umf_singletons.c" 3 4
                             ((void *)0)
# 832 "umf_singletons.c"
                                 )
    {
 ...
 n1 = find_any_singletons (n_row, n_col, Ap, Ai,
  Cdeg, Rdeg, Cperm, Rperm, &n1r, &n1c, Rp, Ri, W, Next) ;
    ...
    if (Quser != (long *) 
# 867 "umf_singletons.c" 3 4
                        ((void *)0) 
# 867 "umf_singletons.c"
                             && strategy == 3)
    {
...
# 877 "umf_singletons.c" 3 4
                                                          ((void *)0)
# 877 "umf_singletons.c"
                                                              , Rperm,
     &max_rdeg) ;
    }
