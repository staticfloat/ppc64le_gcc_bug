# 1 "umfpack_report_perm.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "umfpack_report_perm.c"
# 18 "umfpack_report_perm.c"
# 1 "umf_internal.h" 1
# 25 "umf_internal.h"
...
)
{
    ...
    prl = ((Control != (double *) 
# 32 "umfpack_report_perm.c" 3 4
         ((void *)0)
# 32 "umfpack_report_perm.c"
 ...
 return ((0)) ;
    ...
    W = (long *) umf_l_malloc ((((np) > (1)) ? (np) : (1)), sizeof (long)) ;
    status = umf_l_report_perm (np, Perm, W, prl, 1) ;
