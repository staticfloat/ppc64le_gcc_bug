# 1 "umfpack_load_numeric.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "umfpack_load_numeric.c"
# 15 "umfpack_load_numeric.c"
# 1 "umf_internal.h" 1
# 25 "umf_internal.h"
...
# 19 "umfpack_load_numeric.c" 2
# 47 "umfpack_load_numeric.c"
 long umfpack_zl_load_numeric
(
    void **NumericHandle,
    char *user_filename
)
{
    ...
    *NumericHandle = (void *) 
# 57 "umfpack_load_numeric.c" 3 4
                             ((void *)0) 
# 57 "umfpack_load_numeric.c"
                                  ;
...
# 63 "umfpack_load_numeric.c" 3 4
                                 ((void *)0)
# 63 "umfpack_load_numeric.c"
                                     )
    {
 ...
 return ((-17)) ;
    ...
    if (Numeric == (NumericType *) 
# 82 "umfpack_load_numeric.c" 3 4
                                  ((void *)0)
# 82 "umfpack_load_numeric.c"
                                      )
    {
 fclose (f) ;
 return ((-1)) ;
 ...
 return ((-17)) ;
    ...
    if (Numeric->valid != 129987754 || Numeric->n_row <= 0 ||
 ...
 return ((-3)) ;
    ...
    Numeric->D = (DoubleComplex *) 
# 110 "umfpack_load_numeric.c" 3 4
                                 ((void *)0) 
# 110 "umfpack_load_numeric.c"
                                      ;
    Numeric->Rperm = (long *) 
# 111 "umfpack_load_numeric.c" 3 4
                               ((void *)0) 
# 111 "umfpack_load_numeric.c"
                                    ;
    Numeric->Cperm = (long *) 
# 112 "umfpack_load_numeric.c" 3 4
                               ((void *)0) 
# 112 "umfpack_load_numeric.c"
                                    ;
    Numeric->Lpos = (long *) 
# 113 "umfpack_load_numeric.c" 3 4
                               ((void *)0) 
# 113 "umfpack_load_numeric.c"
                                    ;
    Numeric->Lilen = (long *) 
# 114 "umfpack_load_numeric.c" 3 4
                               ((void *)0) 
# 114 "umfpack_load_numeric.c"
                                    ;
    Numeric->Lip = (long *) 
# 115 "umfpack_load_numeric.c" 3 4
                               ((void *)0) 
# 115 "umfpack_load_numeric.c"
                                    ;
    Numeric->Upos = (long *) 
# 116 "umfpack_load_numeric.c" 3 4
                               ((void *)0) 
# 116 "umfpack_load_numeric.c"
                                    ;
    Numeric->Uilen = (long *) 
# 117 "umfpack_load_numeric.c" 3 4
                               ((void *)0) 
# 117 "umfpack_load_numeric.c"
                                    ;
    Numeric->Uip = (long *) 
# 118 "umfpack_load_numeric.c" 3 4
                               ((void *)0) 
# 118 "umfpack_load_numeric.c"
                                    ;
    Numeric->Rs = (double *) 
# 119 "umfpack_load_numeric.c" 3 4
                                  ((void *)0) 
# 119 "umfpack_load_numeric.c"
                                       ;
    Numeric->Memory = (Unit *) 
# 120 "umfpack_load_numeric.c" 3 4
                                ((void *)0) 
# 120 "umfpack_load_numeric.c"
                                     ;
    Numeric->Upattern = (long *) 
# 121 "umfpack_load_numeric.c" 3 4
                               ((void *)0) 
# 121 "umfpack_load_numeric.c"
                                    ;
    ...
    { Numeric->D = (DoubleComplex *) umf_l_malloc ((((Numeric->n_row) < (Numeric->n_col)) ? (Numeric->n_row) : (Numeric->n_col))+1, sizeof (DoubleComplex)) ; if (Numeric->D == (DoubleComplex *) 
# 129 "umfpack_load_numeric.c" 3 4
   ((void *)0)
# 129 "umfpack_load_numeric.c"
   ) { umfpack_zl_free_numeric ((void **) &Numeric) ; fclose (f) ; return ((-1)) ; } if (fread (Numeric->D, sizeof (DoubleComplex), (((Numeric->n_row) < (Numeric->n_col)) ? (Numeric->n_row) : (Numeric->n_col))+1, f) != (size_t) (((Numeric->n_row) < (Numeric->n_col)) ? (Numeric->n_row) : (Numeric->n_col))+1) { umfpack_zl_free_numeric ((void **) &Numeric) ; fclose (f) ; return ((-17)) ; } if (ferror (f)) { umfpack_zl_free_numeric ((void **) &Numeric) ; fclose (f) ; return ((-17)) ; } } ;
    { Numeric->Rperm = (long *) umf_l_malloc (Numeric->n_row+1, sizeof (long)) ; if (Numeric->Rperm == (long *) 
# 130 "umfpack_load_numeric.c" 3 4
   ((void *)0)
# 130 "umfpack_load_numeric.c"
   ) { umfpack_zl_free_numeric ((void **) &Numeric) ; fclose (f) ; return ((-1)) ; } if (fread (Numeric->Rperm, sizeof (long), Numeric->n_row+1, f) != (size_t) Numeric->n_row+1) { umfpack_zl_free_numeric ((void **) &Numeric) ; fclose (f) ; return ((-17)) ; } if (ferror (f)) { umfpack_zl_free_numeric ((void **) &Numeric) ; fclose (f) ; return ((-17)) ; } } ;
    { Numeric->Cperm = (long *) umf_l_malloc (Numeric->n_col+1, sizeof (long)) ; if (Numeric->Cperm == (long *) 
# 131 "umfpack_load_numeric.c" 3 4
   ((void *)0)
# 131 "umfpack_load_numeric.c"
   ) { umfpack_zl_free_numeric ((void **) &Numeric) ; fclose (f) ; return ((-1)) ; } if (fread (Numeric->Cperm, sizeof (long), Numeric->n_col+1, f) != (size_t) Numeric->n_col+1) { umfpack_zl_free_numeric ((void **) &Numeric) ; fclose (f) ; return ((-17)) ; } if (ferror (f)) { umfpack_zl_free_numeric ((void **) &Numeric) ; fclose (f) ; return ((-17)) ; } } ;
    { Numeric->Lpos = (long *) umf_l_malloc (Numeric->npiv+1, sizeof (long)) ; if (Numeric->Lpos == (long *) 
# 132 "umfpack_load_numeric.c" 3 4
   ((void *)0)
# 132 "umfpack_load_numeric.c"
   ) { umfpack_zl_free_numeric ((void **) &Numeric) ; fclose (f) ; return ((-1)) ; } if (fread (Numeric->Lpos, sizeof (long), Numeric->npiv+1, f) != (size_t) Numeric->npiv+1) { umfpack_zl_free_numeric ((void **) &Numeric) ; fclose (f) ; return ((-17)) ; } if (ferror (f)) { umfpack_zl_free_numeric ((void **) &Numeric) ; fclose (f) ; return ((-17)) ; } } ;
    { Numeric->Lilen = (long *) umf_l_malloc (Numeric->npiv+1, sizeof (long)) ; if (Numeric->Lilen == (long *) 
# 133 "umfpack_load_numeric.c" 3 4
   ((void *)0)
# 133 "umfpack_load_numeric.c"
   ) { umfpack_zl_free_numeric ((void **) &Numeric) ; fclose (f) ; return ((-1)) ; } if (fread (Numeric->Lilen, sizeof (long), Numeric->npiv+1, f) != (size_t) Numeric->npiv+1) { umfpack_zl_free_numeric ((void **) &Numeric) ; fclose (f) ; return ((-17)) ; } if (ferror (f)) { umfpack_zl_free_numeric ((void **) &Numeric) ; fclose (f) ; return ((-17)) ; } } ;
    { Numeric->Lip = (long *) umf_l_malloc (Numeric->npiv+1, sizeof (long)) ; if (Numeric->Lip == (long *) 
# 134 "umfpack_load_numeric.c" 3 4
   ((void *)0)
# 134 "umfpack_load_numeric.c"
   ) { umfpack_zl_free_numeric ((void **) &Numeric) ; fclose (f) ; return ((-1)) ; } if (fread (Numeric->Lip, sizeof (long), Numeric->npiv+1, f) != (size_t) Numeric->npiv+1) { umfpack_zl_free_numeric ((void **) &Numeric) ; fclose (f) ; return ((-17)) ; } if (ferror (f)) { umfpack_zl_free_numeric ((void **) &Numeric) ; fclose (f) ; return ((-17)) ; } } ;
    { Numeric->Upos = (long *) umf_l_malloc (Numeric->npiv+1, sizeof (long)) ; if (Numeric->Upos == (long *) 
# 135 "umfpack_load_numeric.c" 3 4
   ((void *)0)
# 135 "umfpack_load_numeric.c"
   ) { umfpack_zl_free_numeric ((void **) &Numeric) ; fclose (f) ; return ((-1)) ; } if (fread (Numeric->Upos, sizeof (long), Numeric->npiv+1, f) != (size_t) Numeric->npiv+1) { umfpack_zl_free_numeric ((void **) &Numeric) ; fclose (f) ; return ((-17)) ; } if (ferror (f)) { umfpack_zl_free_numeric ((void **) &Numeric) ; fclose (f) ; return ((-17)) ; } } ;
    { Numeric->Uilen = (long *) umf_l_malloc (Numeric->npiv+1, sizeof (long)) ; if (Numeric->Uilen == (long *) 
# 136 "umfpack_load_numeric.c" 3 4
   ((void *)0)
# 136 "umfpack_load_numeric.c"
   ) { umfpack_zl_free_numeric ((void **) &Numeric) ; fclose (f) ; return ((-1)) ; } if (fread (Numeric->Uilen, sizeof (long), Numeric->npiv+1, f) != (size_t) Numeric->npiv+1) { umfpack_zl_free_numeric ((void **) &Numeric) ; fclose (f) ; return ((-17)) ; } if (ferror (f)) { umfpack_zl_free_numeric ((void **) &Numeric) ; fclose (f) ; return ((-17)) ; } } ;
    { Numeric->Uip = (long *) umf_l_malloc (Numeric->npiv+1, sizeof (long)) ; if (Numeric->Uip == (long *) 
# 137 "umfpack_load_numeric.c" 3 4
   ((void *)0)
# 137 "umfpack_load_numeric.c"
   ) { umfpack_zl_free_numeric ((void **) &Numeric) ; fclose (f) ; return ((-1)) ; } if (fread (Numeric->Uip, sizeof (long), Numeric->npiv+1, f) != (size_t) Numeric->npiv+1) { umfpack_zl_free_numeric ((void **) &Numeric) ; fclose (f) ; return ((-17)) ; } if (ferror (f)) { umfpack_zl_free_numeric ((void **) &Numeric) ; fclose (f) ; return ((-17)) ; } } ;
    if (Numeric->scale != 0)
    {
 { Numeric->Rs = (double *) umf_l_malloc (Numeric->n_row, sizeof (double)) ; if (Numeric->Rs == (double *) 
# 140 "umfpack_load_numeric.c" 3 4
((void *)0)
# 140 "umfpack_load_numeric.c"
) { umfpack_zl_free_numeric ((void **) &Numeric) ; fclose (f) ; return ((-1)) ; } if (fread (Numeric->Rs, sizeof (double), Numeric->n_row, f) != (size_t) Numeric->n_row) { umfpack_zl_free_numeric ((void **) &Numeric) ; fclose (f) ; return ((-17)) ; } if (ferror (f)) { umfpack_zl_free_numeric ((void **) &Numeric) ; fclose (f) ; return ((-17)) ; } } ;
    }
    if (Numeric->ulen > 0)
    {
 { Numeric->Upattern = (long *) umf_l_malloc (Numeric->ulen+1, sizeof (long)) ; if (Numeric->Upattern == (long *) 
# 144 "umfpack_load_numeric.c" 3 4
((void *)0)
# 144 "umfpack_load_numeric.c"
) { umfpack_zl_free_numeric ((void **) &Numeric) ; fclose (f) ; return ((-1)) ; } if (fread (Numeric->Upattern, sizeof (long), Numeric->ulen+1, f) != (size_t) Numeric->ulen+1) { umfpack_zl_free_numeric ((void **) &Numeric) ; fclose (f) ; return ((-17)) ; } if (ferror (f)) { umfpack_zl_free_numeric ((void **) &Numeric) ; fclose (f) ; return ((-17)) ; } } ;
    }
    { Numeric->Memory = (Unit *) umf_l_malloc (Numeric->size, sizeof (Unit)) ; if (Numeric->Memory == (Unit *) 
# 146 "umfpack_load_numeric.c" 3 4
   ((void *)0)
# 146 "umfpack_load_numeric.c"
   ) { umfpack_zl_free_numeric ((void **) &Numeric) ; fclose (f) ; return ((-1)) ; } if (fread (Numeric->Memory, sizeof (Unit), Numeric->size, f) != (size_t) Numeric->size) { umfpack_zl_free_numeric ((void **) &Numeric) ; fclose (f) ; return ((-17)) ; } if (ferror (f)) { umfpack_zl_free_numeric ((void **) &Numeric) ; fclose (f) ; return ((-17)) ; } } ;
