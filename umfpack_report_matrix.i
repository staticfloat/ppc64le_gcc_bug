# 1 "umfpack_report_matrix.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "umfpack_report_matrix.c"
# 15 "umfpack_report_matrix.c"
# 1 "umf_internal.h" 1
# 25 "umf_internal.h"
...
{
    DoubleComplex a ;
    long prl, i, k, length, ilast, p, nz, prl1, p1, p2, n, n_i, do_values ;
    char *vector_kind, *index_kind ;

    long split = ((Az) != (double *) 
# 35 "umfpack_report_matrix.c" 3 4
               ((void *)0)
# 35 "umfpack_report_matrix.c"
               ) ;
    ...
    prl = ((Control != (double *) 
# 42 "umfpack_report_matrix.c" 3 4
         ((void *)0)
# 42 "umfpack_report_matrix.c"
...
# 64 "umfpack_report_matrix.c" 3 4
   ((void *)0)
# 64 "umfpack_report_matrix.c"
   ) { (void) (SuiteSparse_config.printf_func) ("%s-form matrix, n_row ""%" "ld"" n_col ""%" "ld"", ", vector_kind, n_row, n_col) ; } }
                                    ;

    if (n_row <= 0 || n_col <= 0)
    {
 { if (SuiteSparse_config.printf_func != 
# 69 "umfpack_report_matrix.c" 3 4
((void *)0)
# 69 "umfpack_report_matrix.c"
) { (void) (SuiteSparse_config.printf_func) ("ERROR: n_row <= 0 or n_col <= 0\n\n") ; } } ;
 return ((-6)) ;
    }
    ...
    {
 { if (SuiteSparse_config.printf_func != 
# 75 "umfpack_report_matrix.c" 3 4
((void *)0)
# 75 "umfpack_report_matrix.c"
) { (void) (SuiteSparse_config.printf_func) ("ERROR: Ap missing\n\n") ; } } ;
 return ((-5)) ;
    }

    nz = Ap [n] ;
    { if (SuiteSparse_config.printf_func != 
# 80 "umfpack_report_matrix.c" 3 4
   ((void *)0)
# 80 "umfpack_report_matrix.c"
   ) { (void) (SuiteSparse_config.printf_func) ("nz = ""%" "ld"". ", nz) ; } } ;
    if (nz < 0)
    {
 { if (SuiteSparse_config.printf_func != 
# 83 "umfpack_report_matrix.c" 3 4
((void *)0)
# 83 "umfpack_report_matrix.c"
) { (void) (SuiteSparse_config.printf_func) ("ERROR: number of entries < 0\n\n") ; } } ;
 return ((-8)) ;
    }
    ...
    {
 { if (SuiteSparse_config.printf_func != 
# 89 "umfpack_report_matrix.c" 3 4
((void *)0)
# 89 "umfpack_report_matrix.c"
) { (void) (SuiteSparse_config.printf_func) ("ERROR: Ap [""%" "ld""] = ""%" "ld"" must be ""%" "ld""\n\n", (long) (0), (Ap [0]), (long) (0)) ; } }
                                                        ;
 return ((-8)) ;
    }
    ...
    {
 { if (SuiteSparse_config.printf_func != 
# 96 "umfpack_report_matrix.c" 3 4
((void *)0)
# 96 "umfpack_report_matrix.c"
) { (void) (SuiteSparse_config.printf_func) ("ERROR: Ai missing\n\n") ; } } ;
 return ((-5)) ;
    }

    do_values = Ax != (double *) 
# 100 "umfpack_report_matrix.c" 3 4
                                ((void *)0) 
# 100 "umfpack_report_matrix.c"
                                     ;

    { if (prl >= (4)) { { if (SuiteSparse_config.printf_func != 
# 102 "umfpack_report_matrix.c" 3 4
   ((void *)0)
# 102 "umfpack_report_matrix.c"
 ...
 {
     { if (SuiteSparse_config.printf_func != 
# 112 "umfpack_report_matrix.c" 3 4
    ((void *)0)
# 112 "umfpack_report_matrix.c"
    ) { (void) (SuiteSparse_config.printf_func) ("ERROR: Ap [""%" "ld""] < 0\n\n", (k)) ; } } ;
     return ((-8)) ;
 }
 if (Ap [k] > nz)
 {
     { if (SuiteSparse_config.printf_func != 
# 117 "umfpack_report_matrix.c" 3 4
    ((void *)0)
# 117 "umfpack_report_matrix.c"
    ) { (void) (SuiteSparse_config.printf_func) ("ERROR: Ap [""%" "ld""] > size of Ai\n\n", (k)) ; } } ;
     return ((-8)) ;
 }
    }
 ...
 {
     { if (SuiteSparse_config.printf_func != 
# 127 "umfpack_report_matrix.c" 3 4
    ((void *)0)
# 127 "umfpack_report_matrix.c"
    ) { (void) (SuiteSparse_config.printf_func) ("ERROR: # entries in %s ""%" "ld"" is < 0\n\n", vector_kind, (k)) ; } }
                           ;
     return ((-8)) ;
 }
    }
 ...
 length = p2 - p1 ;
 { if (prl >= (4)) { { if (SuiteSparse_config.printf_func != 
# 150 "umfpack_report_matrix.c" 3 4
((void *)0)
# 150 "umfpack_report_matrix.c"
) { (void) (SuiteSparse_config.printf_func) ("\n    %s ""%" "ld"": start: ""%" "ld"" end: ""%" "ld"" entries: ""%" "ld""\n", vector_kind, (k), p1, p2-1, length) ; } } ; } }
                                                ;
 ilast = (-1) ;
 for (p = p1 ; p < p2 ; p++)
 {
     i = Ai [p] ;
     { if (prl >= (4)) { { if (SuiteSparse_config.printf_func != 
# 156 "umfpack_report_matrix.c" 3 4
    ((void *)0)
# 156 "umfpack_report_matrix.c"
    ) { (void) (SuiteSparse_config.printf_func) ("\t%s ""%" "ld"" ", index_kind, (i)) ; } } ; } } ;
     if (do_values && prl >= 4)
     {
  { if (SuiteSparse_config.printf_func != 
# 159 "umfpack_report_matrix.c" 3 4
 ((void *)0)
# 159 "umfpack_report_matrix.c"
 ) { (void) (SuiteSparse_config.printf_func) (":") ; } } ;
  { if (split) { (a).component [0] = (Ax)[p] ; (a).component [1] = (Az)[p] ; } else { (a) = ((DoubleComplex *)(Ax))[p] ; } } ;
  { if ((((a).component [0]) != 0.)) { { if (SuiteSparse_config.printf_func != 
# 161 "umfpack_report_matrix.c" 3 4
 ((void *)0)
# 161 "umfpack_report_matrix.c"
 ) { (void) (SuiteSparse_config.printf_func) (" (%g", (a).component [0]) ; } } ; } else { { if (SuiteSparse_config.printf_func != 
# 161 "umfpack_report_matrix.c" 3 4
 ((void *)0)
# 161 "umfpack_report_matrix.c"
 ) { (void) (SuiteSparse_config.printf_func) (" (0") ; } } ; } if ((((a).component [1]) < 0.)) { { if (SuiteSparse_config.printf_func != 
# 161 "umfpack_report_matrix.c" 3 4
 ((void *)0)
# 161 "umfpack_report_matrix.c"
 ) { (void) (SuiteSparse_config.printf_func) (" - %gi)", -(a).component [1]) ; } } ; } else if ((((a).component [1]) == 0.)) { { if (SuiteSparse_config.printf_func != 
# 161 "umfpack_report_matrix.c" 3 4
 ((void *)0)
# 161 "umfpack_report_matrix.c"
...
# 161 "umfpack_report_matrix.c" 3 4
 ((void *)0)
# 161 "umfpack_report_matrix.c"
 ) { (void) (SuiteSparse_config.printf_func) (" + %gi)", (a).component [1]) ; } } ; } } ;
     }
     if (i < 0 || i >= n_i)
     {
  { if (SuiteSparse_config.printf_func != 
# 165 "umfpack_report_matrix.c" 3 4
 ((void *)0)
# 165 "umfpack_report_matrix.c"
 ) { (void) (SuiteSparse_config.printf_func) (" ERROR: %s index ""%" "ld"" out of range in %s ""%" "ld""\n\n", index_kind, (i), vector_kind, (k)) ; } }
                                                      ;
  return ((-8)) ;
     }
     if (i <= ilast)
     {
  { if (SuiteSparse_config.printf_func != 
# 171 "umfpack_report_matrix.c" 3 4
 ((void *)0)
# 171 "umfpack_report_matrix.c"
 ) { (void) (SuiteSparse_config.printf_func) (" ERROR: %s index ""%" "ld"" out of order (or duplicate) in " "%s ""%" "ld""\n\n", index_kind, (i), vector_kind, (k)) ; } }

                                             ;
  return ((-8)) ;
     }
     { if (prl >= (4)) { { if (SuiteSparse_config.printf_func != 
# 176 "umfpack_report_matrix.c" 3 4
    ((void *)0)
# 176 "umfpack_report_matrix.c"
    ) { (void) (SuiteSparse_config.printf_func) ("\n") ; } } ; } } ;

     if (prl == 4 && (p - p1) == 9 && length > 10)
     {
  { if (prl >= (4)) { { if (SuiteSparse_config.printf_func != 
# 180 "umfpack_report_matrix.c" 3 4
 ((void *)0)
# 180 "umfpack_report_matrix.c"
 ) { (void) (SuiteSparse_config.printf_func) ("\t...\n") ; } } ; } } ;
  prl-- ;
     }
     ilast = i ;
 ...
 {
     { if (prl >= (4)) { { if (SuiteSparse_config.printf_func != 
# 188 "umfpack_report_matrix.c" 3 4
    ((void *)0)
# 188 "umfpack_report_matrix.c"
    ) { (void) (SuiteSparse_config.printf_func) ("\n    ...\n") ; } } ; } } ;
     prl-- ;
 }
    }
    ...
    { if (prl >= (4)) { { if (SuiteSparse_config.printf_func != 
# 198 "umfpack_report_matrix.c" 3 4
   ((void *)0)
# 198 "umfpack_report_matrix.c"
   ) { (void) (SuiteSparse_config.printf_func) ("    %s-form matrix ", vector_kind) ; } } ; } } ;
    { if (SuiteSparse_config.printf_func != 
# 199 "umfpack_report_matrix.c" 3 4
   ((void *)0)
# 199 "umfpack_report_matrix.c"
