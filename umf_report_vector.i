# 1 "umf_report_vector.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "umf_report_vector.c"
# 10 "umf_report_vector.c"
# 1 "umf_internal.h" 1
# 25 "umf_internal.h"
...
# 28 "umf_report_vector.c" 3 4
   ((void *)0)
# 28 "umf_report_vector.c"
   ) { (void) (SuiteSparse_config.printf_func) ("    ""%" "ld"" :", (i)) ; } } ;
    if (scalar)
    {
 { if (((Xx [i]) != 0.)) { { if (SuiteSparse_config.printf_func != 
# 31 "umf_report_vector.c" 3 4
((void *)0)
# 31 "umf_report_vector.c"
) { (void) (SuiteSparse_config.printf_func) (" (%g)", (Xx [i])) ; } } ; } else { { if (SuiteSparse_config.printf_func != 
# 31 "umf_report_vector.c" 3 4
((void *)0)
# 31 "umf_report_vector.c"
) { (void) (SuiteSparse_config.printf_func) (" (0)") ; } } ; } } ;
    }
    else
    {
 { if (((Xz) != (double *) 
# 35 "umf_report_vector.c" 3 4
((void *)0)
# 35 "umf_report_vector.c"
)) { (xi).component [0] = (Xx)[i] ; (xi).component [1] = (Xz)[i] ; } else { (xi) = ((DoubleComplex *)(Xx))[i] ; } } ;
 { if ((((xi).component [0]) != 0.)) { { if (SuiteSparse_config.printf_func != 
# 36 "umf_report_vector.c" 3 4
((void *)0)
# 36 "umf_report_vector.c"
) { (void) (SuiteSparse_config.printf_func) (" (%g", (xi).component [0]) ; } } ; } else { { if (SuiteSparse_config.printf_func != 
# 36 "umf_report_vector.c" 3 4
((void *)0)
# 36 "umf_report_vector.c"
) { (void) (SuiteSparse_config.printf_func) (" (0") ; } } ; } if ((((xi).component [1]) < 0.)) { { if (SuiteSparse_config.printf_func != 
# 36 "umf_report_vector.c" 3 4
((void *)0)
# 36 "umf_report_vector.c"
) { (void) (SuiteSparse_config.printf_func) (" - %gi)", -(xi).component [1]) ; } } ; } else if ((((xi).component [1]) == 0.)) { { if (SuiteSparse_config.printf_func != 
# 36 "umf_report_vector.c" 3 4
((void *)0)
# 36 "umf_report_vector.c"
...
((void *)0)
# 36 "umf_report_vector.c"
) { (void) (SuiteSparse_config.printf_func) (" + %gi)", (xi).component [1]) ; } } ; } } ;
    }
    { if (SuiteSparse_config.printf_func != 
# 38 "umf_report_vector.c" 3 4
   ((void *)0)
# 38 "umf_report_vector.c"
...
)
{
    ...
    {
 { if (SuiteSparse_config.printf_func != 
# 59 "umf_report_vector.c" 3 4
((void *)0)
# 59 "umf_report_vector.c"
) { (void) (SuiteSparse_config.printf_func) ("dense vector, n = ""%" "ld"". ", n) ; } } ;
    }
 ...
 {
     { if (SuiteSparse_config.printf_func != 
# 66 "umf_report_vector.c" 3 4
    ((void *)0)
# 66 "umf_report_vector.c"
    ) { (void) (SuiteSparse_config.printf_func) ("ERROR: vector not present\n\n") ; } } ;
     return ((-5)) ;
 }
 if (n < 0)
 {
     { if (SuiteSparse_config.printf_func != 
# 71 "umf_report_vector.c" 3 4
    ((void *)0)
# 71 "umf_report_vector.c"
    ) { (void) (SuiteSparse_config.printf_func) ("ERROR: length of vector is < 0\n\n") ; } } ;
     return ((-6)) ;
 }
    }
...
# 78 "umf_report_vector.c" 3 4
((void *)0)
# 78 "umf_report_vector.c"
) { (void) (SuiteSparse_config.printf_func) ("\n") ; } } ; } } ;
    }
 ...
 {
     { if (SuiteSparse_config.printf_func != 
# 91 "umf_report_vector.c" 3 4
    ((void *)0)
# 91 "umf_report_vector.c"
    ) { (void) (SuiteSparse_config.printf_func) ("    ...\n") ; } } ;
 ...
 for (i = 0 ; i < n ; i++)
 {
    ...
    { if (prl >= (4)) { { if (SuiteSparse_config.printf_func != 
# 104 "umf_report_vector.c" 3 4
   ((void *)0)
# 104 "umf_report_vector.c"
   ) { (void) (SuiteSparse_config.printf_func) ("    dense vector ") ; } } ; } } ;
    if (user || prl >= 4)
    {
 { if (SuiteSparse_config.printf_func != 
# 107 "umf_report_vector.c" 3 4
((void *)0)
# 107 "umf_report_vector.c"
