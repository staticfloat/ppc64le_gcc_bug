...
# 93 "umf_get_memory.c"
 ...
 newsize = (((newsize) > (minsize)) ? (newsize) : (minsize)) ;
    ...
    mnew = (Unit *) 
# 131 "umf_get_memory.c" 3 4
                   ((void *)0) 
# 131 "umf_get_memory.c"
                        ;
    while (!mnew)
    {
