# 1 "umf_garbage_collection.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "umf_garbage_collection.c"
# 47 "umf_garbage_collection.c"
# 1 "umf_internal.h" 1
# 25 "umf_internal.h"
...
# 48 "umf_garbage_collection.c" 2
# 1 "umf_garbage_collection.h" 1
...
# 79 "umf_garbage_collection.c"
    ...
    n_row = Work->n_row ;
    n_col = Work->n_col ;
# 96 "umf_garbage_collection.c"
    Numeric->ngarbage++ ;
# 105 "umf_garbage_collection.c"
...
# 359 "umf_garbage_collection.c"
     }
# 374 "umf_garbage_collection.c"
     Work->fnr_curr = drnew ;
     Work->fnc_curr = dcnew ;
...
# 487 "umf_garbage_collection.c"
 }
 else if (e > 0)
 {
# 508 "umf_garbage_collection.c"
     p = psrc + 1 ;
