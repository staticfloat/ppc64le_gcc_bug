# 1 "umfpack_load_symbolic.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "umfpack_load_symbolic.c"
# 15 "umfpack_load_symbolic.c"
# 1 "umf_internal.h" 1
# 25 "umf_internal.h"
...
# 16 "umfpack_load_symbolic.c" 2
# 1 "umf_valid_symbolic.h" 1
...
# 19 "umfpack_load_symbolic.c" 2
# 47 "umfpack_load_symbolic.c"
 long umfpack_zl_load_symbolic
(
    void **SymbolicHandle,
    char *user_filename
)
{
    ...
    *SymbolicHandle = (void *) 
# 57 "umfpack_load_symbolic.c" 3 4
                              ((void *)0) 
# 57 "umfpack_load_symbolic.c"
                                   ;
    ...
    if (user_filename == (char *) 
# 63 "umfpack_load_symbolic.c" 3 4
                                 ((void *)0)
# 63 "umfpack_load_symbolic.c"
                                     )
    {
 ...
 return ((-17)) ;
    ...
    if (Symbolic == (SymbolicType *) 
# 82 "umfpack_load_symbolic.c" 3 4
                                    ((void *)0)
# 82 "umfpack_load_symbolic.c"
                                        )
    {
 fclose (f) ;
 return ((-1)) ;
 ...
 return ((-17)) ;
    ...
    if (Symbolic->valid != 110291734 || Symbolic->n_row <= 0 ||
 ...
 return ((-4)) ;
    ...
    Symbolic->Cperm_init = (long *) 
# 110 "umfpack_load_symbolic.c" 3 4
                                          ((void *)0) 
# 110 "umfpack_load_symbolic.c"
                                               ;
    Symbolic->Rperm_init = (long *) 
# 111 "umfpack_load_symbolic.c" 3 4
                                          ((void *)0) 
# 111 "umfpack_load_symbolic.c"
                                               ;
    Symbolic->Front_npivcol = (long *) 
# 112 "umfpack_load_symbolic.c" 3 4
                                          ((void *)0) 
# 112 "umfpack_load_symbolic.c"
                                               ;
    Symbolic->Front_parent = (long *) 
# 113 "umfpack_load_symbolic.c" 3 4
                                          ((void *)0) 
# 113 "umfpack_load_symbolic.c"
                                               ;
    Symbolic->Front_1strow = (long *) 
# 114 "umfpack_load_symbolic.c" 3 4
                                          ((void *)0) 
# 114 "umfpack_load_symbolic.c"
                                               ;
    Symbolic->Front_leftmostdesc = (long *) 
# 115 "umfpack_load_symbolic.c" 3 4
                                          ((void *)0) 
# 115 "umfpack_load_symbolic.c"
                                               ;
    Symbolic->Chain_start = (long *) 
# 116 "umfpack_load_symbolic.c" 3 4
                                          ((void *)0) 
# 116 "umfpack_load_symbolic.c"
                                               ;
    Symbolic->Chain_maxrows = (long *) 
# 117 "umfpack_load_symbolic.c" 3 4
                                          ((void *)0) 
# 117 "umfpack_load_symbolic.c"
                                               ;
    Symbolic->Chain_maxcols = (long *) 
# 118 "umfpack_load_symbolic.c" 3 4
                                          ((void *)0) 
# 118 "umfpack_load_symbolic.c"
                                               ;
    Symbolic->Cdeg = (long *) 
# 119 "umfpack_load_symbolic.c" 3 4
                                          ((void *)0) 
# 119 "umfpack_load_symbolic.c"
                                               ;
    Symbolic->Rdeg = (long *) 
# 120 "umfpack_load_symbolic.c" 3 4
                                          ((void *)0) 
# 120 "umfpack_load_symbolic.c"
                                               ;
    Symbolic->Esize = (long *) 
# 121 "umfpack_load_symbolic.c" 3 4
                                          ((void *)0) 
# 121 "umfpack_load_symbolic.c"
                                               ;
    Symbolic->Diagonal_map = (long *) 
# 122 "umfpack_load_symbolic.c" 3 4
                                          ((void *)0) 
# 122 "umfpack_load_symbolic.c"
                                               ;
    ...
    { Symbolic->Cperm_init = (long *) umf_l_malloc (Symbolic->n_col+1, sizeof (long)) ; if (Symbolic->Cperm_init == (long *) 
# 130 "umfpack_load_symbolic.c" 3 4
   ((void *)0)
# 130 "umfpack_load_symbolic.c"
   ) { umfpack_zl_free_symbolic ((void **) &Symbolic) ; fclose (f) ; return ((-1)) ; } if (fread (Symbolic->Cperm_init, sizeof (long), Symbolic->n_col+1, f) != (size_t) Symbolic->n_col+1) { umfpack_zl_free_symbolic ((void **) &Symbolic) ; fclose (f) ; return ((-17)) ; } if (ferror (f)) { umfpack_zl_free_symbolic ((void **) &Symbolic) ; fclose (f) ; return ((-17)) ; } } ;
    { Symbolic->Rperm_init = (long *) umf_l_malloc (Symbolic->n_row+1, sizeof (long)) ; if (Symbolic->Rperm_init == (long *) 
# 131 "umfpack_load_symbolic.c" 3 4
   ((void *)0)
# 131 "umfpack_load_symbolic.c"
   ) { umfpack_zl_free_symbolic ((void **) &Symbolic) ; fclose (f) ; return ((-1)) ; } if (fread (Symbolic->Rperm_init, sizeof (long), Symbolic->n_row+1, f) != (size_t) Symbolic->n_row+1) { umfpack_zl_free_symbolic ((void **) &Symbolic) ; fclose (f) ; return ((-17)) ; } if (ferror (f)) { umfpack_zl_free_symbolic ((void **) &Symbolic) ; fclose (f) ; return ((-17)) ; } } ;
    { Symbolic->Front_npivcol = (long *) umf_l_malloc (Symbolic->nfr+1, sizeof (long)) ; if (Symbolic->Front_npivcol == (long *) 
# 132 "umfpack_load_symbolic.c" 3 4
   ((void *)0)
# 132 "umfpack_load_symbolic.c"
   ) { umfpack_zl_free_symbolic ((void **) &Symbolic) ; fclose (f) ; return ((-1)) ; } if (fread (Symbolic->Front_npivcol, sizeof (long), Symbolic->nfr+1, f) != (size_t) Symbolic->nfr+1) { umfpack_zl_free_symbolic ((void **) &Symbolic) ; fclose (f) ; return ((-17)) ; } if (ferror (f)) { umfpack_zl_free_symbolic ((void **) &Symbolic) ; fclose (f) ; return ((-17)) ; } } ;
    { Symbolic->Front_parent = (long *) umf_l_malloc (Symbolic->nfr+1, sizeof (long)) ; if (Symbolic->Front_parent == (long *) 
# 133 "umfpack_load_symbolic.c" 3 4
   ((void *)0)
# 133 "umfpack_load_symbolic.c"
   ) { umfpack_zl_free_symbolic ((void **) &Symbolic) ; fclose (f) ; return ((-1)) ; } if (fread (Symbolic->Front_parent, sizeof (long), Symbolic->nfr+1, f) != (size_t) Symbolic->nfr+1) { umfpack_zl_free_symbolic ((void **) &Symbolic) ; fclose (f) ; return ((-17)) ; } if (ferror (f)) { umfpack_zl_free_symbolic ((void **) &Symbolic) ; fclose (f) ; return ((-17)) ; } } ;
    { Symbolic->Front_1strow = (long *) umf_l_malloc (Symbolic->nfr+1, sizeof (long)) ; if (Symbolic->Front_1strow == (long *) 
# 134 "umfpack_load_symbolic.c" 3 4
   ((void *)0)
# 134 "umfpack_load_symbolic.c"
   ) { umfpack_zl_free_symbolic ((void **) &Symbolic) ; fclose (f) ; return ((-1)) ; } if (fread (Symbolic->Front_1strow, sizeof (long), Symbolic->nfr+1, f) != (size_t) Symbolic->nfr+1) { umfpack_zl_free_symbolic ((void **) &Symbolic) ; fclose (f) ; return ((-17)) ; } if (ferror (f)) { umfpack_zl_free_symbolic ((void **) &Symbolic) ; fclose (f) ; return ((-17)) ; } } ;
    { Symbolic->Front_leftmostdesc = (long *) umf_l_malloc (Symbolic->nfr+1, sizeof (long)) ; if (Symbolic->Front_leftmostdesc == (long *) 
# 135 "umfpack_load_symbolic.c" 3 4
   ((void *)0)
# 135 "umfpack_load_symbolic.c"
   ) { umfpack_zl_free_symbolic ((void **) &Symbolic) ; fclose (f) ; return ((-1)) ; } if (fread (Symbolic->Front_leftmostdesc, sizeof (long), Symbolic->nfr+1, f) != (size_t) Symbolic->nfr+1) { umfpack_zl_free_symbolic ((void **) &Symbolic) ; fclose (f) ; return ((-17)) ; } if (ferror (f)) { umfpack_zl_free_symbolic ((void **) &Symbolic) ; fclose (f) ; return ((-17)) ; } } ;
    { Symbolic->Chain_start = (long *) umf_l_malloc (Symbolic->nchains+1, sizeof (long)) ; if (Symbolic->Chain_start == (long *) 
# 136 "umfpack_load_symbolic.c" 3 4
   ((void *)0)
# 136 "umfpack_load_symbolic.c"
   ) { umfpack_zl_free_symbolic ((void **) &Symbolic) ; fclose (f) ; return ((-1)) ; } if (fread (Symbolic->Chain_start, sizeof (long), Symbolic->nchains+1, f) != (size_t) Symbolic->nchains+1) { umfpack_zl_free_symbolic ((void **) &Symbolic) ; fclose (f) ; return ((-17)) ; } if (ferror (f)) { umfpack_zl_free_symbolic ((void **) &Symbolic) ; fclose (f) ; return ((-17)) ; } } ;
    { Symbolic->Chain_maxrows = (long *) umf_l_malloc (Symbolic->nchains+1, sizeof (long)) ; if (Symbolic->Chain_maxrows == (long *) 
# 137 "umfpack_load_symbolic.c" 3 4
   ((void *)0)
# 137 "umfpack_load_symbolic.c"
   ) { umfpack_zl_free_symbolic ((void **) &Symbolic) ; fclose (f) ; return ((-1)) ; } if (fread (Symbolic->Chain_maxrows, sizeof (long), Symbolic->nchains+1, f) != (size_t) Symbolic->nchains+1) { umfpack_zl_free_symbolic ((void **) &Symbolic) ; fclose (f) ; return ((-17)) ; } if (ferror (f)) { umfpack_zl_free_symbolic ((void **) &Symbolic) ; fclose (f) ; return ((-17)) ; } } ;
    { Symbolic->Chain_maxcols = (long *) umf_l_malloc (Symbolic->nchains+1, sizeof (long)) ; if (Symbolic->Chain_maxcols == (long *) 
# 138 "umfpack_load_symbolic.c" 3 4
   ((void *)0)
# 138 "umfpack_load_symbolic.c"
   ) { umfpack_zl_free_symbolic ((void **) &Symbolic) ; fclose (f) ; return ((-1)) ; } if (fread (Symbolic->Chain_maxcols, sizeof (long), Symbolic->nchains+1, f) != (size_t) Symbolic->nchains+1) { umfpack_zl_free_symbolic ((void **) &Symbolic) ; fclose (f) ; return ((-17)) ; } if (ferror (f)) { umfpack_zl_free_symbolic ((void **) &Symbolic) ; fclose (f) ; return ((-17)) ; } } ;
    { Symbolic->Cdeg = (long *) umf_l_malloc (Symbolic->n_col+1, sizeof (long)) ; if (Symbolic->Cdeg == (long *) 
# 139 "umfpack_load_symbolic.c" 3 4
   ((void *)0)
# 139 "umfpack_load_symbolic.c"
   ) { umfpack_zl_free_symbolic ((void **) &Symbolic) ; fclose (f) ; return ((-1)) ; } if (fread (Symbolic->Cdeg, sizeof (long), Symbolic->n_col+1, f) != (size_t) Symbolic->n_col+1) { umfpack_zl_free_symbolic ((void **) &Symbolic) ; fclose (f) ; return ((-17)) ; } if (ferror (f)) { umfpack_zl_free_symbolic ((void **) &Symbolic) ; fclose (f) ; return ((-17)) ; } } ;
    { Symbolic->Rdeg = (long *) umf_l_malloc (Symbolic->n_row+1, sizeof (long)) ; if (Symbolic->Rdeg == (long *) 
# 140 "umfpack_load_symbolic.c" 3 4
   ((void *)0)
# 140 "umfpack_load_symbolic.c"
   ) { umfpack_zl_free_symbolic ((void **) &Symbolic) ; fclose (f) ; return ((-1)) ; } if (fread (Symbolic->Rdeg, sizeof (long), Symbolic->n_row+1, f) != (size_t) Symbolic->n_row+1) { umfpack_zl_free_symbolic ((void **) &Symbolic) ; fclose (f) ; return ((-17)) ; } if (ferror (f)) { umfpack_zl_free_symbolic ((void **) &Symbolic) ; fclose (f) ; return ((-17)) ; } } ;
    if (Symbolic->esize > 0)
    {

 { Symbolic->Esize = (long *) umf_l_malloc (Symbolic->esize, sizeof (long)) ; if (Symbolic->Esize == (long *) 
# 144 "umfpack_load_symbolic.c" 3 4
((void *)0)
# 144 "umfpack_load_symbolic.c"
) { umfpack_zl_free_symbolic ((void **) &Symbolic) ; fclose (f) ; return ((-1)) ; } if (fread (Symbolic->Esize, sizeof (long), Symbolic->esize, f) != (size_t) Symbolic->esize) { umfpack_zl_free_symbolic ((void **) &Symbolic) ; fclose (f) ; return ((-17)) ; } if (ferror (f)) { umfpack_zl_free_symbolic ((void **) &Symbolic) ; fclose (f) ; return ((-17)) ; } } ;
    }
    if (Symbolic->prefer_diagonal)
    {

 { Symbolic->Diagonal_map = (long *) umf_l_malloc (Symbolic->n_col+1, sizeof (long)) ; if (Symbolic->Diagonal_map == (long *) 
# 149 "umfpack_load_symbolic.c" 3 4
((void *)0)
# 149 "umfpack_load_symbolic.c"
) { umfpack_zl_free_symbolic ((void **) &Symbolic) ; fclose (f) ; return ((-1)) ; } if (fread (Symbolic->Diagonal_map, sizeof (long), Symbolic->n_col+1, f) != (size_t) Symbolic->n_col+1) { umfpack_zl_free_symbolic ((void **) &Symbolic) ; fclose (f) ; return ((-17)) ; } if (ferror (f)) { umfpack_zl_free_symbolic ((void **) &Symbolic) ; fclose (f) ; return ((-17)) ; } } ;
    }
