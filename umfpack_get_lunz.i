# 1 "umfpack_get_lunz.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "umfpack_get_lunz.c"
# 15 "umfpack_get_lunz.c"
# 1 "umf_internal.h" 1
# 25 "umf_internal.h"
...
)
{
 ...
 return ((-5)) ;
    ...
    *lnz = Numeric->lnz + (((Numeric->n_row) < (Numeric->n_col)) ? (Numeric->n_row) : (Numeric->n_col)) ;
