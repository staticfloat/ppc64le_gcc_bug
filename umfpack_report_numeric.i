# 1 "umfpack_report_numeric.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "umfpack_report_numeric.c"
# 20 "umfpack_report_numeric.c"
# 1 "umf_internal.h" 1
# 25 "umf_internal.h"
...
# 21 "umfpack_report_numeric.c" 2
# 1 "umf_valid_numeric.h" 1





 long umfzl_valid_numeric
(
    NumericType *Numeric
) ;
# 22 "umfpack_report_numeric.c" 2
# 1 "umf_report_perm.h" 1





 long umf_l_report_perm
(
    long n,
    const long P [ ],
    long W [ ],
...
# 23 "umfpack_report_numeric.c" 2
# 1 "umf_report_vector.h" 1





 long umfzl_report_vector
(
    long n,
    const double Xx [ ],
    const double Xz [ ],
...
# 26 "umfpack_report_numeric.c" 2


static long report_L
(
    NumericType *Numeric,
    long Pattern [ ],
    long prl
...
{
    long prl, *W, nn, n_row, n_col, n_inner, num_fixed_size, numeric_size,
 npiv ;
    NumericType *Numeric ;

    prl = ((Control != (double *) 
# 57 "umfpack_report_numeric.c" 3 4
         ((void *)0)
# 57 "umfpack_report_numeric.c"
...
# 64 "umfpack_report_numeric.c" 3 4
   ((void *)0)
# 64 "umfpack_report_numeric.c"
   ) { (void) (SuiteSparse_config.printf_func) ("Numeric object:  ") ; } } ;

    Numeric = (NumericType *) NumericHandle ;
    if (!umfzl_valid_numeric (Numeric))
    {
 { if (SuiteSparse_config.printf_func != 
# 69 "umfpack_report_numeric.c" 3 4
((void *)0)
# 69 "umfpack_report_numeric.c"
) { (void) (SuiteSparse_config.printf_func) ("ERROR: LU factors invalid\n\n") ; } } ;
 return ((-3)) ;
    }
    ...
    num_fixed_size =
 (((((sizeof (NumericType) * (1))) + (sizeof (Unit)) - 1) / (sizeof (Unit))))
 + (((((sizeof (DoubleComplex) * (n_inner+1))) + (sizeof (Unit)) - 1) / (sizeof (Unit))))
 + (((((sizeof (long) * (n_row+1))) + (sizeof (Unit)) - 1) / (sizeof (Unit))))
 + (((((sizeof (long) * (n_col+1))) + (sizeof (Unit)) - 1) / (sizeof (Unit))))
 + 6 * (((((sizeof (long) * (npiv+1))) + (sizeof (Unit)) - 1) / (sizeof (Unit))))
 + ((Numeric->scale != 0) ?
  (((((sizeof (DoubleComplex) * (n_row))) + (sizeof (Unit)) - 1) / (sizeof (Unit)))) : 0) ;
 ...
 + (((((sizeof (long) * (Numeric->ulen))) + (sizeof (Unit)) - 1) / (sizeof (Unit)))) ;
    ...
    {
 { if (SuiteSparse_config.printf_func != 
# 106 "umfpack_report_numeric.c" 3 4
((void *)0)
# 106 "umfpack_report_numeric.c"
) { (void) (SuiteSparse_config.printf_func) ("\n    n_row: ""%" "ld""  n_col: ""%" "ld""\n", n_row, n_col) ; } } ;

 { if (SuiteSparse_config.printf_func != 
# 108 "umfpack_report_numeric.c" 3 4
((void *)0)
# 108 "umfpack_report_numeric.c"
) { (void) (SuiteSparse_config.printf_func) ("    relative pivot tolerance used:              %g\n", Numeric->relpt) ; } }
                      ;
 { if (SuiteSparse_config.printf_func != 
# 110 "umfpack_report_numeric.c" 3 4
((void *)0)
# 110 "umfpack_report_numeric.c"
) { (void) (SuiteSparse_config.printf_func) ("    relative symmetric pivot tolerance used:    %g\n", Numeric->relpt2) ; } }
                       ;

 { if (SuiteSparse_config.printf_func != 
# 113 "umfpack_report_numeric.c" 3 4
((void *)0)
# 113 "umfpack_report_numeric.c"
) { (void) (SuiteSparse_config.printf_func) ("    matrix scaled: ") ; } } ;
 if (Numeric->scale == 0)
 {
     { if (SuiteSparse_config.printf_func != 
# 116 "umfpack_report_numeric.c" 3 4
    ((void *)0)
# 116 "umfpack_report_numeric.c"
    ) { (void) (SuiteSparse_config.printf_func) ("no") ; } } ;
 }
 else if (Numeric->scale == 1)
 {
     { if (SuiteSparse_config.printf_func != 
# 120 "umfpack_report_numeric.c" 3 4
    ((void *)0)
# 120 "umfpack_report_numeric.c"
    ) { (void) (SuiteSparse_config.printf_func) ("yes (divided each row by sum abs value in each row)\n") ; } } ;
     { if (SuiteSparse_config.printf_func != 
# 121 "umfpack_report_numeric.c" 3 4
    ((void *)0)
# 121 "umfpack_report_numeric.c"
    ) { (void) (SuiteSparse_config.printf_func) ("    minimum sum (abs (rows of A)):              %.5e\n", Numeric->rsmin) ; } }
                   ;
     { if (SuiteSparse_config.printf_func != 
# 123 "umfpack_report_numeric.c" 3 4
    ((void *)0)
# 123 "umfpack_report_numeric.c"
    ) { (void) (SuiteSparse_config.printf_func) ("    maximum sum (abs (rows of A)):              %.5e", Numeric->rsmax) ; } }
                   ;
 }
 else if (Numeric->scale == 2)
 {
     { if (SuiteSparse_config.printf_func != 
# 128 "umfpack_report_numeric.c" 3 4
    ((void *)0)
# 128 "umfpack_report_numeric.c"
    ) { (void) (SuiteSparse_config.printf_func) ("yes (divided each row by max abs value in each row)\n") ; } } ;
     { if (SuiteSparse_config.printf_func != 
# 129 "umfpack_report_numeric.c" 3 4
    ((void *)0)
# 129 "umfpack_report_numeric.c"
    ) { (void) (SuiteSparse_config.printf_func) ("    minimum max (abs (rows of A)):              %.5e\n", Numeric->rsmin) ; } }
                   ;
     { if (SuiteSparse_config.printf_func != 
# 131 "umfpack_report_numeric.c" 3 4
    ((void *)0)
# 131 "umfpack_report_numeric.c"
    ) { (void) (SuiteSparse_config.printf_func) ("    maximum max (abs (rows of A)):              %.5e", Numeric->rsmax) ; } }
                   ;
 }
 { if (SuiteSparse_config.printf_func != 
# 134 "umfpack_report_numeric.c" 3 4
((void *)0)
# 134 "umfpack_report_numeric.c"
) { (void) (SuiteSparse_config.printf_func) ("\n") ; } } ;

 { if (SuiteSparse_config.printf_func != 
# 136 "umfpack_report_numeric.c" 3 4
((void *)0)
# 136 "umfpack_report_numeric.c"
) { (void) (SuiteSparse_config.printf_func) ("    initial allocation parameter used:          %g\n", Numeric->alloc_init) ; } }
                           ;
 { if (SuiteSparse_config.printf_func != 
# 138 "umfpack_report_numeric.c" 3 4
((void *)0)
# 138 "umfpack_report_numeric.c"
) { (void) (SuiteSparse_config.printf_func) ("    frontal matrix allocation parameter used:   %g\n", Numeric->front_alloc_init) ; } }
                                 ;
 { if (SuiteSparse_config.printf_func != 
# 140 "umfpack_report_numeric.c" 3 4
((void *)0)
# 140 "umfpack_report_numeric.c"
) { (void) (SuiteSparse_config.printf_func) ("    final total size of Numeric object (Units): ""%" "ld""\n", numeric_size) ; } }
                    ;
 { if (SuiteSparse_config.printf_func != 
# 142 "umfpack_report_numeric.c" 3 4
((void *)0)
# 142 "umfpack_report_numeric.c"
) { (void) (SuiteSparse_config.printf_func) ("    final total size of Numeric object (MBytes): %.1f\n", (((numeric_size) * sizeof (Unit)) / 1048576.0)) ; } }
                             ;
 { if (SuiteSparse_config.printf_func != 
# 144 "umfpack_report_numeric.c" 3 4
((void *)0)
# 144 "umfpack_report_numeric.c"
) { (void) (SuiteSparse_config.printf_func) ("    peak size of variable-size part (Units):    ""%" "ld""\n", Numeric->max_usage) ; } }
                          ;
 { if (SuiteSparse_config.printf_func != 
# 146 "umfpack_report_numeric.c" 3 4
((void *)0)
# 146 "umfpack_report_numeric.c"
) { (void) (SuiteSparse_config.printf_func) ("    peak size of variable-size part (MBytes):   %.1f\n", (((Numeric->max_usage) * sizeof (Unit)) / 1048576.0)) ; } }
                                   ;
 { if (SuiteSparse_config.printf_func != 
# 148 "umfpack_report_numeric.c" 3 4
((void *)0)
# 148 "umfpack_report_numeric.c"
) { (void) (SuiteSparse_config.printf_func) ("    largest actual frontal matrix size:         ""%" "ld""\n", Numeric->maxfrsize) ; } }
                          ;
 { if (SuiteSparse_config.printf_func != 
# 150 "umfpack_report_numeric.c" 3 4
((void *)0)
# 150 "umfpack_report_numeric.c"
) { (void) (SuiteSparse_config.printf_func) ("    memory defragmentations:                    ""%" "ld""\n", Numeric->ngarbage) ; } }
                         ;
 { if (SuiteSparse_config.printf_func != 
# 152 "umfpack_report_numeric.c" 3 4
((void *)0)
# 152 "umfpack_report_numeric.c"
) { (void) (SuiteSparse_config.printf_func) ("    memory reallocations:                       ""%" "ld""\n", Numeric->nrealloc) ; } }
                         ;
 { if (SuiteSparse_config.printf_func != 
# 154 "umfpack_report_numeric.c" 3 4
((void *)0)
# 154 "umfpack_report_numeric.c"
) { (void) (SuiteSparse_config.printf_func) ("    costly memory reallocations:                ""%" "ld""\n", Numeric->ncostly) ; } }
                        ;
 { if (SuiteSparse_config.printf_func != 
# 156 "umfpack_report_numeric.c" 3 4
((void *)0)
# 156 "umfpack_report_numeric.c"
) { (void) (SuiteSparse_config.printf_func) ("    entries in compressed pattern (L and U):    ""%" "ld""\n", Numeric->isize) ; } }
                      ;
 { if (SuiteSparse_config.printf_func != 
# 158 "umfpack_report_numeric.c" 3 4
((void *)0)
# 158 "umfpack_report_numeric.c"
) { (void) (SuiteSparse_config.printf_func) ("    number of nonzeros in L (excl diag):        ""%" "ld""\n", Numeric->lnz) ; } }
                    ;
 { if (SuiteSparse_config.printf_func != 
# 160 "umfpack_report_numeric.c" 3 4
((void *)0)
# 160 "umfpack_report_numeric.c"
) { (void) (SuiteSparse_config.printf_func) ("    number of entries stored in L (excl diag):  ""%" "ld""\n", Numeric->nLentries) ; } }
                          ;
 { if (SuiteSparse_config.printf_func != 
# 162 "umfpack_report_numeric.c" 3 4
((void *)0)
# 162 "umfpack_report_numeric.c"
) { (void) (SuiteSparse_config.printf_func) ("    number of nonzeros in U (excl diag):        ""%" "ld""\n", Numeric->unz) ; } }
                    ;
 { if (SuiteSparse_config.printf_func != 
# 164 "umfpack_report_numeric.c" 3 4
((void *)0)
# 164 "umfpack_report_numeric.c"
) { (void) (SuiteSparse_config.printf_func) ("    number of entries stored in U (excl diag):  ""%" "ld""\n", Numeric->nUentries) ; } }
                          ;
 { if (SuiteSparse_config.printf_func != 
# 166 "umfpack_report_numeric.c" 3 4
((void *)0)
# 166 "umfpack_report_numeric.c"
) { (void) (SuiteSparse_config.printf_func) ("    factorization floating-point operations:    %g\n", Numeric->flops) ; } }
                      ;
 { if (SuiteSparse_config.printf_func != 
# 168 "umfpack_report_numeric.c" 3 4
((void *)0)
# 168 "umfpack_report_numeric.c"
) { (void) (SuiteSparse_config.printf_func) ("    number of nonzeros on diagonal of U:        ""%" "ld""\n", Numeric->nnzpiv) ; } }
                       ;
 { if (SuiteSparse_config.printf_func != 
# 170 "umfpack_report_numeric.c" 3 4
((void *)0)
# 170 "umfpack_report_numeric.c"
) { (void) (SuiteSparse_config.printf_func) ("    min abs. value on diagonal of U:            %.5e\n", Numeric->min_udiag) ; } }
                          ;
 { if (SuiteSparse_config.printf_func != 
# 172 "umfpack_report_numeric.c" 3 4
((void *)0)
# 172 "umfpack_report_numeric.c"
) { (void) (SuiteSparse_config.printf_func) ("    max abs. value on diagonal of U:            %.5e\n", Numeric->max_udiag) ; } }
                          ;
 { if (SuiteSparse_config.printf_func != 
# 174 "umfpack_report_numeric.c" 3 4
((void *)0)
# 174 "umfpack_report_numeric.c"
) { (void) (SuiteSparse_config.printf_func) ("    reciprocal condition number estimate:       %.2e\n", Numeric->rcond) ; } }
                      ;
    }

    W = (long *) umf_l_malloc (nn, sizeof (long)) ;
    if (!W)
    {
 { if (SuiteSparse_config.printf_func != 
# 181 "umfpack_report_numeric.c" 3 4
((void *)0)
# 181 "umfpack_report_numeric.c"
) { (void) (SuiteSparse_config.printf_func) (" ERROR: out of memory to check Numeric object\n\n") ; } } ;
 return ((-1)) ;
    }
 ...
 if (Numeric->do_recip)
 {
     { if (prl >= (4)) { { if (SuiteSparse_config.printf_func != 
# 190 "umfpack_report_numeric.c" 3 4
    ((void *)0)
# 190 "umfpack_report_numeric.c"
 ...
 {
     { if (prl >= (4)) { { if (SuiteSparse_config.printf_func != 
# 195 "umfpack_report_numeric.c" 3 4
    ((void *)0)
# 195 "umfpack_report_numeric.c"
    ) { (void) (SuiteSparse_config.printf_func) ("\nScale factors applied via division\n") ; } } ; } } ;
 }
 { if (prl >= (4)) { { if (SuiteSparse_config.printf_func != 
# 197 "umfpack_report_numeric.c" 3 4
((void *)0)
# 197 "umfpack_report_numeric.c"
) { (void) (SuiteSparse_config.printf_func) ("Scale factors, Rs: ") ; } } ; } } ;
 (void) umfzl_report_vector (n_row, Numeric->Rs, (double *) 
# 198 "umfpack_report_numeric.c" 3 4
                                                         ((void *)0)
# 198 "umfpack_report_numeric.c"
                                                             ,
     prl, (0), (1)) ;
    }
    else
    {
 { if (prl >= (4)) { { if (SuiteSparse_config.printf_func != 
# 203 "umfpack_report_numeric.c" 3 4
((void *)0)
# 203 "umfpack_report_numeric.c"
) { (void) (SuiteSparse_config.printf_func) ("Scale factors, Rs: (not present)\n") ; } } ; } } ;
    }

    { if (prl >= (4)) { { if (SuiteSparse_config.printf_func != 
# 206 "umfpack_report_numeric.c" 3 4
   ((void *)0)
# 206 "umfpack_report_numeric.c"
   ) { (void) (SuiteSparse_config.printf_func) ("\nP: row ") ; } } ; } } ;
    if (umf_l_report_perm (n_row, Numeric->Rperm, W, prl, 0) != (0))
    {
 (void) umf_l_free ((void *) W) ;
 return ((-3)) ;
    }

    { if (prl >= (4)) { { if (SuiteSparse_config.printf_func != 
# 213 "umfpack_report_numeric.c" 3 4
   ((void *)0)
# 213 "umfpack_report_numeric.c"
   ) { (void) (SuiteSparse_config.printf_func) ("\nQ: column ") ; } } ; } } ;
    if (umf_l_report_perm (n_col, Numeric->Cperm, W, prl, 0) != (0))
    {
 (void) umf_l_free ((void *) W) ;
 return ((-3)) ;
    }
 ...
 (void) umf_l_free ((void *) W) ;
 { if (SuiteSparse_config.printf_func != 
# 223 "umfpack_report_numeric.c" 3 4
((void *)0)
# 223 "umfpack_report_numeric.c"
) { (void) (SuiteSparse_config.printf_func) (" ERROR: L factor invalid\n\n") ; } } ;
 return ((-3)) ;
    }
 ...
 (void) umf_l_free ((void *) W) ;
 { if (SuiteSparse_config.printf_func != 
# 230 "umfpack_report_numeric.c" 3 4
((void *)0)
# 230 "umfpack_report_numeric.c"
) { (void) (SuiteSparse_config.printf_func) (" ERROR: U factor invalid\n\n") ; } } ;
 return ((-3)) ;
    }


    { if (prl >= (4)) { { if (SuiteSparse_config.printf_func != 
# 235 "umfpack_report_numeric.c" 3 4
   ((void *)0)
# 235 "umfpack_report_numeric.c"
   ) { (void) (SuiteSparse_config.printf_func) ("\ndiagonal of U: ") ; } } ; } } ;
    (void) umfzl_report_vector (n_inner, (double *) Numeric->D, (double *) 
# 236 "umfpack_report_numeric.c" 3 4
                                                                        ((void *)0)
# 236 "umfpack_report_numeric.c"
                                                                            ,
 prl, (0), (0)) ;
    ...
    { if (prl >= (4)) { { if (SuiteSparse_config.printf_func != 
# 241 "umfpack_report_numeric.c" 3 4
   ((void *)0)
# 241 "umfpack_report_numeric.c"
   ) { (void) (SuiteSparse_config.printf_func) ("    Numeric object:  ") ; } } ; } } ;
    { if (SuiteSparse_config.printf_func != 
# 242 "umfpack_report_numeric.c" 3 4
   ((void *)0)
# 242 "umfpack_report_numeric.c"
...
{
    long k, deg, *ip, j, row, n_row, *Lpos, *Lilen, valid, k1,
 *Lip, newLchain, llen, prl1, pos, lp, p, npiv, n1, *Li ;
    ...
    { if (prl >= (4)) { { if (SuiteSparse_config.printf_func != 
# 275 "umfpack_report_numeric.c" 3 4
   ((void *)0)
# 275 "umfpack_report_numeric.c"
 ...
 lp = Lip [k] ;
 deg = Lilen [k] ;
 Li = (long *) (Numeric->Memory + lp) ;
 lp += (((((sizeof (long) * (deg))) + (sizeof (Unit)) - 1) / (sizeof (Unit)))) ;
 Lval = (DoubleComplex *) (Numeric->Memory + lp) ;
 if (k1-- > 0)
 {
     prl = prl1 ;
 }
 ...
 {
     { if (SuiteSparse_config.printf_func != 
# 308 "umfpack_report_numeric.c" 3 4
    ((void *)0)
# 308 "umfpack_report_numeric.c"
    ) { (void) (SuiteSparse_config.printf_func) ("    ...\n") ; } } ;
     prl-- ;
 }
 { if (prl >= (4)) { { if (SuiteSparse_config.printf_func != 
# 311 "umfpack_report_numeric.c" 3 4
((void *)0)
# 311 "umfpack_report_numeric.c"
) { (void) (SuiteSparse_config.printf_func) ("\n    column ""%" "ld"":", (k)) ; } } ; } } ;
 { if (prl >= (4)) { { if (SuiteSparse_config.printf_func != 
# 312 "umfpack_report_numeric.c" 3 4
((void *)0)
# 312 "umfpack_report_numeric.c"
) { (void) (SuiteSparse_config.printf_func) ("  length ""%" "ld"".\n", deg) ; } } ; } } ;
 for (j = 0 ; j < deg ; j++)
 {
     row = Li [j] ;
     { if (prl >= (4)) { { if (SuiteSparse_config.printf_func != 
# 316 "umfpack_report_numeric.c" 3 4
    ((void *)0)
# 316 "umfpack_report_numeric.c"
    ) { (void) (SuiteSparse_config.printf_func) ("\trow ""%" "ld"" : ", (row)) ; } } ; } } ;
     if (prl >= 4) { if ((((Lval [j]).component [0]) != 0.)) { { if (SuiteSparse_config.printf_func != 
# 317 "umfpack_report_numeric.c" 3 4
                  ((void *)0)
# 317 "umfpack_report_numeric.c"
                  ) { (void) (SuiteSparse_config.printf_func) (" (%g", (Lval [j]).component [0]) ; } } ; } else { { if (SuiteSparse_config.printf_func != 
# 317 "umfpack_report_numeric.c" 3 4
                  ((void *)0)
# 317 "umfpack_report_numeric.c"
                  ) { (void) (SuiteSparse_config.printf_func) (" (0") ; } } ; } if ((((Lval [j]).component [1]) < 0.)) { { if (SuiteSparse_config.printf_func != 
# 317 "umfpack_report_numeric.c" 3 4
                  ((void *)0)
# 317 "umfpack_report_numeric.c"
                  ) { (void) (SuiteSparse_config.printf_func) (" - %gi)", -(Lval [j]).component [1]) ; } } ; } else if ((((Lval [j]).component [1]) == 0.)) { { if (SuiteSparse_config.printf_func != 
# 317 "umfpack_report_numeric.c" 3 4
                  ((void *)0)
# 317 "umfpack_report_numeric.c"
                  ) { (void) (SuiteSparse_config.printf_func) (" + 0i)") ; } } ; } else { { if (SuiteSparse_config.printf_func != 
# 317 "umfpack_report_numeric.c" 3 4
                  ((void *)0)
# 317 "umfpack_report_numeric.c"
                  ) { (void) (SuiteSparse_config.printf_func) (" + %gi)", (Lval [j]).component [1]) ; } } ; } } ;
     if (row <= k || row >= n_row)
     {
  return ((0)) ;
     }
     { if (prl >= (4)) { { if (SuiteSparse_config.printf_func != 
# 322 "umfpack_report_numeric.c" 3 4
    ((void *)0)
# 322 "umfpack_report_numeric.c"
    ) { (void) (SuiteSparse_config.printf_func) ("\n") ; } } ; } } ;

     if (prl == 4 && j == 9 && deg > 10)
     {
  { if (SuiteSparse_config.printf_func != 
# 326 "umfpack_report_numeric.c" 3 4
 ((void *)0)
# 326 "umfpack_report_numeric.c"
 ) { (void) (SuiteSparse_config.printf_func) ("\t...\n") ; } } ;
  prl-- ;
     }
 }
 ...
 {
     { if (SuiteSparse_config.printf_func != 
# 358 "umfpack_report_numeric.c" 3 4
    ((void *)0)
# 358 "umfpack_report_numeric.c"
    ) { (void) (SuiteSparse_config.printf_func) ("    ...\n") ; } } ;
     prl-- ;
 }

 { if (prl >= (4)) { { if (SuiteSparse_config.printf_func != 
# 362 "umfpack_report_numeric.c" 3 4
((void *)0)
# 362 "umfpack_report_numeric.c"
) { (void) (SuiteSparse_config.printf_func) ("\n    column ""%" "ld"":", (k)) ; } } ; } } ;
 ...
 {
     { if (prl >= (4)) { { if (SuiteSparse_config.printf_func != 
# 372 "umfpack_report_numeric.c" 3 4
    ((void *)0)
# 372 "umfpack_report_numeric.c"
    ) { (void) (SuiteSparse_config.printf_func) ("  remove row ""%" "ld"" at position ""%" "ld"".", (Pattern [pos]), (pos)) ; } } ; } }
                                       ;
 ...
 p = lp + (((((sizeof (long) * (llen))) + (sizeof (Unit)) - 1) / (sizeof (Unit)))) ;
 xp = (DoubleComplex *) (Numeric->Memory + p) ;
 if ((llen > 0 || deg > 0)
     && (p + (long) (((((sizeof (DoubleComplex) * (deg))) + (sizeof (Unit)) - 1) / (sizeof (Unit)))) > Numeric->size))
 {
     return ((0)) ;
 }
 if (llen > 0)
 {
     { if (prl >= (4)) { { if (SuiteSparse_config.printf_func != 
# 398 "umfpack_report_numeric.c" 3 4
    ((void *)0)
# 398 "umfpack_report_numeric.c"
    ) { (void) (SuiteSparse_config.printf_func) ("  add ""%" "ld"" entries.", llen) ; } } ; } } ;
     ip = (long *) (Numeric->Memory + lp) ;
     for (j = 0 ; j < llen ; j++)
     {
  Pattern [deg++] = *ip++ ;
     }
 ...
 { if (prl >= (4)) { { if (SuiteSparse_config.printf_func != 
# 410 "umfpack_report_numeric.c" 3 4
((void *)0)
# 410 "umfpack_report_numeric.c"
) { (void) (SuiteSparse_config.printf_func) ("  length ""%" "ld"".", deg) ; } } ; } } ;
 if (newLchain)
 {
     { if (prl >= (4)) { { if (SuiteSparse_config.printf_func != 
# 413 "umfpack_report_numeric.c" 3 4
    ((void *)0)
# 413 "umfpack_report_numeric.c"
    ) { (void) (SuiteSparse_config.printf_func) ("  Start of Lchain.") ; } } ; } } ;
 }
 { if (prl >= (4)) { { if (SuiteSparse_config.printf_func != 
# 415 "umfpack_report_numeric.c" 3 4
((void *)0)
# 415 "umfpack_report_numeric.c"
) { (void) (SuiteSparse_config.printf_func) ("\n") ; } } ; } } ;
 ...
 for (j = 0 ; j < deg ; j++)
 {
     row = Pattern [j] ;
     { if (prl >= (4)) { { if (SuiteSparse_config.printf_func != 
# 420 "umfpack_report_numeric.c" 3 4
    ((void *)0)
# 420 "umfpack_report_numeric.c"
    ) { (void) (SuiteSparse_config.printf_func) ("\trow ""%" "ld"" : ", (row)) ; } } ; } } ;
     if (prl >= 4) { if ((((*xp).component [0]) != 0.)) { { if (SuiteSparse_config.printf_func != 
# 421 "umfpack_report_numeric.c" 3 4
                  ((void *)0)
# 421 "umfpack_report_numeric.c"
                  ) { (void) (SuiteSparse_config.printf_func) (" (%g", (*xp).component [0]) ; } } ; } else { { if (SuiteSparse_config.printf_func != 
# 421 "umfpack_report_numeric.c" 3 4
                  ((void *)0)
# 421 "umfpack_report_numeric.c"
                  ) { (void) (SuiteSparse_config.printf_func) (" (0") ; } } ; } if ((((*xp).component [1]) < 0.)) { { if (SuiteSparse_config.printf_func != 
# 421 "umfpack_report_numeric.c" 3 4
                  ((void *)0)
# 421 "umfpack_report_numeric.c"
                  ) { (void) (SuiteSparse_config.printf_func) (" - %gi)", -(*xp).component [1]) ; } } ; } else if ((((*xp).component [1]) == 0.)) { { if (SuiteSparse_config.printf_func != 
# 421 "umfpack_report_numeric.c" 3 4
                  ((void *)0)
# 421 "umfpack_report_numeric.c"
                  ) { (void) (SuiteSparse_config.printf_func) (" + 0i)") ; } } ; } else { { if (SuiteSparse_config.printf_func != 
# 421 "umfpack_report_numeric.c" 3 4
                  ((void *)0)
# 421 "umfpack_report_numeric.c"
                  ) { (void) (SuiteSparse_config.printf_func) (" + %gi)", (*xp).component [1]) ; } } ; } } ;
     if (row <= k || row >= n_row)
     {
  return ((0)) ;
     }
     { if (prl >= (4)) { { if (SuiteSparse_config.printf_func != 
# 426 "umfpack_report_numeric.c" 3 4
    ((void *)0)
# 426 "umfpack_report_numeric.c"
    ) { (void) (SuiteSparse_config.printf_func) ("\n") ; } } ; } } ;
     xp++ ;
     ...
     {
  { if (SuiteSparse_config.printf_func != 
# 431 "umfpack_report_numeric.c" 3 4
 ((void *)0)
# 431 "umfpack_report_numeric.c"
 ) { (void) (SuiteSparse_config.printf_func) ("\t...\n") ; } } ;
  prl-- ;
     }
 }
    ...
    { if (prl >= (4)) { { if (SuiteSparse_config.printf_func != 
# 437 "umfpack_report_numeric.c" 3 4
   ((void *)0)
# 437 "umfpack_report_numeric.c"
   ) { (void) (SuiteSparse_config.printf_func) ("\n") ; } } ; } } ;
    return ((1)) ;
}
...
)
{
    ...
    long k, deg, j, *ip, col, *Upos, *Uilen, k1, prl1, pos,
 *Uip, n_col, ulen, p, newUchain, up, npiv, n1, *Ui ;
    DoubleComplex *xp, *Uval ;
    ...
    { if (prl >= (4)) { { if (SuiteSparse_config.printf_func != 
# 471 "umfpack_report_numeric.c" 3 4
   ((void *)0)
# 471 "umfpack_report_numeric.c"
 ...
 for (j = 0 ; j < deg ; j++)
 {
    ...
    { if (prl >= (4)) { { if (SuiteSparse_config.printf_func != 
# 493 "umfpack_report_numeric.c" 3 4
   ((void *)0)
# 493 "umfpack_report_numeric.c"
   ) { (void) (SuiteSparse_config.printf_func) ("\n    row ""%" "ld"":  length ""%" "ld"".  End of Uchain.\n", (npiv-1), deg) ; } } ; } }
       ;
 ...
 {
     up = -up ;
     p = up + (((((sizeof (long) * (ulen))) + (sizeof (Unit)) - 1) / (sizeof (Unit)))) ;
 }
 else
 {
     p = up ;
 ...
 xp = (DoubleComplex *) (Numeric->Memory + p) ;
 if (deg > 0 && (p + (long) (((((sizeof (DoubleComplex) * (deg))) + (sizeof (Unit)) - 1) / (sizeof (Unit)))) > Numeric->size))
 {
     return ((0)) ;
 }
 for (j = 0 ; j < deg ; j++)
 {
     col = Pattern [j] ;
     { if (prl >= (4)) { { if (SuiteSparse_config.printf_func != 
# 533 "umfpack_report_numeric.c" 3 4
    ((void *)0)
# 533 "umfpack_report_numeric.c"
    ) { (void) (SuiteSparse_config.printf_func) ("\tcol ""%" "ld"" :", (col)) ; } } ; } } ;
     if (prl >= 4) { if ((((*xp).component [0]) != 0.)) { { if (SuiteSparse_config.printf_func != 
# 534 "umfpack_report_numeric.c" 3 4
                  ((void *)0)
# 534 "umfpack_report_numeric.c"
                  ) { (void) (SuiteSparse_config.printf_func) (" (%g", (*xp).component [0]) ; } } ; } else { { if (SuiteSparse_config.printf_func != 
# 534 "umfpack_report_numeric.c" 3 4
                  ((void *)0)
# 534 "umfpack_report_numeric.c"
...
# 534 "umfpack_report_numeric.c"
  ...
  return ((0)) ;
     ...
     { if (prl >= (4)) { { if (SuiteSparse_config.printf_func != 
# 539 "umfpack_report_numeric.c" 3 4
    ((void *)0)
# 539 "umfpack_report_numeric.c"
    ) { (void) (SuiteSparse_config.printf_func) ("\n") ; } } ; } } ;
     xp++ ;
     ...
     {
  { if (SuiteSparse_config.printf_func != 
# 544 "umfpack_report_numeric.c" 3 4
 ((void *)0)
# 544 "umfpack_report_numeric.c"
 ) { (void) (SuiteSparse_config.printf_func) ("\t...\n") ; } } ;
  prl-- ;
     }
 }
 ...
 {
     { if (SuiteSparse_config.printf_func != 
# 559 "umfpack_report_numeric.c" 3 4
    ((void *)0)
# 559 "umfpack_report_numeric.c"
    ) { (void) (SuiteSparse_config.printf_func) ("    ...\n") ; } } ;
     prl-- ;
 }
 ...
 {
     { if (prl >= (4)) { { if (SuiteSparse_config.printf_func != 
# 565 "umfpack_report_numeric.c" 3 4
    ((void *)0)
# 565 "umfpack_report_numeric.c"
    ) { (void) (SuiteSparse_config.printf_func) ("\n    row ""%" "ld"":  ", (k-1)) ; } } ; } } ;
 }
 ...
 if (newUchain)
 {
  ...
  deg = ulen ;
  { if (prl >= (4)) { { if (SuiteSparse_config.printf_func != 
# 574 "umfpack_report_numeric.c" 3 4
 ((void *)0)
# 574 "umfpack_report_numeric.c"
 ) { (void) (SuiteSparse_config.printf_func) ("length ""%" "ld"".  End of Uchain.\n", deg) ; } } ; } } ;
  if (up + (long) (((((sizeof (long) * (ulen))) + (sizeof (Unit)) - 1) / (sizeof (Unit)))) > Numeric->size)
  {
      return ((0)) ;
  }
  ip = (long *) (Numeric->Memory + up) ;
  for (j = 0 ; j < deg ; j++)
  {
      Pattern [j] = *ip++ ;
  }
 ...
 else
 {
     ...
     {
  { if (prl >= (4)) { { if (SuiteSparse_config.printf_func != 
# 590 "umfpack_report_numeric.c" 3 4
 ((void *)0)
# 590 "umfpack_report_numeric.c"
 ) { (void) (SuiteSparse_config.printf_func) ("remove ""%" "ld"" entries.  ", ulen) ; } } ; } } ;
     }
     deg -= ulen ;
     if (deg < 0)
     {
  ...
  { if (prl >= (4)) { { if (SuiteSparse_config.printf_func != 
# 601 "umfpack_report_numeric.c" 3 4
 ((void *)0)
# 601 "umfpack_report_numeric.c"
 ) { (void) (SuiteSparse_config.printf_func) ("add column ""%" "ld"" at position ""%" "ld"".  ", (k), (pos)) ; } } ; } }
                               ;
  if (pos < 0 || pos > deg)
  {
      return ((0)) ;
  ...
  Pattern [pos] = k ;
     ...
     { if (prl >= (4)) { { if (SuiteSparse_config.printf_func != 
# 610 "umfpack_report_numeric.c" 3 4
    ((void *)0)
# 610 "umfpack_report_numeric.c"
    ) { (void) (SuiteSparse_config.printf_func) ("length ""%" "ld"".\n", deg) ; } } ; } } ;
 }
    }
 ...
 up = Uip [k] ;
 deg = Uilen [k] ;
 Ui = (long *) (Numeric->Memory + up) ;
 up += (((((sizeof (long) * (deg))) + (sizeof (Unit)) - 1) / (sizeof (Unit)))) ;
 Uval = (DoubleComplex *) (Numeric->Memory + up) ;
 if (k1-- > 0)
 {
     prl = prl1 ;
 }
 ...
 {
     { if (SuiteSparse_config.printf_func != 
# 635 "umfpack_report_numeric.c" 3 4
    ((void *)0)
# 635 "umfpack_report_numeric.c"
    ) { (void) (SuiteSparse_config.printf_func) ("    ...\n") ; } } ;
     prl-- ;
 }
 { if (prl >= (4)) { { if (SuiteSparse_config.printf_func != 
# 638 "umfpack_report_numeric.c" 3 4
((void *)0)
# 638 "umfpack_report_numeric.c"
) { (void) (SuiteSparse_config.printf_func) ("\n    row ""%" "ld"":", (k)) ; } } ; } } ;
 { if (prl >= (4)) { { if (SuiteSparse_config.printf_func != 
# 639 "umfpack_report_numeric.c" 3 4
((void *)0)
# 639 "umfpack_report_numeric.c"
) { (void) (SuiteSparse_config.printf_func) ("  length ""%" "ld"".\n", deg) ; } } ; } } ;
 for (j = 0 ; j < deg ; j++)
 {
     col = Ui [j] ;
     { if (prl >= (4)) { { if (SuiteSparse_config.printf_func != 
# 643 "umfpack_report_numeric.c" 3 4
    ((void *)0)
# 643 "umfpack_report_numeric.c"
    ) { (void) (SuiteSparse_config.printf_func) ("\tcol ""%" "ld"" : ", (col)) ; } } ; } } ;
     if (prl >= 4) { if ((((Uval [j]).component [0]) != 0.)) { { if (SuiteSparse_config.printf_func != 
# 644 "umfpack_report_numeric.c" 3 4
                  ((void *)0)
# 644 "umfpack_report_numeric.c"
                  ) { (void) (SuiteSparse_config.printf_func) (" (%g", (Uval [j]).component [0]) ; } } ; } else { { if (SuiteSparse_config.printf_func != 
# 644 "umfpack_report_numeric.c" 3 4
                  ((void *)0)
# 644 "umfpack_report_numeric.c"
                  ) { (void) (SuiteSparse_config.printf_func) (" (0") ; } } ; } if ((((Uval [j]).component [1]) < 0.)) { { if (SuiteSparse_config.printf_func != 
# 644 "umfpack_report_numeric.c" 3 4
                  ((void *)0)
# 644 "umfpack_report_numeric.c"
                  ) { (void) (SuiteSparse_config.printf_func) (" - %gi)", -(Uval [j]).component [1]) ; } } ; } else if ((((Uval [j]).component [1]) == 0.)) { { if (SuiteSparse_config.printf_func != 
# 644 "umfpack_report_numeric.c" 3 4
                  ((void *)0)
# 644 "umfpack_report_numeric.c"
                  ) { (void) (SuiteSparse_config.printf_func) (" + 0i)") ; } } ; } else { { if (SuiteSparse_config.printf_func != 
# 644 "umfpack_report_numeric.c" 3 4
                  ((void *)0)
# 644 "umfpack_report_numeric.c"
                  ) { (void) (SuiteSparse_config.printf_func) (" + %gi)", (Uval [j]).component [1]) ; } } ; } } ;
     if (col <= k || col >= n_col)
     {
  return ((0)) ;
     }
     { if (prl >= (4)) { { if (SuiteSparse_config.printf_func != 
# 649 "umfpack_report_numeric.c" 3 4
    ((void *)0)
# 649 "umfpack_report_numeric.c"
    ) { (void) (SuiteSparse_config.printf_func) ("\n") ; } } ; } } ;

     if (prl == 4 && j == 9 && deg > 10)
     {
  { if (SuiteSparse_config.printf_func != 
# 653 "umfpack_report_numeric.c" 3 4
 ((void *)0)
# 653 "umfpack_report_numeric.c"
 ) { (void) (SuiteSparse_config.printf_func) ("\t...\n") ; } } ;
  prl-- ;
     }
 }
    ...
    prl = prl1 ;
    { if (prl >= (4)) { { if (SuiteSparse_config.printf_func != 
# 660 "umfpack_report_numeric.c" 3 4
   ((void *)0)
# 660 "umfpack_report_numeric.c"
   ) { (void) (SuiteSparse_config.printf_func) ("\n") ; } } ; } } ;
    return ((1)) ;
}
