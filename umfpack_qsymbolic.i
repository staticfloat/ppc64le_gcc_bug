# 1 "umfpack_qsymbolic.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "umfpack_qsymbolic.c"
# 21 "umfpack_qsymbolic.c"
# 1 "umf_internal.h" 1
# 25 "umf_internal.h"
...
# 22 "umfpack_qsymbolic.c" 2
# 1 "umf_symbolic_usage.h" 1
...
# 27 "umfpack_qsymbolic.c" 2
# 1 "umf_is_permutation.h" 1
...
# 30 "umfpack_qsymbolic.c" 2
# 1 "umf_singletons.h" 1
 ...
 *Elen, *Degree, *s, *W, *Sp, *Tp ;
    ...
    if (user_ordering == 
# 192 "umfpack_qsymbolic.c" 3 4
                        ((void *)0)
# 192 "umfpack_qsymbolic.c"
                            )
    {
    ...
    else
    {
        ...
        Head = 
# 202 "umfpack_qsymbolic.c" 3 4
              ((void *)0) 
# 202 "umfpack_qsymbolic.c"
                   ;
        Elen = 
# 203 "umfpack_qsymbolic.c" 3 4
              ((void *)0) 
# 203 "umfpack_qsymbolic.c"
                   ;
        Degree = 
# 204 "umfpack_qsymbolic.c" 3 4
                ((void *)0) 
# 204 "umfpack_qsymbolic.c"
                     ;
    }
...
# 523 "umfpack_qsymbolic.c" 3 4
               ((void *)0)
# 523 "umfpack_qsymbolic.c"
               ) ;


    nzdiag = 0 ;
    do_nzdiag = (Ax != (double *) 
# 527 "umfpack_qsymbolic.c" 3 4
                                 ((void *)0)
# 527 "umfpack_qsymbolic.c"
                                     ) ;
# 540 "umfpack_qsymbolic.c"
    pp = 0 ;
    for (k = n1 ; k < n_col ; k++)
    {
 oldcol = Cperm1 [k] ;
...
# 762 "umfpack_qsymbolic.c"
    ...
    if (Quser == (long *) 
# 767 "umfpack_qsymbolic.c" 3 4
                        ((void *)0)
# 767 "umfpack_qsymbolic.c"
                            )
    {
    ...
    if (User_Info != (double *) 
# 790 "umfpack_qsymbolic.c" 3 4
                               ((void *)0)
# 790 "umfpack_qsymbolic.c"
                                   )
    {
 ...
 Info [i] = (-1) ;
    ...
    if (SymbolicHandle != 
# 820 "umfpack_qsymbolic.c" 3 4
                         ((void *)0)
# 820 "umfpack_qsymbolic.c"
                             )
    {
        *SymbolicHandle = (void *) 
# 822 "umfpack_qsymbolic.c" 3 4
                                  ((void *)0) 
# 822 "umfpack_qsymbolic.c"
                                       ;
    }
 ...
 strategy = 0 ;
    ...
    if (Quser != (long *) 
# 866 "umfpack_qsymbolic.c" 3 4
                        ((void *)0)
# 866 "umfpack_qsymbolic.c"
                            )
    {
...
# 947 "umfpack_qsymbolic.c" 3 4
                             ((void *)0)
# 947 "umfpack_qsymbolic.c"
                                 ) ;
 return ((-1)) ;
    }
...
# 953 "umfpack_qsymbolic.c" 3 4
                                   ((void *)0) 
# 953 "umfpack_qsymbolic.c"
                                        ;
    Symbolic->Chain_maxrows = (long *) 
# 954 "umfpack_qsymbolic.c" 3 4
                                     ((void *)0) 
# 954 "umfpack_qsymbolic.c"
                                          ;
    Symbolic->Chain_maxcols = (long *) 
# 955 "umfpack_qsymbolic.c" 3 4
                                     ((void *)0) 
# 955 "umfpack_qsymbolic.c"
                                          ;
    Symbolic->Front_npivcol = (long *) 
# 956 "umfpack_qsymbolic.c" 3 4
                                     ((void *)0) 
# 956 "umfpack_qsymbolic.c"
                                          ;
    Symbolic->Front_parent = (long *) 
# 957 "umfpack_qsymbolic.c" 3 4
                                    ((void *)0) 
# 957 "umfpack_qsymbolic.c"
                                         ;
    Symbolic->Front_1strow = (long *) 
# 958 "umfpack_qsymbolic.c" 3 4
                                    ((void *)0) 
# 958 "umfpack_qsymbolic.c"
                                         ;
    Symbolic->Front_leftmostdesc = (long *) 
# 959 "umfpack_qsymbolic.c" 3 4
                                          ((void *)0) 
# 959 "umfpack_qsymbolic.c"
                                               ;
    Symbolic->Esize = (long *) 
# 960 "umfpack_qsymbolic.c" 3 4
                             ((void *)0) 
# 960 "umfpack_qsymbolic.c"
                                  ;
    Symbolic->esize = 0 ;
    Symbolic->ordering = (-1) ;
    Symbolic->amd_lunz = (-1) ;
...
# 970 "umfpack_qsymbolic.c" 3 4
                                    ((void *)0) 
# 970 "umfpack_qsymbolic.c"
                                         ;
 ...
 Info [0] = (-1) ;
 error (&Symbolic, (SWType *) 
# 981 "umfpack_qsymbolic.c" 3 4
                             ((void *)0)
# 981 "umfpack_qsymbolic.c"
                                 ) ;
 return ((-1)) ;
    }
    ...
    if (Quser != (long *) 
# 996 "umfpack_qsymbolic.c" 3 4
                        ((void *)0)
# 996 "umfpack_qsymbolic.c"
                            )
    {
 ...
 if (!umf_l_is_permutation (Quser, Cperm_init, n_col, n_col))
 {
     Info [0] = (-15) ;
     error (&Symbolic, (SWType *) 
# 1002 "umfpack_qsymbolic.c" 3 4
                                 ((void *)0)
# 1002 "umfpack_qsymbolic.c"
                                     ) ;
     return ((-15)) ;
 }
    }
# 1030 "umfpack_qsymbolic.c"
    SW = &SWspace ;
    ...
    SW->Rs = (double *) 
# 1052 "umfpack_qsymbolic.c" 3 4
                             ((void *)0) 
# 1052 "umfpack_qsymbolic.c"
                                  ;
...
# 1147 "umfpack_qsymbolic.c"
 ...
 if (Quser != (long *) 
# 1179 "umfpack_qsymbolic.c" 3 4
                     ((void *)0)
# 1179 "umfpack_qsymbolic.c"
                         )
 {
...
# 1184 "umfpack_qsymbolic.c" 3 4
                                                     ((void *)0)
# 1184 "umfpack_qsymbolic.c"
                                                         ,
  (long *) 
# 1185 "umfpack_qsymbolic.c" 3 4
         ((void *)0)
# 1185 "umfpack_qsymbolic.c"
             , (long *) 
# 1185 "umfpack_qsymbolic.c" 3 4
                       ((void *)0)
# 1185 "umfpack_qsymbolic.c"
                           , 0,
  Rp, Ri, (double *) 
# 1186 "umfpack_qsymbolic.c" 3 4
                    ((void *)0)
# 1186 "umfpack_qsymbolic.c"
                        , Wq, (0)

  , (double *) 
# 1188 "umfpack_qsymbolic.c" 3 4
              ((void *)0)
# 1188 "umfpack_qsymbolic.c"
                  , (double *) 
# 1188 "umfpack_qsymbolic.c" 3 4
                               ((void *)0)
# 1188 "umfpack_qsymbolic.c"
...
# 1302 "umfpack_qsymbolic.c" 3 4
                                                                  ((void *)0)
# 1302 "umfpack_qsymbolic.c"
                                                                      )
    {
...
# 1334 "umfpack_qsymbolic.c"
    if (Quser != (long *) 
# 1334 "umfpack_qsymbolic.c" 3 4
                        ((void *)0)
# 1334 "umfpack_qsymbolic.c"
                            )
    {
...
# 1347 "umfpack_qsymbolic.c" 3 4
                                                                    ((void *)0)
# 1347 "umfpack_qsymbolic.c"
                                                                        )
    {
        long nrow2, ncol2 ;
# 1359 "umfpack_qsymbolic.c"
 (void) prune_singletons (n1, n_col, Ap, Ai,
     (double *) 
# 1360 "umfpack_qsymbolic.c" 3 4
               ((void *)0)
# 1360 "umfpack_qsymbolic.c"
                   ,

     (double *) 
# 1362 "umfpack_qsymbolic.c" 3 4
               ((void *)0)
# 1362 "umfpack_qsymbolic.c"
                   ,
...
# 1550 "umfpack_qsymbolic.c"
 ...
 (void) prune_singletons (n1, n_col, Ap, Ai,
     (double *) 
# 1562 "umfpack_qsymbolic.c" 3 4
               ((void *)0)
# 1562 "umfpack_qsymbolic.c"
                   ,

     (double *) 
# 1564 "umfpack_qsymbolic.c" 3 4
               ((void *)0)
# 1564 "umfpack_qsymbolic.c"
                   ,
...
# 1671 "umfpack_qsymbolic.c"
 ...
 (void) umfzl_transpose (n_row - n1, n_col - n1 - nempty_col,
     Sp, Si, (double *) 
# 1679 "umfpack_qsymbolic.c" 3 4
                       ((void *)0)
# 1679 "umfpack_qsymbolic.c"
                           ,
     P, (long *) 
# 1680 "umfpack_qsymbolic.c" 3 4
               ((void *)0)
# 1680 "umfpack_qsymbolic.c"
                   , 0, Bp, Bi, (double *) 
# 1680 "umfpack_qsymbolic.c" 3 4
                                           ((void *)0)
# 1680 "umfpack_qsymbolic.c"
     ...
     , (double *) 
# 1682 "umfpack_qsymbolic.c" 3 4
                 ((void *)0)
# 1682 "umfpack_qsymbolic.c"
                     , (double *) 
# 1682 "umfpack_qsymbolic.c" 3 4
                                  ((void *)0)
# 1682 "umfpack_qsymbolic.c"
...
# 2070 "umfpack_qsymbolic.c" 3 4
                            ((void *)0)
# 2070 "umfpack_qsymbolic.c"
                                )
 {
...
)
{
    return (symbolic_analysis (n_row, n_col, Ap, Ai, Ax,
        ...
        (void *) 
# 2693 "umfpack_qsymbolic.c" 3 4
                ((void *)0)
# 2693 "umfpack_qsymbolic.c"
                    ,
        (void *) 
# 2694 "umfpack_qsymbolic.c" 3 4
                ((void *)0)
# 2694 "umfpack_qsymbolic.c"
                    ,
...
)
{
    return (symbolic_analysis (n_row, n_col, Ap, Ai, Ax,
        ...
        (long *) 
# 2746 "umfpack_qsymbolic.c" 3 4
               ((void *)0)
# 2746 "umfpack_qsymbolic.c"
                   ,
